...
module Orb
  module Models
    class NewPlanMatrixPrice < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Orb::NewPlanMatrixPrice, Orb::Internal::AnyHash) }

      # The cadence to bill for this price on.
      sig { returns(Orb::NewPlanMatrixPrice::Cadence::OrSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewPlanMatrixPrice::ConversionRateConfig::Unit,
              Orb::NewPlanMatrixPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          model_type: Orb::NewPlanMatrixPrice::ModelType::OrSymbol,
          name: String,
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewPlanMatrixPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewPlanMatrixPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module Cadence
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanMatrixPrice::Cadence::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Orb::NewPlanMatrixPrice::ModelType) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        MATRIX =
          T.let(:matrix, Orb::NewPlanMatrixPrice::ModelType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Orb::NewPlanMatrixPrice::ModelType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanMatrixPrice::ConversionRateConfig::Unit::UnitConfig
            )
          end
          ...
          sig do
            params(
              unit_config:
                Orb::NewPlanMatrixPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanMatrixPrice::ConversionRateConfig::Tiered::TieredConfig
            )
          end
          ...
          sig do
            params(
              tiered_config:
                Orb::NewPlanMatrixPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewPlanMatrixPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewPlanMatrixPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
