...
module Orb
  module Models
    class NewPlanBulkPrice < Orb::Internal::Type::BaseModel
      ...
      sig { returns(Orb::NewPlanBulkPrice::Cadence::OrSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewPlanBulkPrice::ConversionRateConfig::Unit,
              Orb::NewPlanBulkPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          cadence: Orb::NewPlanBulkPrice::Cadence::OrSymbol,
          item_id: String,
          model_type: Orb::NewPlanBulkPrice::ModelType::OrSymbol,
          name: String,
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewPlanBulkPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewPlanBulkPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module Cadence
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanBulkPrice::Cadence::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Orb::NewPlanBulkPrice::ModelType) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        BULK = T.let(:bulk, Orb::NewPlanBulkPrice::ModelType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Orb::NewPlanBulkPrice::ModelType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanBulkPrice::ConversionRateConfig::Unit::UnitConfig
            )
          end
          ...
          sig do
            params(
              unit_config:
                Orb::NewPlanBulkPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanBulkPrice::ConversionRateConfig::Tiered::TieredConfig
            )
          end
          ...
          sig do
            params(
              tiered_config:
                Orb::NewPlanBulkPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewPlanBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewPlanBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanBulkPrice::ConversionRateConfig::Variants]
          )
        end
        def self.variants
        end
