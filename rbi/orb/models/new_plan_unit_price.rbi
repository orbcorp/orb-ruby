...
module Orb
  module Models
    class NewPlanUnitPrice < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Orb::NewPlanUnitPrice, Orb::Internal::AnyHash) }

      # The cadence to bill for this price on.
      sig { returns(Orb::NewPlanUnitPrice::Cadence::OrSymbol) }
      ...
      sig { returns(Orb::NewPlanUnitPrice::ModelType::OrSymbol) }
      ...
      sig do
        params(
          cadence: Orb::NewPlanUnitPrice::Cadence::OrSymbol,
          item_id: String,
          model_type: Orb::NewPlanUnitPrice::ModelType::OrSymbol,
          name: String,
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewPlanUnitPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewPlanUnitPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module Cadence
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanUnitPrice::Cadence::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Orb::NewPlanUnitPrice::ModelType) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        UNIT = T.let(:unit, Orb::NewPlanUnitPrice::ModelType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Orb::NewPlanUnitPrice::ModelType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanUnitPrice::ConversionRateConfig::Unit::UnitConfig
            )
          end
          attr_reader :unit_config
          ...
          sig do
            params(
              unit_config:
                Orb::NewPlanUnitPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
          attr_writer :unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanUnitPrice::ConversionRateConfig::Tiered::TieredConfig
            )
          end
          ...
          sig do
            params(
              tiered_config:
                Orb::NewPlanUnitPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewPlanUnitPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewPlanUnitPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanUnitPrice::ConversionRateConfig::Variants]
          )
        end
        def self.variants
        end
