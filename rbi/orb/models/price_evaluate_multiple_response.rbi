...
module Orb
  module Models
    class PriceEvaluateMultipleResponse < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(T::Array[Orb::Models::PriceEvaluateMultipleResponse::Data])
      end
      attr_accessor :data
      ...
      sig do
        params(
          data:
            T::Array[Orb::Models::PriceEvaluateMultipleResponse::Data::OrHash]
      ...
      sig do
        override.returns(
          { data: T::Array[Orb::Models::PriceEvaluateMultipleResponse::Data] }
        )
      end
      def to_hash
      end
      ...
      class Data < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::Models::PriceEvaluateMultipleResponse::Data,
              Orb::Internal::AnyHash
            )
          end
