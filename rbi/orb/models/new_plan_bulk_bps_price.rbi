    ...
    class NewPlanBulkBPSPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Unit,
              Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Unit::UnitConfig
            )
          end
          ...
          sig do
            params(
              unit_config:
                Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Tiered::TieredConfig
            )
          end
          ...
          sig do
            params(
              tiered_config:
                Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewPlanBulkBPSPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
