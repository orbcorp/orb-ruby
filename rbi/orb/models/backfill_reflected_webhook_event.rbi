...
module Orb
  module Models
    class BackfillReflectedWebhookEvent < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::BackfillReflectedWebhookEvent, Orb::Internal::AnyHash)
        end
      ...
      sig { returns(Orb::BackfillReflectedWebhookEvent::Backfill) }
      attr_reader :backfill

      sig do
        params(
          backfill: Orb::BackfillReflectedWebhookEvent::Backfill::OrHash
        ).void
      end
      ...
      sig { returns(Orb::BackfillReflectedWebhookEvent::Type::TaggedSymbol) }
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Orb::BackfillReflectedWebhookEvent::Type::OrSymbol
      ...
      sig do
        override.returns(
          {
            id: String,
            backfill: Orb::BackfillReflectedWebhookEvent::Backfill,
            created_at: Time,
            properties: T.anything,
            type: Orb::BackfillReflectedWebhookEvent::Type::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      class Backfill < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::BackfillReflectedWebhookEvent::Backfill,
        ...
        sig do
          returns(
            Orb::BackfillReflectedWebhookEvent::Backfill::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            status:
              Orb::BackfillReflectedWebhookEvent::Backfill::Status::OrSymbol,
            timeframe_end: Time,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Orb::BackfillReflectedWebhookEvent::Backfill::Status
              )
            end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::BackfillReflectedWebhookEvent::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        BACKFILL_REFLECTED =
          T.let(
            :"backfill.reflected",
            Orb::BackfillReflectedWebhookEvent::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Orb::BackfillReflectedWebhookEvent::Type::TaggedSymbol]
          )
        end
        def self.values
        end
