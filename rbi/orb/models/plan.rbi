    ...
    class Plan < Orb::Internal::Type::BaseModel
          ...
          adjustments:
            T::Array[
              T.any(
                ...
                Orb::Plan::Adjustment::TieredPercentageDiscount::OrHash,
      ...
      module Adjustment
        ...
        Variants =
          T.type_alias do
            T.any(
              ...
              Orb::Plan::Adjustment::TieredPercentageDiscount,
        ...
        class TieredPercentageDiscount < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[Orb::Plan::Adjustment::TieredPercentageDiscount::Filter]
            )
          end
          ...
          sig do
            returns(
              T::Array[Orb::Plan::Adjustment::TieredPercentageDiscount::Tier]
            )
          end
          attr_accessor :tiers
          ...
          sig do
            params(
              ...
              filters:
                T::Array[
                  Orb::Plan::Adjustment::TieredPercentageDiscount::Filter::OrHash
                ],
              ...
              tiers:
                T::Array[
                  Orb::Plan::Adjustment::TieredPercentageDiscount::Tier::OrHash
                ],
            ...
            override.returns(
              {
                ...
                filters:
                  T::Array[
                    Orb::Plan::Adjustment::TieredPercentageDiscount::Filter
                  ],
                is_invoice_level: T::Boolean,
                plan_phase_order: T.nilable(Integer),
                reason: T.nilable(String),
                ...
                tiers:
                  T::Array[
                    Orb::Plan::Adjustment::TieredPercentageDiscount::Tier
                  ]
              }
            )
          end
          ...
          class Filter < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Orb::Plan::Adjustment::TieredPercentageDiscount::Filter::Field::TaggedSymbol
              )
            end
            attr_accessor :field
            ...
            sig do
              returns(
                Orb::Plan::Adjustment::TieredPercentageDiscount::Filter::Operator::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                field:
                  Orb::Plan::Adjustment::TieredPercentageDiscount::Filter::Field::OrSymbol,
                operator:
                  Orb::Plan::Adjustment::TieredPercentageDiscount::Filter::Operator::OrSymbol,
            ...
            module Field
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::Plan::Adjustment::TieredPercentageDiscount::Filter::Field
                  )
                end
            ...
            module Operator
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::Plan::Adjustment::TieredPercentageDiscount::Filter::Operator
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
