...
module Orb
  module Models
    class SubscriptionCostExceededWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      sig { returns(Orb::SubscriptionCostExceededWebhookEvent::Properties) }
      attr_reader :properties

      sig do
        params(
          properties:
            Orb::SubscriptionCostExceededWebhookEvent::Properties::OrHash
        ).void
      end
      ...
      sig do
        returns(Orb::SubscriptionCostExceededWebhookEvent::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Orb::SubscriptionCostExceededWebhookEvent::Type::OrSymbol
        ...
        override.returns(
          {
            id: String,
            created_at: Time,
            properties: Orb::SubscriptionCostExceededWebhookEvent::Properties,
            subscription: Orb::Subscription,
            type: Orb::SubscriptionCostExceededWebhookEvent::Type::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      class Properties < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::SubscriptionCostExceededWebhookEvent::Properties,
              Orb::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            alert_configuration:
              Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::OrHash
          ).void
        end
        ...
        class AlertConfiguration < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              metric:
                T.nilable(
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::Metric::OrHash
                )
            ).void
          end
          attr_writer :metric
          ...
          sig do
            params(
              plan:
                T.nilable(
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::Plan::OrHash
                )
            ).void
          end
          attr_writer :plan
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::Threshold
                ]
              )
            )
          end
          ...
          sig do
            returns(
              Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::BalanceAlertStatus
                ]
              )
            )
          end
          ...
          sig do
            params(
              license_type:
                T.nilable(
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::LicenseType::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              thresholds:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::Threshold::OrHash
                  ]
                ),
              type:
                Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::Type::OrSymbol,
              balance_alert_status:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::BalanceAlertStatus::OrHash
                  ]
                ),
              ...
              price_filters:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::OrHash
                  ]
                ),
              threshold_overrides:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::OrHash
                  ]
                )
            ).returns(T.attached_class)
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::Type
                )
              end
          ...
          class PriceFilter < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field::TaggedSymbol
              )
            end
            attr_accessor :field
            ...
            sig do
              returns(
                Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                field:
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field::OrSymbol,
                operator:
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator::OrSymbol,
            ...
            module Field
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module Operator
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class ThresholdOverride < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::Threshold
                ]
              )
            end
            attr_accessor :thresholds
            ...
            sig do
              params(
                ...
                thresholds:
                  T::Array[
                    Orb::SubscriptionCostExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::Threshold::OrHash
                  ],
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::SubscriptionCostExceededWebhookEvent::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        SUBSCRIPTION_COST_EXCEEDED =
          T.let(
            ...
            Orb::SubscriptionCostExceededWebhookEvent::Type::TaggedSymbol
          )
