    ...
    module Customers
      class CostListResponse < Orb::Internal::Type::BaseModel
        ...
        sig do
          params(
            data:
              T::Array[Orb::Models::Customers::CostListResponse::Data::OrHash]
        ...
        sig do
          override.returns(
            { data: T::Array[Orb::Models::Customers::CostListResponse::Data] }
          )
        end
        def to_hash
        end
        ...
        class Data < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              per_price_costs:
                T::Array[
                  Orb::Models::Customers::CostListResponse::Data::PerPriceCost::OrHash
                ],
              subtotal: String,
              timeframe_end: Time,
