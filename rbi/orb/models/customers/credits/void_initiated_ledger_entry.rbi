    ...
    module Customers
      module Credits
        class VoidInitiatedLedgerEntry < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::Customers::Credits::VoidInitiatedLedgerEntry::EntryStatus::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Orb::Customers::Credits::VoidInitiatedLedgerEntry::EntryType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              entry_status:
                Orb::Customers::Credits::VoidInitiatedLedgerEntry::EntryStatus::OrSymbol,
              entry_type:
                Orb::Customers::Credits::VoidInitiatedLedgerEntry::EntryType::OrSymbol,
          ...
          module EntryStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::Customers::Credits::VoidInitiatedLedgerEntry::EntryStatus
                )
              end
          ...
          module EntryType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::Customers::Credits::VoidInitiatedLedgerEntry::EntryType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
