    ...
    module Customers
      module Credits
        class AmendmentLedgerEntry < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::Customers::Credits::AmendmentLedgerEntry::EntryStatus::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Orb::Customers::Credits::AmendmentLedgerEntry::EntryType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              entry_status:
                Orb::Customers::Credits::AmendmentLedgerEntry::EntryStatus::OrSymbol,
              entry_type:
                Orb::Customers::Credits::AmendmentLedgerEntry::EntryType::OrSymbol,
          ...
          module EntryStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::Customers::Credits::AmendmentLedgerEntry::EntryStatus
                )
              end
          ...
          module EntryType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::Customers::Credits::AmendmentLedgerEntry::EntryType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
