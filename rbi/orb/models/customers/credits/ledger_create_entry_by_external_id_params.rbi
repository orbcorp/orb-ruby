        ...
        class LedgerCreateEntryByExternalIDParams < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::Customers::Credits::LedgerCreateEntryByExternalIDParams::Filter
                ]
              )
            )
          end
            ...
            module Field
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::Customers::Credits::LedgerCreateEntryByExternalIDParams::Filter::Field
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              ITEM_ID =
                T.let(
                  :item_id,
                  Orb::Customers::Credits::LedgerCreateEntryByExternalIDParams::Filter::Field::TaggedSymbol
                )
            ...
            module Operator
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::Customers::Credits::LedgerCreateEntryByExternalIDParams::Filter::Operator
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              INCLUDES =
                T.let(
                  :includes,
                  Orb::Customers::Credits::LedgerCreateEntryByExternalIDParams::Filter::Operator::TaggedSymbol
                )
              EXCLUDES =
                T.let(
                  :excludes,
