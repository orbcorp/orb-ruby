      ...
      module Credits
        class TopUpListResponse < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              invoice_settings:
                Orb::Models::Customers::Credits::TopUpListResponse::InvoiceSettings::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Orb::Models::Customers::Credits::TopUpListResponse::ExpiresAfterUnit::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              ...
              expires_after_unit:
                T.nilable(
                  Orb::Models::Customers::Credits::TopUpListResponse::ExpiresAfterUnit::OrSymbol
                )
          ...
          module ExpiresAfterUnit
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::Models::Customers::Credits::TopUpListResponse::ExpiresAfterUnit
                )
              end
