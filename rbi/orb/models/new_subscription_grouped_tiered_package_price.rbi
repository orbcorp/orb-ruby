    ...
    class NewSubscriptionGroupedTieredPackagePrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        params(
          grouped_tiered_package_config:
            Orb::NewSubscriptionGroupedTieredPackagePrice::GroupedTieredPackageConfig::OrHash
        ).void
      end
      ...
      class GroupedTieredPackageConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Orb::NewSubscriptionGroupedTieredPackagePrice::GroupedTieredPackageConfig::Tier
            ]
          )
        end
        attr_accessor :tiers
        ...
        sig do
          params(
            ...
            tiers:
              T::Array[
                Orb::NewSubscriptionGroupedTieredPackagePrice::GroupedTieredPackageConfig::Tier::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(
