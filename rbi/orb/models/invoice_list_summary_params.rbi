...
module Orb
  module Models
    class InvoiceListSummaryParams < Orb::Internal::Type::BaseModel
      extend Orb::Internal::Type::RequestParameters::Converter
      include Orb::Internal::Type::RequestParameters

      OrHash =
        T.type_alias do
          T.any(Orb::InvoiceListSummaryParams, Orb::Internal::AnyHash)
        end
      ...
      sig do
        returns(T.nilable(Orb::InvoiceListSummaryParams::DateType::OrSymbol))
      end
      ...
      module DateType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::InvoiceListSummaryParams::DateType)
          end
        ...
        DUE_DATE =
          T.let(
            :due_date,
            Orb::InvoiceListSummaryParams::DateType::TaggedSymbol
          )
        INVOICE_DATE =
          T.let(
            :invoice_date,
        ...
        sig do
          override.returns(
            T::Array[Orb::InvoiceListSummaryParams::DateType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Orb::InvoiceListSummaryParams::Status) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        DRAFT =
          T.let(:draft, Orb::InvoiceListSummaryParams::Status::TaggedSymbol)
        ISSUED =
          T.let(:issued, Orb::InvoiceListSummaryParams::Status::TaggedSymbol)
        PAID = T.let(:paid, Orb::InvoiceListSummaryParams::Status::TaggedSymbol)
        SYNCED =
          T.let(:synced, Orb::InvoiceListSummaryParams::Status::TaggedSymbol)
        VOID = T.let(:void, Orb::InvoiceListSummaryParams::Status::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Orb::InvoiceListSummaryParams::Status::TaggedSymbol]
          )
        end
        def self.values
        end
