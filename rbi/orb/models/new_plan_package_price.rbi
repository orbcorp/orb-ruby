...
module Orb
  module Models
    class NewPlanPackagePrice < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Orb::NewPlanPackagePrice, Orb::Internal::AnyHash) }

      # The cadence to bill for this price on.
      sig { returns(Orb::NewPlanPackagePrice::Cadence::OrSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewPlanPackagePrice::ConversionRateConfig::Unit,
              Orb::NewPlanPackagePrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          item_id: String,
          model_type: Orb::NewPlanPackagePrice::ModelType::OrSymbol,
          name: String,
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewPlanPackagePrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewPlanPackagePrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module Cadence
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanPackagePrice::Cadence::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Orb::NewPlanPackagePrice::ModelType) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        PACKAGE =
          T.let(:package, Orb::NewPlanPackagePrice::ModelType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Orb::NewPlanPackagePrice::ModelType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanPackagePrice::ConversionRateConfig::Unit::UnitConfig
            )
          end
          ...
          sig do
            params(
              unit_config:
                Orb::NewPlanPackagePrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanPackagePrice::ConversionRateConfig::Tiered::TieredConfig
            )
          end
          ...
          sig do
            params(
              tiered_config:
                Orb::NewPlanPackagePrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewPlanPackagePrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewPlanPackagePrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanPackagePrice::ConversionRateConfig::Variants]
          )
        end
        def self.variants
        end
