...
module Orb
  module Models
    class NewPlanTieredWithMinimumPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(Orb::NewPlanTieredWithMinimumPrice::TieredWithMinimumConfig)
      end
      ...
      sig do
        params(
          tiered_with_minimum_config:
            Orb::NewPlanTieredWithMinimumPrice::TieredWithMinimumConfig::OrHash
        ).void
      end
      ...
      class TieredWithMinimumConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Orb::NewPlanTieredWithMinimumPrice::TieredWithMinimumConfig::Tier
            ]
          )
        end
        attr_accessor :tiers
        ...
        sig do
          params(
            tiers:
              T::Array[
                Orb::NewPlanTieredWithMinimumPrice::TieredWithMinimumConfig::Tier::OrHash
              ],
