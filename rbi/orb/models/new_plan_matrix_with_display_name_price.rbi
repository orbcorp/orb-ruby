    ...
    class NewPlanMatrixWithDisplayNamePrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        params(
          matrix_with_display_name_config:
            Orb::NewPlanMatrixWithDisplayNamePrice::MatrixWithDisplayNameConfig::OrHash
        ).void
      end
      ...
      class MatrixWithDisplayNameConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Orb::NewPlanMatrixWithDisplayNamePrice::MatrixWithDisplayNameConfig::UnitAmount
            ]
          )
        end
        ...
        sig do
          params(
            ...
            unit_amounts:
              T::Array[
                Orb::NewPlanMatrixWithDisplayNamePrice::MatrixWithDisplayNameConfig::UnitAmount::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(
