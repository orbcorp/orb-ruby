...
module Orb
  module Models
    class NewFloatingTieredPrice < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::NewFloatingTieredPrice, Orb::Internal::AnyHash)
        end

      # The cadence to bill for this price on.
      sig { returns(Orb::NewFloatingTieredPrice::Cadence::OrSymbol) }
      ...
      sig { returns(Orb::NewFloatingTieredPrice::ModelType::OrSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewFloatingTieredPrice::ConversionRateConfig::Unit,
              Orb::NewFloatingTieredPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          cadence: Orb::NewFloatingTieredPrice::Cadence::OrSymbol,
          currency: String,
          item_id: String,
          model_type: Orb::NewFloatingTieredPrice::ModelType::OrSymbol,
          name: String,
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewFloatingTieredPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewFloatingTieredPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
          dimensional_price_configuration:
            T.nilable(Orb::NewDimensionalPriceConfiguration::OrHash),
      ...
      module Cadence
        ...
        sig do
          override.returns(
            T::Array[Orb::NewFloatingTieredPrice::Cadence::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Orb::NewFloatingTieredPrice::ModelType) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        TIERED =
          T.let(:tiered, Orb::NewFloatingTieredPrice::ModelType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Orb::NewFloatingTieredPrice::ModelType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewFloatingTieredPrice::ConversionRateConfig::Unit::UnitConfig
            )
          end
          ...
          sig do
            params(
              unit_config:
                Orb::NewFloatingTieredPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              tiered_config:
                Orb::NewFloatingTieredPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          attr_writer :tiered_config
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewFloatingTieredPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewFloatingTieredPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[
              Orb::NewFloatingTieredPrice::ConversionRateConfig::Variants
            ]
          )
        end
        def self.variants
