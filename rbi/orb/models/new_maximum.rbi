...
module Orb
  module Models
    class NewMaximum < Orb::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(T::Array[Orb::NewMaximum::Filter])) }
      ...
      sig do
        params(
          ...
          filters: T.nilable(T::Array[Orb::NewMaximum::Filter::OrHash]),
        ...
        override.returns(
          {
            ...
            applies_to_price_ids: T.nilable(T::Array[String]),
            currency: T.nilable(String),
            filters: T.nilable(T::Array[Orb::NewMaximum::Filter]),
            is_invoice_level: T::Boolean,
            price_type: T.nilable(Orb::NewMaximum::PriceType::OrSymbol)
          }
        )
      ...
      class Filter < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Orb::NewMaximum::Filter, Orb::Internal::AnyHash)
          end

        # The property of the price to filter on.
        sig { returns(Orb::NewMaximum::Filter::Field::OrSymbol) }
        attr_accessor :field

        # Should prices that match the filter be included or excluded.
        sig { returns(Orb::NewMaximum::Filter::Operator::OrSymbol) }
        ...
        sig do
          params(
            field: Orb::NewMaximum::Filter::Field::OrSymbol,
            operator: Orb::NewMaximum::Filter::Operator::OrSymbol,
        ...
        module Field
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, Orb::NewMaximum::Filter::Field) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          PRICE_ID =
            T.let(:price_id, Orb::NewMaximum::Filter::Field::TaggedSymbol)
          ITEM_ID =
            T.let(:item_id, Orb::NewMaximum::Filter::Field::TaggedSymbol)
          PRICE_TYPE =
            T.let(:price_type, Orb::NewMaximum::Filter::Field::TaggedSymbol)
          CURRENCY =
            T.let(:currency, Orb::NewMaximum::Filter::Field::TaggedSymbol)
          PRICING_UNIT_ID =
            T.let(
              :pricing_unit_id,
              Orb::NewMaximum::Filter::Field::TaggedSymbol
            )

          sig do
            override.returns(
              T::Array[Orb::NewMaximum::Filter::Field::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, Orb::NewMaximum::Filter::Operator) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          INCLUDES =
            T.let(:includes, Orb::NewMaximum::Filter::Operator::TaggedSymbol)
          EXCLUDES =
            T.let(:excludes, Orb::NewMaximum::Filter::Operator::TaggedSymbol)

          sig do
            override.returns(
              T::Array[Orb::NewMaximum::Filter::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
