...
module Orb
  module Models
    class InvoiceIssuedSummaryWebhookEvent < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::InvoiceIssuedSummaryWebhookEvent, Orb::Internal::AnyHash)
        end
      ...
      sig { returns(Orb::InvoiceIssuedSummaryWebhookEvent::Invoice) }
      attr_reader :invoice

      sig do
        params(
          invoice: Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::OrHash
        ).void
      end
      attr_writer :invoice

      sig { returns(Orb::InvoiceIssuedSummaryWebhookEvent::Properties) }
      attr_reader :properties

      sig do
        params(
          properties: Orb::InvoiceIssuedSummaryWebhookEvent::Properties::OrHash
        ).void
      end
      attr_writer :properties

      # The event this payload describes.
      sig { returns(Orb::InvoiceIssuedSummaryWebhookEvent::Type::TaggedSymbol) }
      attr_accessor :type
      ...
      sig do
        params(
          ...
          invoice: Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::OrHash,
          properties: Orb::InvoiceIssuedSummaryWebhookEvent::Properties::OrHash,
          type: Orb::InvoiceIssuedSummaryWebhookEvent::Type::OrSymbol
        ...
        override.returns(
          {
            id: String,
            created_at: Time,
            invoice: Orb::InvoiceIssuedSummaryWebhookEvent::Invoice,
            properties: Orb::InvoiceIssuedSummaryWebhookEvent::Properties,
            type: Orb::InvoiceIssuedSummaryWebhookEvent::Type::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      class Invoice < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::InvoiceIssuedSummaryWebhookEvent::Invoice,
        ...
        sig do
          returns(
            Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::AutoCollection
          )
        end
        ...
        sig do
          params(
            auto_collection:
              Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::AutoCollection::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T::Array[Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CreditNote]
          )
        end
        ...
        sig do
          returns(
            T::Array[
              Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction
            ]
          )
        end
        ...
        sig do
          returns(
            Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::InvoiceSource::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T::Array[
              Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt
            ]
          )
        end
        ...
        sig do
          returns(
            Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            credit_notes:
              T::Array[
                Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CreditNote::OrHash
              ],
            currency: String,
            customer: Orb::CustomerMinified::OrHash,
            customer_balance_transactions:
              T::Array[
                Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::OrHash
              ],
            ...
            invoice_source:
              Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::InvoiceSource::OrSymbol,
            ...
            payment_attempts:
              T::Array[
                Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt::OrHash
              ],
            ...
            status:
              Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::Status::OrSymbol,
            subscription: T.nilable(Orb::SubscriptionMinified::OrHash),
          ...
          override.returns(
            {
              ...
              credit_notes:
                T::Array[
                  Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CreditNote
                ],
              currency: String,
        ...
        class CustomerBalanceTransaction < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Action::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              id: String,
              action:
                Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Action::OrSymbol,
              amount: String,
              created_at: Time,
              ...
              type:
                Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Type::OrSymbol
            ).returns(T.attached_class)
          end
          def self.new(
            # A unique id for this transaction.
          ...
          module Action
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Action
                )
              end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module InvoiceSource
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::InvoiceSource
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class PaymentAttempt < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt::PaymentProvider::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              ...
              payment_provider:
                T.nilable(
                  Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt::PaymentProvider::OrSymbol
                ),
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Properties < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::InvoiceIssuedSummaryWebhookEvent::Properties,
              Orb::Internal::AnyHash
            )
          end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::InvoiceIssuedSummaryWebhookEvent::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        INVOICE_ISSUED_SUMMARY =
          T.let(
            :"invoice.issued_summary",
            Orb::InvoiceIssuedSummaryWebhookEvent::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Orb::InvoiceIssuedSummaryWebhookEvent::Type::TaggedSymbol]
          )
        end
        def self.values
        end
