...
module Orb
  module Models
    class NewSubscriptionMinimumCompositePrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(Orb::NewSubscriptionMinimumCompositePrice::Cadence::OrSymbol)
      end
      ...
      sig { returns(Orb::NewSubscriptionMinimumCompositePrice::MinimumConfig) }
      attr_reader :minimum_config

      sig do
        params(
          minimum_config:
            Orb::NewSubscriptionMinimumCompositePrice::MinimumConfig::OrHash
        ).void
      end
      attr_writer :minimum_config

      sig do
        returns(Orb::NewSubscriptionMinimumCompositePrice::ModelType::OrSymbol)
      end
      ...
      sig do
        params(
          cadence: Orb::NewSubscriptionMinimumCompositePrice::Cadence::OrSymbol,
          item_id: String,
          minimum_config:
            Orb::NewSubscriptionMinimumCompositePrice::MinimumConfig::OrHash,
          model_type:
            Orb::NewSubscriptionMinimumCompositePrice::ModelType::OrSymbol,
          name: String,
      ...
      sig do
        override.returns(
          {
            cadence:
              Orb::NewSubscriptionMinimumCompositePrice::Cadence::OrSymbol,
            item_id: String,
            minimum_config:
              Orb::NewSubscriptionMinimumCompositePrice::MinimumConfig,
            model_type:
              Orb::NewSubscriptionMinimumCompositePrice::ModelType::OrSymbol,
            name: String,
            billable_metric_id: T.nilable(String),
      ...
      module Cadence
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewSubscriptionMinimumCompositePrice::Cadence)
          end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewSubscriptionMinimumCompositePrice::ModelType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        MINIMUM =
          T.let(
            :minimum,
            Orb::NewSubscriptionMinimumCompositePrice::ModelType::TaggedSymbol
          )
