...
module Orb
  module Models
    class NewSubscriptionUnitWithPercentPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(Orb::NewSubscriptionUnitWithPercentPrice::UnitWithPercentConfig)
      end
      ...
      sig do
        params(
          unit_with_percent_config:
            Orb::NewSubscriptionUnitWithPercentPrice::UnitWithPercentConfig::OrHash
        ).void
      end
        ...
        override.returns(
          {
            ...
            name: String,
            unit_with_percent_config:
              Orb::NewSubscriptionUnitWithPercentPrice::UnitWithPercentConfig,
            billable_metric_id: T.nilable(String),
            billed_in_advance: T.nilable(T::Boolean),
            billing_cycle_configuration:
