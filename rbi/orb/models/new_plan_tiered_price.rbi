...
module Orb
  module Models
    class NewPlanTieredPrice < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Orb::NewPlanTieredPrice, Orb::Internal::AnyHash) }

      # The cadence to bill for this price on.
      sig { returns(Orb::NewPlanTieredPrice::Cadence::OrSymbol) }
      ...
      sig { returns(Orb::NewPlanTieredPrice::ModelType::OrSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewPlanTieredPrice::ConversionRateConfig::Unit,
              Orb::NewPlanTieredPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          cadence: Orb::NewPlanTieredPrice::Cadence::OrSymbol,
          item_id: String,
          model_type: Orb::NewPlanTieredPrice::ModelType::OrSymbol,
          name: String,
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewPlanTieredPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewPlanTieredPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module Cadence
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanTieredPrice::Cadence::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Orb::NewPlanTieredPrice::ModelType) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        TIERED =
          T.let(:tiered, Orb::NewPlanTieredPrice::ModelType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Orb::NewPlanTieredPrice::ModelType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanTieredPrice::ConversionRateConfig::Unit::UnitConfig
            )
          end
          ...
          sig do
            params(
              unit_config:
                Orb::NewPlanTieredPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewPlanTieredPrice::ConversionRateConfig::Tiered::TieredConfig
            )
          end
          attr_reader :tiered_config
          ...
          sig do
            params(
              tiered_config:
                Orb::NewPlanTieredPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          attr_writer :tiered_config
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewPlanTieredPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewPlanTieredPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanTieredPrice::ConversionRateConfig::Variants]
          )
        end
        def self.variants
        end
