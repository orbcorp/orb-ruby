    ...
    class NewPlanScalableMatrixWithTieredPricingPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        params(
          scalable_matrix_with_tiered_pricing_config:
            Orb::NewPlanScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig::OrHash
        ).void
      end
      ...
      class ScalableMatrixWithTieredPricingConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Orb::NewPlanScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig::Tier
            ]
          )
        end
        attr_accessor :tiers
        ...
        sig do
          params(
            ...
            matrix_scaling_factors:
              T::Array[
                Orb::NewPlanScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig::MatrixScalingFactor::OrHash
              ],
            tiers:
              T::Array[
                Orb::NewPlanScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig::Tier::OrHash
              ],
