    ...
    class PriceCreateParams < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.any(
            ...
            Orb::PriceCreateParams::Body::GroupedTieredMatrix,
      ...
      module Body
        ...
        class GroupedTieredMatrix < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::PriceCreateParams::Body::GroupedTieredMatrix::Cadence::OrSymbol
            )
          end
          attr_accessor :cadence
          ...
          sig do
            params(
              grouped_tiered_matrix_config:
                Orb::PriceCreateParams::Body::GroupedTieredMatrix::GroupedTieredMatrixConfig::OrHash
            ).void
          end
          ...
          module Cadence
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::PriceCreateParams::Body::GroupedTieredMatrix::Cadence
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class GroupedTieredMatrixConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::PriceCreateParams::Body::GroupedTieredMatrix::GroupedTieredMatrixConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                ...
                tiers:
                  T::Array[
                    Orb::PriceCreateParams::Body::GroupedTieredMatrix::GroupedTieredMatrixConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
