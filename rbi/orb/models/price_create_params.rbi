    ...
    class PriceCreateParams < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::PriceCreateParams::ConversionRateConfig::Unit,
              Orb::PriceCreateParams::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::PriceCreateParams::ConversionRateConfig::Unit::OrHash,
                Orb::PriceCreateParams::ConversionRateConfig::Tiered::OrHash
              )
            ),
          dimensional_price_configuration:
            T.nilable(Orb::NewDimensionalPriceConfiguration::OrHash),
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::PriceCreateParams::ConversionRateConfig::Unit::UnitConfig
            )
          end
          attr_reader :unit_config
          ...
          sig do
            params(
              unit_config:
                Orb::PriceCreateParams::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
          attr_writer :unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::PriceCreateParams::ConversionRateConfig::Tiered::TieredConfig
            )
          end
          attr_reader :tiered_config
          ...
          sig do
            params(
              tiered_config:
                Orb::PriceCreateParams::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          attr_writer :tiered_config
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::PriceCreateParams::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::PriceCreateParams::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
