...
module Orb
  module Models
    class SubscriptionUsageExceededWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      sig { returns(Orb::SubscriptionUsageExceededWebhookEvent::Properties) }
      attr_reader :properties

      sig do
        params(
          properties:
            Orb::SubscriptionUsageExceededWebhookEvent::Properties::OrHash
        ).void
      end
      ...
      sig do
        returns(Orb::SubscriptionUsageExceededWebhookEvent::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Orb::SubscriptionUsageExceededWebhookEvent::Type::OrSymbol
        ...
        override.returns(
          {
            id: String,
            created_at: Time,
            properties: Orb::SubscriptionUsageExceededWebhookEvent::Properties,
            subscription: Orb::Subscription,
            type: Orb::SubscriptionUsageExceededWebhookEvent::Type::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      class Properties < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::SubscriptionUsageExceededWebhookEvent::Properties,
              Orb::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            alert_configuration:
              Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::OrHash
          ).void
        end
        ...
        attr_accessor :evaluated_quantity

        sig { returns(T.nilable(Float)) }
        attr_accessor :quantity_threshold
        ...
        sig do
          params(
            ...
            evaluated_quantity: T.nilable(Float),
            quantity_threshold: T.nilable(Float),
            timeframe_end: Time,
        ...
        class AlertConfiguration < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              metric:
                T.nilable(
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::Metric::OrHash
                )
            ).void
          end
          attr_writer :metric
          ...
          sig do
            params(
              plan:
                T.nilable(
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::Plan::OrHash
                )
            ).void
          end
          attr_writer :plan
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::Threshold
                ]
              )
            )
          end
          ...
          sig do
            returns(
              Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::BalanceAlertStatus
                ]
              )
            )
          end
          ...
          sig do
            params(
              license_type:
                T.nilable(
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::LicenseType::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              thresholds:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::Threshold::OrHash
                  ]
                ),
              type:
                Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::Type::OrSymbol,
              balance_alert_status:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::BalanceAlertStatus::OrHash
                  ]
                ),
              ...
              price_filters:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::OrHash
                  ]
                ),
              threshold_overrides:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::OrHash
                  ]
                )
            ).returns(T.attached_class)
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::Type
                )
              end
          ...
          class PriceFilter < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field::TaggedSymbol
              )
            end
            attr_accessor :field
            ...
            sig do
              returns(
                Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                field:
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field::OrSymbol,
                operator:
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator::OrSymbol,
            ...
            module Field
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module Operator
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class ThresholdOverride < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::Threshold
                ]
              )
            end
            attr_accessor :thresholds
            ...
            sig do
              params(
                ...
                thresholds:
                  T::Array[
                    Orb::SubscriptionUsageExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::Threshold::OrHash
                  ],
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::SubscriptionUsageExceededWebhookEvent::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        SUBSCRIPTION_USAGE_EXCEEDED =
          T.let(
            ...
            Orb::SubscriptionUsageExceededWebhookEvent::Type::TaggedSymbol
          )
