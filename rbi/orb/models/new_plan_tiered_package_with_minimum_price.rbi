    ...
    class NewPlanTieredPackageWithMinimumPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        params(
          tiered_package_with_minimum_config:
            Orb::NewPlanTieredPackageWithMinimumPrice::TieredPackageWithMinimumConfig::OrHash
        ).void
      end
      ...
      class TieredPackageWithMinimumConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Orb::NewPlanTieredPackageWithMinimumPrice::TieredPackageWithMinimumConfig::Tier
            ]
          )
        end
        attr_accessor :tiers
        ...
        sig do
          params(
            ...
            tiers:
              T::Array[
                Orb::NewPlanTieredPackageWithMinimumPrice::TieredPackageWithMinimumConfig::Tier::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(
