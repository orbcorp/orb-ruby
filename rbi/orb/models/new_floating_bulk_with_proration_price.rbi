...
module Orb
  module Models
    class NewFloatingBulkWithProrationPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(Orb::NewFloatingBulkWithProrationPrice::BulkWithProrationConfig)
      end
      ...
      sig do
        params(
          bulk_with_proration_config:
            Orb::NewFloatingBulkWithProrationPrice::BulkWithProrationConfig::OrHash
        ).void
      end
      ...
      class BulkWithProrationConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Orb::NewFloatingBulkWithProrationPrice::BulkWithProrationConfig::Tier
            ]
          )
        end
        attr_accessor :tiers
        ...
        sig do
          params(
            tiers:
              T::Array[
                Orb::NewFloatingBulkWithProrationPrice::BulkWithProrationConfig::Tier::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(
