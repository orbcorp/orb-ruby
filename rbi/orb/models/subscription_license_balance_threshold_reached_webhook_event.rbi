...
module Orb
  module Models
    class SubscriptionLicenseBalanceThresholdReachedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties
        )
      end
      ...
      sig do
        params(
          properties:
            Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::OrHash
        ).void
      end
      ...
      sig do
        returns(
          Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Subscription
        )
      end
      ...
      sig do
        params(
          subscription:
            Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Subscription::OrHash
        ).void
      end
      ...
      sig do
        returns(
          Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          subscription:
            Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Subscription::OrHash,
          type:
            Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Type::OrSymbol
      ...
      class Properties < Orb::Internal::Type::BaseModel
        ...
        sig do
          params(
            alert_configuration:
              Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T::Array[
              Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::License
            ]
          )
        end
        ...
        sig do
          params(
            ...
            licenses:
              T::Array[
                Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::License::OrHash
              ],
            timeframe_end: Time,
        ...
        class AlertConfiguration < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              metric:
                T.nilable(
                  Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::Metric::OrHash
                )
            ).void
          end
          attr_writer :metric
          ...
          sig do
            params(
              plan:
                T.nilable(
                  Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::Plan::OrHash
                )
            ).void
          end
          attr_writer :plan
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::Threshold
                ]
              )
            )
          end
          ...
          sig do
            returns(
              Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              license_type:
                T.nilable(
                  Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::LicenseType::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::PriceFilter
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              thresholds:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::Threshold::OrHash
                  ]
                ),
              type:
                Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::Type::OrSymbol,
              balance_alert_status:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::BalanceAlertStatus::OrHash
                  ]
                ),
              ...
              price_filters:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::PriceFilter::OrHash
                  ]
                ),
              threshold_overrides:
                T.nilable(
                  T::Array[
                    Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::OrHash
                  ]
                )
            ).returns(T.attached_class)
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::Type
                )
              end
          ...
          class PriceFilter < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field::TaggedSymbol
              )
            end
            attr_accessor :field
            ...
            sig do
              returns(
                Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                field:
                  Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field::OrSymbol,
                operator:
                  Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator::OrSymbol,
            ...
            module Field
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module Operator
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class ThresholdOverride < Orb::Internal::Type::BaseModel
            ...
            sig do
              params(
                ...
                thresholds:
                  T::Array[
                    Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::Threshold::OrHash
                  ],
      ...
      class Subscription < Orb::Internal::Type::BaseModel
        ...
        sig do
          params(
            plan:
              T.nilable(
                Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Subscription::Plan::OrHash
              )
          ).void
        end
        attr_writer :plan
        ...
        sig do
          returns(
            Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Subscription::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            start_date: Time,
            status:
              Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Subscription::Status::OrSymbol
          ).returns(T.attached_class)
        end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Subscription::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Type
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        SUBSCRIPTION_LICENSE_BALANCE_THRESHOLD_REACHED =
          T.let(
            :"subscription.license_balance_threshold_reached",
            Orb::SubscriptionLicenseBalanceThresholdReachedWebhookEvent::Type::TaggedSymbol
          )
