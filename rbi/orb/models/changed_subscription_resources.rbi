...
module Orb
  module Models
    class ChangedSubscriptionResources < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(T::Array[Orb::ChangedSubscriptionResources::CreatedInvoice])
      end
      ...
      sig do
        params(
          ...
          created_invoices:
            T::Array[Orb::ChangedSubscriptionResources::CreatedInvoice::OrHash],
        ...
        override.returns(
          {
            ...
            created_invoices:
              T::Array[Orb::ChangedSubscriptionResources::CreatedInvoice],
      ...
      class CreatedInvoice < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::ChangedSubscriptionResources::CreatedInvoice,
        ...
        sig do
          returns(
            Orb::ChangedSubscriptionResources::CreatedInvoice::AutoCollection
          )
        end
        ...
        sig do
          params(
            auto_collection:
              Orb::ChangedSubscriptionResources::CreatedInvoice::AutoCollection::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T::Array[
              Orb::ChangedSubscriptionResources::CreatedInvoice::CreditNote
            ]
          )
        end
        ...
        sig do
          returns(
            T::Array[
              Orb::ChangedSubscriptionResources::CreatedInvoice::CustomerBalanceTransaction
            ]
          )
        end
        ...
        sig do
          returns(
            Orb::ChangedSubscriptionResources::CreatedInvoice::InvoiceSource::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T::Array[
              Orb::ChangedSubscriptionResources::CreatedInvoice::LineItem
            ]
          )
        end
        ...
        sig do
          returns(
            Orb::ChangedSubscriptionResources::CreatedInvoice::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            credit_notes:
              T::Array[
                Orb::ChangedSubscriptionResources::CreatedInvoice::CreditNote::OrHash
              ],
            currency: String,
            customer: Orb::CustomerMinified::OrHash,
            customer_balance_transactions:
              T::Array[
                Orb::ChangedSubscriptionResources::CreatedInvoice::CustomerBalanceTransaction::OrHash
              ],
            ...
            invoice_source:
              Orb::ChangedSubscriptionResources::CreatedInvoice::InvoiceSource::OrSymbol,
            is_payable_now: T::Boolean,
            issue_failed_at: T.nilable(Time),
            issued_at: T.nilable(Time),
            line_items:
              T::Array[
                Orb::ChangedSubscriptionResources::CreatedInvoice::LineItem::OrHash
              ],
            ...
            status:
              Orb::ChangedSubscriptionResources::CreatedInvoice::Status::OrSymbol,
            subscription: T.nilable(Orb::SubscriptionMinified::OrHash),
            subtotal: String,
        ...
        class CustomerBalanceTransaction < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::ChangedSubscriptionResources::CreatedInvoice::CustomerBalanceTransaction::Action::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Orb::ChangedSubscriptionResources::CreatedInvoice::CustomerBalanceTransaction::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              id: String,
              action:
                Orb::ChangedSubscriptionResources::CreatedInvoice::CustomerBalanceTransaction::Action::OrSymbol,
              amount: String,
              created_at: Time,
              ...
              type:
                Orb::ChangedSubscriptionResources::CreatedInvoice::CustomerBalanceTransaction::Type::OrSymbol
            ).returns(T.attached_class)
          end
          def self.new(
            # A unique id for this transaction.
          ...
          module Action
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::ChangedSubscriptionResources::CreatedInvoice::CustomerBalanceTransaction::Action
                )
              end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Orb::ChangedSubscriptionResources::CreatedInvoice::CustomerBalanceTransaction::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module InvoiceSource
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Orb::ChangedSubscriptionResources::CreatedInvoice::InvoiceSource
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class LineItem < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Orb::ChangedSubscriptionResources::CreatedInvoice::LineItem::Adjustment::Variants
              ]
            )
          end
          ...
          sig do
            returns(
              T::Array[
                Orb::ChangedSubscriptionResources::CreatedInvoice::LineItem::SubLineItem::Variants
              ]
            )
          end
        ...
        class PaymentAttempt < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              ...
              payment_provider:
                T.nilable(
                  Orb::ChangedSubscriptionResources::CreatedInvoice::PaymentAttempt::PaymentProvider::OrSymbol
                ),
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Orb::ChangedSubscriptionResources::CreatedInvoice::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
