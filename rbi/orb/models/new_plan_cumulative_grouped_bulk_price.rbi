    ...
    class NewPlanCumulativeGroupedBulkPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        params(
          cumulative_grouped_bulk_config:
            Orb::NewPlanCumulativeGroupedBulkPrice::CumulativeGroupedBulkConfig::OrHash
        ).void
      end
      ...
      class CumulativeGroupedBulkConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Orb::NewPlanCumulativeGroupedBulkPrice::CumulativeGroupedBulkConfig::DimensionValue
            ]
          )
        end
        ...
        sig do
          params(
            dimension_values:
              T::Array[
                Orb::NewPlanCumulativeGroupedBulkPrice::CumulativeGroupedBulkConfig::DimensionValue::OrHash
              ],
            group: String
          ).returns(T.attached_class)
        end
