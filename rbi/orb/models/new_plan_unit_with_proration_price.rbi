    ...
    class NewPlanUnitWithProrationPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewPlanUnitWithProrationPrice::ConversionRateConfig::Unit,
              Orb::NewPlanUnitWithProrationPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewPlanUnitWithProrationPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewPlanUnitWithProrationPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              unit_config:
                Orb::NewPlanUnitWithProrationPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              tiered_config:
                Orb::NewPlanUnitWithProrationPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewPlanUnitWithProrationPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewPlanUnitWithProrationPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
