...
module Orb
  module Models
    class SubscriptionTrialEndedWebhookEvent < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::SubscriptionTrialEndedWebhookEvent, Orb::Internal::AnyHash)
        end
      ...
      sig do
        returns(Orb::SubscriptionTrialEndedWebhookEvent::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Orb::SubscriptionTrialEndedWebhookEvent::Type::OrSymbol
        ...
        override.returns(
          {
            ...
            type: Orb::SubscriptionTrialEndedWebhookEvent::Type::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::SubscriptionTrialEndedWebhookEvent::Type)
          end
        ...
        SUBSCRIPTION_TRIAL_ENDED =
          T.let(
            ...
            Orb::SubscriptionTrialEndedWebhookEvent::Type::TaggedSymbol
          )
