    ...
    class NewFloatingTieredPackagePrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewFloatingTieredPackagePrice::ConversionRateConfig::Unit,
              Orb::NewFloatingTieredPackagePrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewFloatingTieredPackagePrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewFloatingTieredPackagePrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
          dimensional_price_configuration:
            T.nilable(Orb::NewDimensionalPriceConfiguration::OrHash),
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              unit_config:
                Orb::NewFloatingTieredPackagePrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              tiered_config:
                Orb::NewFloatingTieredPackagePrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewFloatingTieredPackagePrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewFloatingTieredPackagePrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[
              Orb::NewFloatingTieredPackagePrice::ConversionRateConfig::Variants
            ]
          )
        end
        def self.variants
