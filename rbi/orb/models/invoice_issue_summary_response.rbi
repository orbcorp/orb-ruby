  ...
  module Models
    class InvoiceIssueSummaryResponse < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Orb::Models::InvoiceIssueSummaryResponse,
      ...
      sig { returns(Orb::Models::InvoiceIssueSummaryResponse::AutoCollection) }
      attr_reader :auto_collection

      sig do
        params(
          auto_collection:
            Orb::Models::InvoiceIssueSummaryResponse::AutoCollection::OrHash
        ).void
      end
      ...
      sig do
        returns(T::Array[Orb::Models::InvoiceIssueSummaryResponse::CreditNote])
      end
      ...
      sig do
        returns(
          T::Array[
            Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction
          ]
        )
      end
      ...
      sig do
        returns(
          Orb::Models::InvoiceIssueSummaryResponse::InvoiceSource::TaggedSymbol
        )
      end
      ...
      sig do
        returns(
          T::Array[Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt]
        )
      end
      ...
      sig do
        returns(Orb::Models::InvoiceIssueSummaryResponse::Status::TaggedSymbol)
      end
      ...
      sig do
        params(
          ...
          credit_notes:
            T::Array[
              Orb::Models::InvoiceIssueSummaryResponse::CreditNote::OrHash
            ],
          currency: String,
          customer: Orb::CustomerMinified::OrHash,
          customer_balance_transactions:
            T::Array[
              Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::OrHash
            ],
          ...
          invoice_source:
            Orb::Models::InvoiceIssueSummaryResponse::InvoiceSource::OrSymbol,
          ...
          payment_attempts:
            T::Array[
              Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt::OrHash
            ],
          ...
          status: Orb::Models::InvoiceIssueSummaryResponse::Status::OrSymbol,
        ...
        override.returns(
          {
            ...
            amount_due: String,
            auto_collection:
              Orb::Models::InvoiceIssueSummaryResponse::AutoCollection,
            billing_address: T.nilable(Orb::Address),
            created_at: Time,
            credit_notes:
              T::Array[Orb::Models::InvoiceIssueSummaryResponse::CreditNote],
            currency: String,
            ...
            status:
              Orb::Models::InvoiceIssueSummaryResponse::Status::TaggedSymbol,
      ...
      class CreditNote < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::Models::InvoiceIssueSummaryResponse::CreditNote,
              Orb::Internal::AnyHash
            )
          end
      ...
      class CustomerBalanceTransaction < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Action::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          params(
            id: String,
            action:
              Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Action::OrSymbol,
            amount: String,
            created_at: Time,
            ...
            type:
              Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Type::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
          # A unique id for this transaction.
        ...
        module Action
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Action
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module InvoiceSource
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Orb::Models::InvoiceIssueSummaryResponse::InvoiceSource
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class PaymentAttempt < Orb::Internal::Type::BaseModel
        ...
        sig do
          params(
            ...
            payment_provider:
              T.nilable(
                Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt::PaymentProvider::OrSymbol
              ),
        ...
        module PaymentProvider
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt::PaymentProvider
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::Models::InvoiceIssueSummaryResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
