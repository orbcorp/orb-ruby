...
module Orb
  module Models
    class SubscriptionCancelResponse < Orb::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Orb::Models::SubscriptionCancelResponse::PendingSubscriptionChange)) }
      attr_reader :pending_subscription_change

      sig do
        params(
          pending_subscription_change: T.nilable(
            T.any(Orb::Models::SubscriptionCancelResponse::PendingSubscriptionChange, Orb::Internal::AnyHash)
          )
        )
          .void
      end
      ...
      sig do
        params(
          redeemed_coupon: T.nilable(T.any(Orb::Models::SubscriptionCancelResponse::RedeemedCoupon, Orb::Internal::AnyHash))
        )
          .void
      end
      ...
      sig { params(trial_info: T.any(Orb::Models::SubscriptionCancelResponse::TrialInfo, Orb::Internal::AnyHash)).void }
      ...
      sig do
        params(
          changed_resources: T.nilable(T.any(Orb::Models::SubscriptionCancelResponse::ChangedResources, Orb::Internal::AnyHash))
        )
          .void
      end
          ...
          .returns(
            {
              ...
              net_terms: Integer,
              pending_subscription_change: T.nilable(Orb::Models::SubscriptionCancelResponse::PendingSubscriptionChange),
              ...
              changed_resources: T.nilable(Orb::Models::SubscriptionCancelResponse::ChangedResources)
            }
          )
      end
      def to_hash; end
      ...
      class AdjustmentInterval < Orb::Internal::Type::BaseModel
        ...
        module Adjustment
          ...
          sig do
            override
              .returns(
                [Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::UsageDiscount, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::AmountDiscount, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PercentageDiscount, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::Minimum, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::Maximum]
              )
          end
      ...
      module DiscountInterval
        ...
        sig do
          override
            .returns(
              [Orb::Models::SubscriptionCancelResponse::DiscountInterval::Amount, Orb::Models::SubscriptionCancelResponse::DiscountInterval::Percentage, Orb::Models::SubscriptionCancelResponse::DiscountInterval::Usage]
            )
        end
        def self.variants; end
      end
