  ...
  module Models
    module Events
      class BackfillFetchResponse < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Orb::Models::Events::BackfillFetchResponse::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            status:
              Orb::Models::Events::BackfillFetchResponse::Status::OrSymbol,
            timeframe_end: Time,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Orb::Models::Events::BackfillFetchResponse::Status)
            end
