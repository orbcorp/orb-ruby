  ...
  module Models
    module Events
      class BackfillCloseResponse < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Orb::Models::Events::BackfillCloseResponse::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            status:
              Orb::Models::Events::BackfillCloseResponse::Status::OrSymbol,
            timeframe_end: Time,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Orb::Models::Events::BackfillCloseResponse::Status)
            end
