  ...
  module Models
    module Events
      class BackfillCreateResponse < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Orb::Models::Events::BackfillCreateResponse::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            status:
              Orb::Models::Events::BackfillCreateResponse::Status::OrSymbol,
            timeframe_end: Time,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Orb::Models::Events::BackfillCreateResponse::Status)
            end
