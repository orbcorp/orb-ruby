...
module Orb
  module Models
    class NewSubscriptionUnitPrice < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::NewSubscriptionUnitPrice, Orb::Internal::AnyHash)
        end

      # The cadence to bill for this price on.
      sig { returns(Orb::NewSubscriptionUnitPrice::Cadence::OrSymbol) }
      ...
      sig { returns(Orb::NewSubscriptionUnitPrice::ModelType::OrSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Unit,
              Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          cadence: Orb::NewSubscriptionUnitPrice::Cadence::OrSymbol,
          item_id: String,
          model_type: Orb::NewSubscriptionUnitPrice::ModelType::OrSymbol,
          name: String,
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module Cadence
        ...
        sig do
          override.returns(
            T::Array[Orb::NewSubscriptionUnitPrice::Cadence::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewSubscriptionUnitPrice::ModelType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        UNIT =
          T.let(:unit, Orb::NewSubscriptionUnitPrice::ModelType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Orb::NewSubscriptionUnitPrice::ModelType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Unit::UnitConfig
            )
          end
          attr_reader :unit_config
          ...
          sig do
            params(
              unit_config:
                Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
          attr_writer :unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              tiered_config:
                Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[
              Orb::NewSubscriptionUnitPrice::ConversionRateConfig::Variants
            ]
          )
        end
        def self.variants
