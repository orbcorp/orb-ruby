...
module Orb
  module Models
    class SubscriptionStartedWebhookEvent < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::SubscriptionStartedWebhookEvent, Orb::Internal::AnyHash)
        end
      ...
      sig { returns(Orb::SubscriptionStartedWebhookEvent::Type::TaggedSymbol) }
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Orb::SubscriptionStartedWebhookEvent::Type::OrSymbol
        ...
        override.returns(
          {
            ...
            type: Orb::SubscriptionStartedWebhookEvent::Type::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::SubscriptionStartedWebhookEvent::Type)
          end
        ...
        SUBSCRIPTION_STARTED =
          T.let(
            ...
            Orb::SubscriptionStartedWebhookEvent::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Orb::SubscriptionStartedWebhookEvent::Type::TaggedSymbol]
          )
        end
        def self.values
        end
