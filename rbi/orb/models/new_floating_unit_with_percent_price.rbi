...
module Orb
  module Models
    class NewFloatingUnitWithPercentPrice < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::NewFloatingUnitWithPercentPrice, Orb::Internal::AnyHash)
        end

      # The cadence to bill for this price on.
      sig { returns(Orb::NewFloatingUnitWithPercentPrice::Cadence::OrSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewFloatingUnitWithPercentPrice::ConversionRateConfig::Unit,
              Orb::NewFloatingUnitWithPercentPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          cadence: Orb::NewFloatingUnitWithPercentPrice::Cadence::OrSymbol,
          currency: String,
          item_id: String,
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewFloatingUnitWithPercentPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewFloatingUnitWithPercentPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
          dimensional_price_configuration:
            T.nilable(Orb::NewDimensionalPriceConfiguration::OrHash),
      ...
      module Cadence
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewFloatingUnitWithPercentPrice::Cadence)
          end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewFloatingUnitWithPercentPrice::ModelType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        UNIT_WITH_PERCENT =
          T.let(
            :unit_with_percent,
            Orb::NewFloatingUnitWithPercentPrice::ModelType::TaggedSymbol
          )
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              unit_config:
                Orb::NewFloatingUnitWithPercentPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              tiered_config:
                Orb::NewFloatingUnitWithPercentPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewFloatingUnitWithPercentPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewFloatingUnitWithPercentPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[
              Orb::NewFloatingUnitWithPercentPrice::ConversionRateConfig::Variants
            ]
          )
        end
        def self.variants
