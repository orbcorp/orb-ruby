    ...
    class NewSubscriptionTieredPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewSubscriptionTieredPrice::ConversionRateConfig::Unit,
              Orb::NewSubscriptionTieredPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewSubscriptionTieredPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewSubscriptionTieredPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              unit_config:
                Orb::NewSubscriptionTieredPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              tiered_config:
                Orb::NewSubscriptionTieredPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          attr_writer :tiered_config
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewSubscriptionTieredPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewSubscriptionTieredPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[
              Orb::NewSubscriptionTieredPrice::ConversionRateConfig::Variants
            ]
          )
        end
        def self.variants
