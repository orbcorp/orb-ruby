...
module Orb
  module Models
    class NewPlanGroupedTieredPrice < Orb::Internal::Type::BaseModel
      ...
      sig { returns(Orb::NewPlanGroupedTieredPrice::GroupedTieredConfig) }
      attr_reader :grouped_tiered_config

      sig do
        params(
          grouped_tiered_config:
            Orb::NewPlanGroupedTieredPrice::GroupedTieredConfig::OrHash
        ).void
      end
        ...
        override.returns(
          {
            cadence: Orb::NewPlanGroupedTieredPrice::Cadence::OrSymbol,
            grouped_tiered_config:
              Orb::NewPlanGroupedTieredPrice::GroupedTieredConfig,
            item_id: String,
            model_type: Orb::NewPlanGroupedTieredPrice::ModelType::OrSymbol,
            name: String,
            billable_metric_id: T.nilable(String),
      ...
      class GroupedTieredConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[Orb::NewPlanGroupedTieredPrice::GroupedTieredConfig::Tier]
          )
        end
        attr_accessor :tiers
        ...
        sig do
          params(
            ...
            tiers:
              T::Array[
                Orb::NewPlanGroupedTieredPrice::GroupedTieredConfig::Tier::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(
          ...
          override.returns(
            {
              ...
              tiers:
                T::Array[
                  Orb::NewPlanGroupedTieredPrice::GroupedTieredConfig::Tier
                ]
            }
          )
        end
