    ...
    class NewSubscriptionGroupedWithMeteredMinimumPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        params(
          grouped_with_metered_minimum_config:
            Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::OrHash
        ).void
      end
      ...
      class GroupedWithMeteredMinimumConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::ScalingFactor
            ]
          )
        end
        ...
        sig do
          returns(
            T::Array[
              Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::UnitAmount
            ]
          )
        end
        ...
        sig do
          params(
            ...
            scaling_factors:
              T::Array[
                Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::ScalingFactor::OrHash
              ],
            scaling_key: String,
            unit_amounts:
              T::Array[
                Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::UnitAmount::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(
