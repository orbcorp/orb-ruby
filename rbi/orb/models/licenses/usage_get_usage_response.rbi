  ...
  module Models
    module Licenses
      class UsageGetUsageResponse < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(T::Array[Orb::Models::Licenses::UsageGetUsageResponse::Data])
        end
        attr_accessor :data
        ...
        sig do
          params(
            data:
              T::Array[
                Orb::Models::Licenses::UsageGetUsageResponse::Data::OrHash
              ],
        ...
        sig do
          override.returns(
            {
              data:
                T::Array[Orb::Models::Licenses::UsageGetUsageResponse::Data],
        ...
        class Data < Orb::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Orb::Models::Licenses::UsageGetUsageResponse::Data,
                Orb::Internal::AnyHash
              )
            end
