...
module Orb
  module Models
    class SubscriptionUnscheduleCancellationResponse < Orb::Internal::Type::BaseModel
      ...
      sig { returns(Orb::Models::SubscriptionUnscheduleCancellationResponse::BillingCycleAnchorConfiguration) }
      ...
      sig { returns(T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::FixedFeeQuantitySchedule]) }
      ...
      sig { returns(T.nilable(Orb::Models::SubscriptionUnscheduleCancellationResponse::PendingSubscriptionChange)) }
      ...
      sig { returns(Orb::Models::SubscriptionUnscheduleCancellationResponse::Status::TaggedSymbol) }
      ...
      sig { returns(T.nilable(Orb::Models::SubscriptionUnscheduleCancellationResponse::ChangedResources)) }
      attr_reader :changed_resources

      sig do
        params(
          changed_resources: T.nilable(
            T.any(Orb::Models::SubscriptionUnscheduleCancellationResponse::ChangedResources, Orb::Internal::AnyHash)
          )
        )
          .void
      end
      ...
      sig do
        params(
          ...
          start_date: Time,
          status: Orb::Models::SubscriptionUnscheduleCancellationResponse::Status::OrSymbol,
          trial_info: T.any(Orb::Models::SubscriptionUnscheduleCancellationResponse::TrialInfo, Orb::Internal::AnyHash),
          changed_resources: T.nilable(
            T.any(Orb::Models::SubscriptionUnscheduleCancellationResponse::ChangedResources, Orb::Internal::AnyHash)
          )
          ...
          .returns(
            {
              ...
              start_date: Time,
              status: Orb::Models::SubscriptionUnscheduleCancellationResponse::Status::TaggedSymbol,
              trial_info: Orb::Models::SubscriptionUnscheduleCancellationResponse::TrialInfo,
              changed_resources: T.nilable(Orb::Models::SubscriptionUnscheduleCancellationResponse::ChangedResources)
            }
          )
      end
      def to_hash; end
      ...
      class AdjustmentInterval < Orb::Internal::Type::BaseModel
        ...
        module Adjustment
          ...
          sig do
            override
              .returns(
                [Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::UsageDiscount, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::AmountDiscount, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::PercentageDiscount, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::Minimum, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::Maximum]
              )
          end
      ...
      module DiscountInterval
        ...
        sig do
          override
            .returns(
              [Orb::Models::SubscriptionUnscheduleCancellationResponse::DiscountInterval::Amount, Orb::Models::SubscriptionUnscheduleCancellationResponse::DiscountInterval::Percentage, Orb::Models::SubscriptionUnscheduleCancellationResponse::DiscountInterval::Usage]
            )
        end
        def self.variants; end
      end
      ...
      class PriceInterval < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::PriceInterval::FixedFeeQuantityTransition]
            )
          )
        end
      ...
      module Status
        ...
        UPCOMING =
          T.let(:upcoming, Orb::Models::SubscriptionUnscheduleCancellationResponse::Status::TaggedSymbol)

        sig { override.returns(T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::Status::TaggedSymbol]) }
        def self.values; end
      end
