    ...
    class SubscriptionTriggerPhaseResponse < Orb::Internal::Type::BaseModel
      ...
      sig do
        params(
          ...
          adjustment_intervals: T::Array[T.any(Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval, Orb::Internal::AnyHash)],
          ...
          maximum_intervals: T::Array[T.any(Orb::Models::SubscriptionTriggerPhaseResponse::MaximumInterval, Orb::Internal::AnyHash)],
      ...
      module DiscountInterval
        ...
        sig do
          override
            .returns(
              [Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Amount, Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Percentage, Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Usage]
            )
        end
        def self.variants; end
      end
