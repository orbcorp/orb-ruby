...
module Orb
  module Models
    class NewSubscriptionBulkPrice < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::NewSubscriptionBulkPrice, Orb::Internal::AnyHash)
        end
      ...
      sig { returns(Orb::NewSubscriptionBulkPrice::Cadence::OrSymbol) }
      ...
      sig { returns(Orb::NewSubscriptionBulkPrice::ModelType::OrSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Unit,
              Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          cadence: Orb::NewSubscriptionBulkPrice::Cadence::OrSymbol,
          item_id: String,
          model_type: Orb::NewSubscriptionBulkPrice::ModelType::OrSymbol,
          name: String,
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module Cadence
        ...
        sig do
          override.returns(
            T::Array[Orb::NewSubscriptionBulkPrice::Cadence::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewSubscriptionBulkPrice::ModelType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        BULK =
          T.let(:bulk, Orb::NewSubscriptionBulkPrice::ModelType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Orb::NewSubscriptionBulkPrice::ModelType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Unit::UnitConfig
            )
          end
          ...
          sig do
            params(
              unit_config:
                Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              tiered_config:
                Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[
              Orb::NewSubscriptionBulkPrice::ConversionRateConfig::Variants
            ]
          )
        end
        def self.variants
