...
module Orb
  module Models
    class NewPlanMinimumCompositePrice < Orb::Internal::Type::BaseModel
      ...
      sig { returns(Orb::NewPlanMinimumCompositePrice::Cadence::OrSymbol) }
      ...
      module Cadence
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewPlanMinimumCompositePrice::Cadence)
          end
        ...
        ANNUAL =
          T.let(
            :annual,
            Orb::NewPlanMinimumCompositePrice::Cadence::TaggedSymbol
          )
        SEMI_ANNUAL =
          T.let(
            :semi_annual,
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanMinimumCompositePrice::Cadence::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewPlanMinimumCompositePrice::ModelType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        sig do
          override.returns(
            T::Array[Orb::NewPlanMinimumCompositePrice::ModelType::TaggedSymbol]
          )
        end
        def self.values
        end
