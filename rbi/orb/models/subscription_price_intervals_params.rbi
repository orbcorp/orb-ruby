      ...
      class Add < Orb::Internal::Type::BaseModel
            ...
            price:
              T.nilable(
                T.any(
                  ...
                  Orb::SubscriptionPriceIntervalsParams::Add::Price::GroupedTieredMatrix::OrHash,
        ...
        module Price
          ...
          class GroupedTieredMatrix < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Orb::SubscriptionPriceIntervalsParams::Add::Price::GroupedTieredMatrix::Cadence::OrSymbol
              )
            end
            attr_accessor :cadence
            ...
            sig do
              params(
                grouped_tiered_matrix_config:
                  Orb::SubscriptionPriceIntervalsParams::Add::Price::GroupedTieredMatrix::GroupedTieredMatrixConfig::OrHash
              ).void
            end
            ...
            module Cadence
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::SubscriptionPriceIntervalsParams::Add::Price::GroupedTieredMatrix::Cadence
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            class GroupedTieredMatrixConfig < Orb::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T::Array[
                    Orb::SubscriptionPriceIntervalsParams::Add::Price::GroupedTieredMatrix::GroupedTieredMatrixConfig::Tier
                  ]
                )
              end
              attr_accessor :tiers
              ...
              sig do
                params(
                  ...
                  tiers:
                    T::Array[
                      Orb::SubscriptionPriceIntervalsParams::Add::Price::GroupedTieredMatrix::GroupedTieredMatrixConfig::Tier::OrHash
                    ]
                ).returns(T.attached_class)
              end
              def self.new(
