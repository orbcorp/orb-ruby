...
module Orb
  module Models
    class InvoiceDunningScheduleEndedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      sig { returns(Orb::InvoiceDunningScheduleEndedWebhookEvent::Properties) }
      attr_reader :properties

      sig do
        params(
          properties:
            Orb::InvoiceDunningScheduleEndedWebhookEvent::Properties::OrHash
        ).void
      end
      ...
      sig do
        returns(
          Orb::InvoiceDunningScheduleEndedWebhookEvent::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          properties:
            Orb::InvoiceDunningScheduleEndedWebhookEvent::Properties::OrHash,
          type: Orb::InvoiceDunningScheduleEndedWebhookEvent::Type::OrSymbol
        ...
        override.returns(
          {
            ...
            invoice: Orb::Invoice,
            properties:
              Orb::InvoiceDunningScheduleEndedWebhookEvent::Properties,
            type:
              Orb::InvoiceDunningScheduleEndedWebhookEvent::Type::TaggedSymbol
          }
        )
      ...
      class Properties < Orb::Internal::Type::BaseModel
        ...
        sig do
          params(
            dunning_schedule:
              Orb::InvoiceDunningScheduleEndedWebhookEvent::Properties::DunningSchedule::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T::Array[
              Orb::InvoiceDunningScheduleEndedWebhookEvent::Properties::DunningStep
            ]
          )
        end
        ...
        sig do
          params(
            ...
            dunning_steps:
              T::Array[
                Orb::InvoiceDunningScheduleEndedWebhookEvent::Properties::DunningStep::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(dunning_schedule:, dunning_steps:)
        end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::InvoiceDunningScheduleEndedWebhookEvent::Type)
          end
