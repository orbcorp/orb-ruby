...
module Orb
  module Models
    class SubscriptionPlanVersionChangeScheduledWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Orb::SubscriptionPlanVersionChangeScheduledWebhookEvent::Properties
        )
      end
      ...
      sig do
        params(
          properties:
            Orb::SubscriptionPlanVersionChangeScheduledWebhookEvent::Properties::OrHash
        ).void
      end
      ...
      sig do
        returns(
          Orb::SubscriptionPlanVersionChangeScheduledWebhookEvent::Type::TaggedSymbol
        )
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type:
            Orb::SubscriptionPlanVersionChangeScheduledWebhookEvent::Type::OrSymbol
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Orb::SubscriptionPlanVersionChangeScheduledWebhookEvent::Type
            )
          end
