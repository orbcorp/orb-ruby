...
module Orb
  module Models
    class CustomerEditedWebhookEvent < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::CustomerEditedWebhookEvent, Orb::Internal::AnyHash)
        end
      ...
      sig { returns(Orb::CustomerEditedWebhookEvent::Properties) }
      attr_reader :properties

      sig do
        params(
          properties: Orb::CustomerEditedWebhookEvent::Properties::OrHash
        ).void
      end
      attr_writer :properties

      # The event this payload describes.
      sig { returns(Orb::CustomerEditedWebhookEvent::Type::TaggedSymbol) }
      attr_accessor :type
      ...
      sig do
        params(
          ...
          properties: Orb::CustomerEditedWebhookEvent::Properties::OrHash,
          type: Orb::CustomerEditedWebhookEvent::Type::OrSymbol
        ...
        override.returns(
          {
            ...
            properties: Orb::CustomerEditedWebhookEvent::Properties,
            type: Orb::CustomerEditedWebhookEvent::Type::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      class Properties < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::CustomerEditedWebhookEvent::Properties,
        ...
        sig do
          returns(
            Orb::CustomerEditedWebhookEvent::Properties::PreviousAttributes
          )
        end
        ...
        sig do
          params(
            previous_attributes:
              Orb::CustomerEditedWebhookEvent::Properties::PreviousAttributes::OrHash
          ).void
        end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Orb::CustomerEditedWebhookEvent::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        CUSTOMER_EDITED =
          T.let(
            :"customer.edited",
            Orb::CustomerEditedWebhookEvent::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Orb::CustomerEditedWebhookEvent::Type::TaggedSymbol]
          )
        end
        def self.values
        end
