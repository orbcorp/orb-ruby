    ...
    class NewPlanScalableMatrixWithUnitPricingPrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewPlanScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit,
              Orb::NewPlanScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewPlanScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewPlanScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              unit_config:
                Orb::NewPlanScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              tiered_config:
                Orb::NewPlanScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewPlanScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewPlanScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[
              Orb::NewPlanScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Variants
            ]
          )
        end
        def self.variants
