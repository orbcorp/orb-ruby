...
module Orb
  module Models
    class NewPlanGroupedTieredPackagePrice < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Orb::NewPlanGroupedTieredPackagePrice, Orb::Internal::AnyHash)
        end
      ...
      sig do
        returns(
          T.nilable(
            T.any(
              Orb::NewPlanGroupedTieredPackagePrice::ConversionRateConfig::Unit,
              Orb::NewPlanGroupedTieredPackagePrice::ConversionRateConfig::Tiered
            )
          )
        )
      end
      ...
      sig do
        params(
          ...
          conversion_rate_config:
            T.nilable(
              T.any(
                Orb::NewPlanGroupedTieredPackagePrice::ConversionRateConfig::Unit::OrHash,
                Orb::NewPlanGroupedTieredPackagePrice::ConversionRateConfig::Tiered::OrHash
              )
            ),
      ...
      module Cadence
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewPlanGroupedTieredPackagePrice::Cadence)
          end
        ...
        ANNUAL =
          T.let(
            :annual,
            Orb::NewPlanGroupedTieredPackagePrice::Cadence::TaggedSymbol
          )
        SEMI_ANNUAL =
          T.let(
            :semi_annual,
      ...
      module ModelType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::NewPlanGroupedTieredPackagePrice::ModelType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        GROUPED_TIERED_PACKAGE =
          T.let(
            :grouped_tiered_package,
            Orb::NewPlanGroupedTieredPackagePrice::ModelType::TaggedSymbol
          )
      ...
      module ConversionRateConfig
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              unit_config:
                Orb::NewPlanGroupedTieredPackagePrice::ConversionRateConfig::Unit::UnitConfig::OrHash
            ).void
          end
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          sig do
            params(
              tiered_config:
                Orb::NewPlanGroupedTieredPackagePrice::ConversionRateConfig::Tiered::TieredConfig::OrHash
            ).void
          end
          ...
          class TieredConfig < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Orb::NewPlanGroupedTieredPackagePrice::ConversionRateConfig::Tiered::TieredConfig::Tier
                ]
              )
            end
            attr_accessor :tiers
            ...
            sig do
              params(
                tiers:
                  T::Array[
                    Orb::NewPlanGroupedTieredPackagePrice::ConversionRateConfig::Tiered::TieredConfig::Tier::OrHash
                  ]
              ).returns(T.attached_class)
            end
            def self.new(
        ...
        sig do
          override.returns(
            T::Array[
              Orb::NewPlanGroupedTieredPackagePrice::ConversionRateConfig::Variants
            ]
          )
        end
        def self.variants
