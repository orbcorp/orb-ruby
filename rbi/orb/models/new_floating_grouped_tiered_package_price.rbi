    ...
    class NewFloatingGroupedTieredPackagePrice < Orb::Internal::Type::BaseModel
      ...
      sig do
        params(
          grouped_tiered_package_config:
            Orb::NewFloatingGroupedTieredPackagePrice::GroupedTieredPackageConfig::OrHash
        ).void
      end
      ...
      class GroupedTieredPackageConfig < Orb::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Orb::NewFloatingGroupedTieredPackagePrice::GroupedTieredPackageConfig::Tier
            ]
          )
        end
        attr_accessor :tiers
        ...
        sig do
          params(
            ...
            tiers:
              T::Array[
                Orb::NewFloatingGroupedTieredPackagePrice::GroupedTieredPackageConfig::Tier::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(
