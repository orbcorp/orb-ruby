...
module Orb
  module Models
    class SubscriptionPlanChangedWebhookEvent < Orb::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
      ...
      sig { returns(Orb::SubscriptionPlanChangedWebhookEvent::Properties) }
      attr_reader :properties

      sig do
        params(
          properties:
            Orb::SubscriptionPlanChangedWebhookEvent::Properties::OrHash
        ).void
      end
      ...
      sig do
        returns(Orb::SubscriptionPlanChangedWebhookEvent::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          ...
          type: Orb::SubscriptionPlanChangedWebhookEvent::Type::OrSymbol
        ...
        override.returns(
          {
            id: String,
            created_at: Time,
            properties: Orb::SubscriptionPlanChangedWebhookEvent::Properties,
            subscription: Orb::Subscription,
            type: Orb::SubscriptionPlanChangedWebhookEvent::Type::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      class Properties < Orb::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Orb::SubscriptionPlanChangedWebhookEvent::Properties,
              Orb::Internal::AnyHash
            )
          end
        ...
        sig { params(previous_plan_id: String).returns(T.attached_class) }
        def self.new(previous_plan_id:)
        end

        sig { override.returns({ previous_plan_id: String }) }
        def to_hash
        end
      end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Orb::SubscriptionPlanChangedWebhookEvent::Type)
          end
        ...
        SUBSCRIPTION_PLAN_CHANGED =
          T.let(
            ...
            Orb::SubscriptionPlanChangedWebhookEvent::Type::TaggedSymbol
          )
