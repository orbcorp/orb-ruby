      ...
      class AddPrice < Orb::Internal::Type::BaseModel
          ...
          returns(
            T.nilable(
              T.any(
                ...
                Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum,
            ...
            price:
              T.nilable(
                T.any(
                  ...
                  Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::OrHash,
        ...
        module Price
          ...
          class Minimum < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::Cadence::OrSymbol
              )
            end
            attr_accessor :cadence
            ...
            sig do
              returns(
                Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::MinimumConfig
              )
            end
            ...
            sig do
              params(
                minimum_config:
                  Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::MinimumConfig::OrHash
              ).void
            end
            ...
            module Cadence
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::Cadence
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              ANNUAL =
                T.let(
                  :annual,
                  Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::Cadence::TaggedSymbol
                )
              SEMI_ANNUAL =
                T.let(
                  :semi_annual,
      ...
      class ReplacePrice < Orb::Internal::Type::BaseModel
          ...
          returns(
            T.nilable(
              T.any(
                ...
                Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum,
                Orb::NewPlanMinimumCompositePrice,
            ...
            price:
              T.nilable(
                T.any(
                  ...
                  Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::OrHash,
                  Orb::NewPlanMinimumCompositePrice::OrHash,
        ...
        module Price
          ...
          class Minimum < Orb::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::Cadence::OrSymbol
              )
            end
            attr_accessor :cadence
            ...
            sig do
              returns(
                Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::MinimumConfig
              )
            end
            attr_reader :minimum_config
            ...
            sig do
              params(
                minimum_config:
                  Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::MinimumConfig::OrHash
              ).void
            end
            attr_writer :minimum_config
            ...
            module Cadence
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::Cadence
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              ANNUAL =
                T.let(
                  :annual,
                  Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::Cadence::TaggedSymbol
                )
              SEMI_ANNUAL =
                T.let(
                  :semi_annual,
