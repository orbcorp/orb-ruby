...
module Orb
  ...
  CreditBlockAccountingSyncFailedWebhookEvent =
    Orb::Models::CreditBlockAccountingSyncFailedWebhookEvent
  ...
  CreditNoteMarkedAsVoidWebhookEvent =
    Orb::Models::CreditNoteMarkedAsVoidWebhookEvent
  ...
  CustomerAccountingSyncFailedWebhookEvent =
    Orb::Models::CustomerAccountingSyncFailedWebhookEvent

  CustomerAccountingSyncSucceededWebhookEvent =
    Orb::Models::CustomerAccountingSyncSucceededWebhookEvent
  ...
  CustomerCreditBalanceDroppedWebhookEvent =
    Orb::Models::CustomerCreditBalanceDroppedWebhookEvent

  CustomerCreditBalanceRecoveredWebhookEvent =
    Orb::Models::CustomerCreditBalanceRecoveredWebhookEvent

  CustomerCreditLedgerIncrementedWebhookEvent =
    Orb::Models::CustomerCreditLedgerIncrementedWebhookEvent
  ...
  DataExportsTransferErrorWebhookEvent =
    Orb::Models::DataExportsTransferErrorWebhookEvent

  DataExportsTransferSuccessWebhookEvent =
    Orb::Models::DataExportsTransferSuccessWebhookEvent
  ...
  IngestionUnmatchedCustomerIDsWebhookEvent =
    Orb::Models::IngestionUnmatchedCustomerIDsWebhookEvent

  Invoice = Orb::Models::Invoice

  InvoiceAccountingSyncFailedWebhookEvent =
    Orb::Models::InvoiceAccountingSyncFailedWebhookEvent

  InvoiceAccountingSyncSucceededWebhookEvent =
    Orb::Models::InvoiceAccountingSyncSucceededWebhookEvent
  ...
  InvoiceCostDataExportedWebhookEvent =
    Orb::Models::InvoiceCostDataExportedWebhookEvent
  ...
  InvoiceDunningScheduleCreatedWebhookEvent =
    Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent

  InvoiceDunningScheduleEndedWebhookEvent =
    Orb::Models::InvoiceDunningScheduleEndedWebhookEvent

  InvoiceDunningScheduleResetWebhookEvent =
    Orb::Models::InvoiceDunningScheduleResetWebhookEvent
  ...
  InvoiceInvoiceDateElapsedWebhookEvent =
    Orb::Models::InvoiceInvoiceDateElapsedWebhookEvent

  InvoiceIssuedSummaryWebhookEvent =
    Orb::Models::InvoiceIssuedSummaryWebhookEvent
  ...
  InvoiceManuallyMarkedAsPaidWebhookEvent =
    Orb::Models::InvoiceManuallyMarkedAsPaidWebhookEvent

  InvoiceManuallyMarkedAsVoidWebhookEvent =
    Orb::Models::InvoiceManuallyMarkedAsVoidWebhookEvent

  InvoiceMarkPaidParams = Orb::Models::InvoiceMarkPaidParams

  InvoicePaymentFailedWebhookEvent =
    Orb::Models::InvoicePaymentFailedWebhookEvent

  InvoicePaymentProcessingWebhookEvent =
    Orb::Models::InvoicePaymentProcessingWebhookEvent

  InvoicePaymentSucceededWebhookEvent =
    Orb::Models::InvoicePaymentSucceededWebhookEvent
  ...
  InvoiceSyncSucceededWebhookEvent =
    Orb::Models::InvoiceSyncSucceededWebhookEvent

  InvoiceTiny = Orb::Models::InvoiceTiny

  InvoiceUndoMarkAsPaidWebhookEvent =
    Orb::Models::InvoiceUndoMarkAsPaidWebhookEvent
  ...
  LicenseRetrieveByExternalIDParams =
    Orb::Models::LicenseRetrieveByExternalIDParams
  ...
  MetricEventsDroppedByWatermarkWebhookEvent =
    Orb::Models::MetricEventsDroppedByWatermarkWebhookEvent
  ...
  NewSubscriptionMinimumCompositePrice =
    Orb::Models::NewSubscriptionMinimumCompositePrice
  ...
  PaymentMethodDeletedWebhookEvent =
    Orb::Models::PaymentMethodDeletedWebhookEvent
  ...
  PlanDefaultVersionSetWebhookEvent =
    Orb::Models::PlanDefaultVersionSetWebhookEvent
  ...
  SalesOrderAccountingSyncFailedWebhookEvent =
    Orb::Models::SalesOrderAccountingSyncFailedWebhookEvent
  ...
  SubscriptionAlertDisabledWebhookEvent =
    Orb::Models::SubscriptionAlertDisabledWebhookEvent
  ...
  SubscriptionCostExceededWebhookEvent =
    Orb::Models::SubscriptionCostExceededWebhookEvent
  ...
  SubscriptionGroupedCostExceededWebhookEvent =
    Orb::Models::SubscriptionGroupedCostExceededWebhookEvent
  ...
  SubscriptionPlanChangedWebhookEvent =
    Orb::Models::SubscriptionPlanChangedWebhookEvent

  SubscriptionPlanChangeScheduledWebhookEvent =
    Orb::Models::SubscriptionPlanChangeScheduledWebhookEvent
  ...
  SubscriptionUsageExceededWebhookEvent =
    Orb::Models::SubscriptionUsageExceededWebhookEvent
  ...
  TransactionAccountingSyncFailedWebhookEvent =
    Orb::Models::TransactionAccountingSyncFailedWebhookEvent
