...
module Orb
  module Type
    ...
    module Union
      ...
      sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Orb::Type::Converter::Input)]]) }
      ...
      # @api private
      sig { override.params(value: T.anything, state: Orb::Type::Converter::State).returns(T.anything) }
