...
module Orb
  module Models
    class SubscriptionUnschedulePendingPlanChangesResponse < Orb::BaseModel
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::AdjustmentInterval])
      ...
      sig { returns(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::BillingCycleAnchorConfiguration) }
      def billing_cycle_anchor_configuration
      end

      sig do
        params(_: Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::BillingCycleAnchorConfiguration)
      ...
      sig { returns(T::Array[Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::FixedFeeQuantitySchedule]) }
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::MaximumInterval])
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::MinimumInterval])
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::PriceInterval])
          .returns(T::Array[Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::PriceInterval])
      end
      def price_intervals=(_)
      end

      sig { returns(T.nilable(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::RedeemedCoupon)) }
      def redeemed_coupon
      end

      sig do
        params(_: T.nilable(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::RedeemedCoupon))
      ...
      sig do
        params(_: Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::TrialInfo)
          .returns(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::TrialInfo)
      end
      def trial_info=(_)
      end
