...
module Orb
  module Models
    class SubscriptionUnschedulePendingPlanChangesResponse < Orb::BaseModel
      ...
      sig do
        params(
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::RedeemedCoupon, Orb::Util::AnyHash)
          )
        )
          .void
      end
      ...
      sig { returns(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::Status::TaggedSymbol) }
      ...
      sig do
        params(
          trial_info: T.any(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::TrialInfo, Orb::Util::AnyHash)
        )
          .void
      end
      ...
      sig do
        params(
          ...
          maximum_intervals: T::Array[T.any(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::MaximumInterval, Orb::Util::AnyHash)],
          metadata: T::Hash[Symbol, String],
          minimum_intervals: T::Array[T.any(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::MinimumInterval, Orb::Util::AnyHash)],
          net_terms: Integer,
          plan: T.any(Orb::Models::Plan, Orb::Util::AnyHash),
          price_intervals: T::Array[T.any(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::PriceInterval, Orb::Util::AnyHash)],
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::RedeemedCoupon, Orb::Util::AnyHash)
          ),
          start_date: Time,
      ...
      module Status
        ...
        OrSymbol =
          T.type_alias { T.any(Symbol, Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::Status::TaggedSymbol) }

        ACTIVE =
          T.let(:active, Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::Status::TaggedSymbol)
        ENDED =
          T.let(:ended, Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::Status::TaggedSymbol)
        UPCOMING =
          T.let(:upcoming, Orb::Models::SubscriptionUnschedulePendingPlanChangesResponse::Status::TaggedSymbol)
