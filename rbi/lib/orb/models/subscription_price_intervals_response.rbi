...
module Orb
  module Models
    class SubscriptionPriceIntervalsResponse < Orb::BaseModel
      Shape = T.type_alias do
        {
          ...
          adjustment_intervals: T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval],
          ...
          discount_intervals: T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::Variants],
          end_date: T.nilable(Time),
          fixed_fee_quantity_schedule: T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::FixedFeeQuantitySchedule],
          invoicing_threshold: T.nilable(String),
          maximum_intervals: T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::MaximumInterval],
      ...
      sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::BillingCycleAnchorConfiguration) }
      ...
      sig { returns(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::Variants]) }
      attr_accessor :discount_intervals

      sig { returns(T.nilable(Time)) }
      attr_accessor :end_date

      sig { returns(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::FixedFeeQuantitySchedule]) }
      attr_accessor :fixed_fee_quantity_schedule

      sig { returns(T.nilable(String)) }
      attr_accessor :invoicing_threshold

      sig { returns(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::MaximumInterval]) }
      attr_accessor :maximum_intervals

      sig { returns(T::Hash[Symbol, String]) }
      attr_accessor :metadata

      sig { returns(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::MinimumInterval]) }
      ...
      sig { returns(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval]) }
      attr_accessor :price_intervals

      sig { returns(T.nilable(Orb::Models::SubscriptionPriceIntervalsResponse::RedeemedCoupon)) }
      ...
      sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::TrialInfo) }
      ...
      sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::Shape) }
      def to_h; end
      ...
      class AdjustmentInterval < Orb::BaseModel
        Shape = T.type_alias do
          {
            id: String,
            adjustment: Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::Variants,
        ...
        sig do
          returns(Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::Variants)
        end
        ...
        sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Shape) }
        def to_h; end
        ...
        class Adjustment < Orb::Union
          ...
          Variants = T.type_alias do
            T.any(
              Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::MaximumAdjustment
            )
          end
          ...
          class AmountDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class PercentageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class UsageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MinimumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::MinimumAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MaximumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::MaximumAdjustment::Shape)
            end
            def to_h; end
          end
      ...
      class BillingCycleAnchorConfiguration < Orb::BaseModel
        ...
        sig do
          returns(Orb::Models::SubscriptionPriceIntervalsResponse::BillingCycleAnchorConfiguration::Shape)
        end
        def to_h; end
      end
      ...
      class DiscountInterval < Orb::Union
        ...
        class AmountDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::AmountDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class PercentageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::PercentageDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class UsageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::UsageDiscountInterval::Shape)
          end
          def to_h; end
        end
      ...
      class FixedFeeQuantitySchedule < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::FixedFeeQuantitySchedule::Shape) }
        def to_h; end
      end
      ...
      class MaximumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::MaximumInterval::Shape) }
        def to_h; end
      end
      ...
      class MinimumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::MinimumInterval::Shape) }
        def to_h; end
      end
      ...
      class PriceInterval < Orb::BaseModel
        Shape = T.type_alias do
          {
            ...
            current_billing_period_start_date: T.nilable(Time),
            end_date: T.nilable(Time),
            fixed_fee_quantity_transitions: T.nilable(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval::FixedFeeQuantityTransition]),
        ...
        sig do
          returns(T.nilable(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval::FixedFeeQuantityTransition]))
        end
        ...
        sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval::Shape) }
        def to_h; end
        ...
        class FixedFeeQuantityTransition < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval::FixedFeeQuantityTransition::Shape)
          end
          def to_h; end
        end
      end
      ...
      class RedeemedCoupon < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::RedeemedCoupon::Shape) }
        def to_h; end
      end
      ...
      class TrialInfo < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionPriceIntervalsResponse::TrialInfo::Shape) }
        def to_h; end
      end
    end
  end
