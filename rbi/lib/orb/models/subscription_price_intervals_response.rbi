...
module Orb
  module Models
    class SubscriptionPriceIntervalsResponse < Orb::BaseModel
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval])
          .returns(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval])
      end
      ...
      sig do
        params(_: Orb::Models::SubscriptionPriceIntervalsResponse::BillingCycleAnchorConfiguration)
          .returns(Orb::Models::SubscriptionPriceIntervalsResponse::BillingCycleAnchorConfiguration)
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::MaximumInterval])
          .returns(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::MaximumInterval])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::MinimumInterval])
          .returns(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::MinimumInterval])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval])
          .returns(T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval])
      end
      ...
      sig do
        params(_: T.nilable(Orb::Models::SubscriptionPriceIntervalsResponse::RedeemedCoupon))
          .returns(T.nilable(Orb::Models::SubscriptionPriceIntervalsResponse::RedeemedCoupon))
      end
      ...
      sig do
        params(_: Orb::Models::SubscriptionPriceIntervalsResponse::TrialInfo)
        ...
        class Adjustment < Orb::Union
          ...
          class << self
            sig do
              override
                .returns(
                  [[Symbol, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseUsageDiscountAdjustment], [Symbol, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseAmountDiscountAdjustment], [Symbol, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhasePercentageDiscountAdjustment], [Symbol, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseMinimumAdjustment], [Symbol, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseMaximumAdjustment]]
                )
            end
      ...
      class DiscountInterval < Orb::Union
        ...
        class << self
          sig do
            override
              .returns(
                [[Symbol, Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::AmountDiscountInterval], [Symbol, Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::PercentageDiscountInterval], [Symbol, Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::UsageDiscountInterval]]
              )
          end
          private def variants
          end
      ...
      class FixedFeeQuantitySchedule < Orb::BaseModel
        ...
        sig { override.returns({end_date: T.nilable(Time), price_id: String, quantity: Float, start_date: Time}) }
        def to_hash
        end
      end
      ...
      class PriceInterval < Orb::BaseModel
        ...
        sig do
          returns(
              T.nilable(
                T::Array[Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval::FixedFeeQuantityTransition]
              )
            )
        end
      ...
      class RedeemedCoupon < Orb::BaseModel
        ...
        sig { params(coupon_id: String, end_date: T.nilable(Time), start_date: Time).returns(T.attached_class) }
