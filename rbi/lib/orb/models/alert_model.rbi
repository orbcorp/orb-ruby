...
module Orb
  module Models
    class AlertModel < Orb::BaseModel
      ...
      sig { returns(T.nilable(Orb::Models::AlertModel::Metric)) }
      def metric
      end

      sig { params(_: T.nilable(Orb::Models::AlertModel::Metric)).returns(T.nilable(Orb::Models::AlertModel::Metric)) }
      def metric=(_)
      end

      sig { returns(T.nilable(Orb::Models::AlertModel::Plan)) }
      def plan
      end

      sig { params(_: T.nilable(Orb::Models::AlertModel::Plan)).returns(T.nilable(Orb::Models::AlertModel::Plan)) }
      def plan=(_)
      end
      ...
      sig do
        params(
          ...
          enabled: T::Boolean,
          metric: T.nilable(Orb::Models::AlertModel::Metric),
          plan: T.nilable(Orb::Models::AlertModel::Plan),
