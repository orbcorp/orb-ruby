...
module Orb
  module Models
    class SubscriptionTriggerPhaseResponse < Orb::BaseModel
      Shape = T.type_alias do
        {
          ...
          discount_intervals: T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Variants],
      ...
      sig { returns(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Variants]) }
      ...
      sig { returns(Orb::Models::SubscriptionTriggerPhaseResponse::Shape) }
      def to_h; end
      ...
      class AdjustmentInterval < Orb::BaseModel
        Shape = T.type_alias do
          {
            id: String,
            adjustment: Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::Variants,
        ...
        sig do
          returns(Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::Variants)
        end
        ...
        sig { returns(Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Shape) }
        def to_h; end
        ...
        class Adjustment < Orb::Union
          ...
          class AmountDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class PercentageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class UsageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MinimumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::MinimumAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MaximumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::MaximumAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          sig do
            override.returns(
              [
                [
                  Symbol,
                  Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::MinimumAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval::Adjustment::MaximumAdjustment
                ]
              ]
            )
          end
      ...
      class BillingCycleAnchorConfiguration < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionTriggerPhaseResponse::BillingCycleAnchorConfiguration::Shape) }
        def to_h; end
      end
      ...
      class DiscountInterval < Orb::Union
        ...
        class AmountDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::AmountDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class PercentageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::PercentageDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class UsageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::UsageDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        sig do
          override.returns(
            [
              ...
              [Symbol, Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::UsageDiscountInterval]
            ]
          )
        end
        private_class_method def self.variants; end
      ...
      class FixedFeeQuantitySchedule < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionTriggerPhaseResponse::FixedFeeQuantitySchedule::Shape) }
        def to_h; end
      end
      ...
      class MaximumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionTriggerPhaseResponse::MaximumInterval::Shape) }
        def to_h; end
      end
      ...
      class MinimumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionTriggerPhaseResponse::MinimumInterval::Shape) }
        def to_h; end
      end
      ...
      class PriceInterval < Orb::BaseModel
        Shape = T.type_alias do
          {
            ...
            current_billing_period_start_date: T.nilable(Time),
            end_date: T.nilable(Time),
            fixed_fee_quantity_transitions: T.nilable(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval::FixedFeeQuantityTransition]),
        ...
        sig do
          returns(T.nilable(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval::FixedFeeQuantityTransition]))
        end
        ...
        sig { returns(Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval::Shape) }
        def to_h; end
        ...
        class FixedFeeQuantityTransition < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval::FixedFeeQuantityTransition::Shape)
          end
          def to_h; end
        end
      end
      ...
      class RedeemedCoupon < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionTriggerPhaseResponse::RedeemedCoupon::Shape) }
        def to_h; end
      end
      ...
      class TrialInfo < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionTriggerPhaseResponse::TrialInfo::Shape) }
        def to_h; end
      end
    end
  end
