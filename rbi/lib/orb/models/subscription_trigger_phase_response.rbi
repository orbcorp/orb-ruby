...
module Orb
  module Models
    class SubscriptionTriggerPhaseResponse < Orb::BaseModel
      ...
      sig do
        params(
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionTriggerPhaseResponse::RedeemedCoupon, Orb::Internal::Util::AnyHash)
          )
        )
          .void
      end
      ...
      sig do
        params(
          trial_info: T.any(Orb::Models::SubscriptionTriggerPhaseResponse::TrialInfo, Orb::Internal::Util::AnyHash)
        )
          .void
      end
      ...
      sig do
        params(
          ...
          adjustment_intervals: T::Array[T.any(Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval, Orb::Internal::Util::AnyHash)],
          ...
          maximum_intervals: T::Array[T.any(Orb::Models::SubscriptionTriggerPhaseResponse::MaximumInterval, Orb::Internal::Util::AnyHash)],
          metadata: T::Hash[Symbol, String],
          minimum_intervals: T::Array[T.any(Orb::Models::SubscriptionTriggerPhaseResponse::MinimumInterval, Orb::Internal::Util::AnyHash)],
          net_terms: Integer,
          plan: T.any(Orb::Models::Plan, Orb::Internal::Util::AnyHash),
          price_intervals: T::Array[T.any(Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval, Orb::Internal::Util::AnyHash)],
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionTriggerPhaseResponse::RedeemedCoupon, Orb::Internal::Util::AnyHash)
          ),
          start_date: Time,
