...
module Orb
  module Models
    class SubscriptionTriggerPhaseResponse < Orb::BaseModel
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval]).returns(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval])
      end
      ...
      sig do
        params(_: Orb::Models::SubscriptionTriggerPhaseResponse::BillingCycleAnchorConfiguration).returns(Orb::Models::SubscriptionTriggerPhaseResponse::BillingCycleAnchorConfiguration)
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::FixedFeeQuantitySchedule]).returns(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::FixedFeeQuantitySchedule])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::MaximumInterval]).returns(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::MaximumInterval])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::MinimumInterval]).returns(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::MinimumInterval])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval]).returns(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval])
      end
      ...
      sig do
        params(_: T.nilable(Orb::Models::SubscriptionTriggerPhaseResponse::RedeemedCoupon)).returns(T.nilable(Orb::Models::SubscriptionTriggerPhaseResponse::RedeemedCoupon))
      end
      ...
      sig do
        params(_: Orb::Models::SubscriptionTriggerPhaseResponse::TrialInfo).returns(Orb::Models::SubscriptionTriggerPhaseResponse::TrialInfo)
      end
      def trial_info=(_)
      end
      ...
      class PriceInterval < Orb::BaseModel
        ...
        sig do
          params(
            _: T.nilable(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval::FixedFeeQuantityTransition])
          ).returns(T.nilable(T::Array[Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval::FixedFeeQuantityTransition]))
        end
