...
module Orb
  module Models
    class CustomerModel < Orb::BaseModel
      ...
      sig { returns(Orb::Models::CustomerModel::Hierarchy) }
      def hierarchy
      end

      sig { params(_: Orb::Models::CustomerModel::Hierarchy).returns(Orb::Models::CustomerModel::Hierarchy) }
      def hierarchy=(_)
      end
      ...
      sig { returns(T.nilable(Orb::Models::CustomerModel::AccountingSyncConfiguration)) }
      def accounting_sync_configuration
      end

      sig do
        params(_: T.nilable(Orb::Models::CustomerModel::AccountingSyncConfiguration))
          .returns(T.nilable(Orb::Models::CustomerModel::AccountingSyncConfiguration))
      end
      def accounting_sync_configuration=(_)
      end

      sig { returns(T.nilable(Orb::Models::CustomerModel::ReportingConfiguration)) }
      def reporting_configuration
      end

      sig do
        params(_: T.nilable(Orb::Models::CustomerModel::ReportingConfiguration))
          .returns(T.nilable(Orb::Models::CustomerModel::ReportingConfiguration))
      end
      ...
      sig do
        params(
          ...
          timezone: String,
          accounting_sync_configuration: T.nilable(Orb::Models::CustomerModel::AccountingSyncConfiguration),
          reporting_configuration: T.nilable(Orb::Models::CustomerModel::ReportingConfiguration)
        )
          .void
      end
      def initialize(
      ...
      class AccountingSyncConfiguration < Orb::BaseModel
        sig { returns(T::Array[Orb::Models::CustomerModel::AccountingSyncConfiguration::AccountingProvider]) }
        def accounting_providers
        end

        sig do
          params(_: T::Array[Orb::Models::CustomerModel::AccountingSyncConfiguration::AccountingProvider])
            .returns(T::Array[Orb::Models::CustomerModel::AccountingSyncConfiguration::AccountingProvider])
        end
        ...
        sig do
          params(
            accounting_providers: T::Array[Orb::Models::CustomerModel::AccountingSyncConfiguration::AccountingProvider],
            excluded: T::Boolean
          )
            .void
        end
