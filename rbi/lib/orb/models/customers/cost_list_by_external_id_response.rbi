  ...
  module Models
    module Customers
      class CostListByExternalIDResponse < Orb::BaseModel
        ...
        sig do
          params(_: T::Array[Orb::Models::Customers::CostListByExternalIDResponse::Data]).returns(T::Array[Orb::Models::Customers::CostListByExternalIDResponse::Data])
        end
        def data=(_)
        end
        ...
        class Data < Orb::BaseModel
          ...
          sig do
            params(_: T::Array[Orb::Models::Customers::CostListByExternalIDResponse::Data::PerPriceCost]).returns(T::Array[Orb::Models::Customers::CostListByExternalIDResponse::Data::PerPriceCost])
          end
          ...
          sig do
            override.returns(
              {
                per_price_costs: T::Array[Orb::Models::Customers::CostListByExternalIDResponse::Data::PerPriceCost], subtotal: String, timeframe_end: Time, timeframe_start: Time, total: String
              }
            )
          end
          def to_hash
