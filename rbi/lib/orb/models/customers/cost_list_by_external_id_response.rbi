  ...
  module Models
    module Customers
      class CostListByExternalIDResponse < Orb::BaseModel
        ...
        sig do
          params(_: T::Array[Orb::Models::Customers::CostListByExternalIDResponse::Data])
            .returns(T::Array[Orb::Models::Customers::CostListByExternalIDResponse::Data])
        end
        def data=(_)
        end
        ...
        class Data < Orb::BaseModel
          ...
          sig do
            params(_: T::Array[Orb::Models::Customers::CostListByExternalIDResponse::Data::PerPriceCost])
              .returns(T::Array[Orb::Models::Customers::CostListByExternalIDResponse::Data::PerPriceCost])
          end
