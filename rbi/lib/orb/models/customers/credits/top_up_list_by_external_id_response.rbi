    ...
    module Customers
      module Credits
        class TopUpListByExternalIDResponse < Orb::BaseModel
          ...
          sig { returns(Orb::Models::Customers::Credits::TopUpListByExternalIDResponse::Shape) }
          def to_h; end
          ...
          class InvoiceSettings < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::Customers::Credits::TopUpListByExternalIDResponse::InvoiceSettings::Shape)
            end
            def to_h; end
          end
