    ...
    module Customers
      module Credits
        class TopUpCreateByExternalIDResponse < Orb::BaseModel
          ...
          sig do
            params(_: Orb::Models::Customers::Credits::TopUpCreateByExternalIDResponse::InvoiceSettings).returns(Orb::Models::Customers::Credits::TopUpCreateByExternalIDResponse::InvoiceSettings)
          end
