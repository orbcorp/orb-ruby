    ...
    module Customers
      module Credits
        class TopUpCreateByExternalIDParams < Orb::BaseModel
          ...
          sig { returns(Orb::Models::Customers::Credits::TopUpCreateByExternalIDParams::InvoiceSettings) }
          def invoice_settings
          end

          sig do
            params(_: Orb::Models::Customers::Credits::TopUpCreateByExternalIDParams::InvoiceSettings).returns(Orb::Models::Customers::Credits::TopUpCreateByExternalIDParams::InvoiceSettings)
          end
