    ...
    module Customers
      module Credits
        class TopUpCreateByExternalIDParams < Orb::BaseModel
          ...
          sig do
            returns(
              T.nilable(Orb::Models::Customers::Credits::TopUpCreateByExternalIDParams::ExpiresAfterUnit::OrSymbol)
            )
          end
          ...
          module ExpiresAfterUnit
            ...
            sig do
              override
                .returns(
                  T::Array[Orb::Models::Customers::Credits::TopUpCreateByExternalIDParams::ExpiresAfterUnit::TaggedSymbol]
                )
            end
            def self.values
            end
