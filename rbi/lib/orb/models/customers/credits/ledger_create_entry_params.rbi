    ...
    module Customers
      module Credits
        class LedgerCreateEntryParams < Orb::BaseModel
          ...
          sig { returns(Orb::Models::Customers::Credits::LedgerCreateEntryParams::Shape) }
          def to_h; end
          ...
          class InvoiceSettings < Orb::BaseModel
            ...
            sig { returns(Orb::Models::Customers::Credits::LedgerCreateEntryParams::InvoiceSettings::Shape) }
            def to_h; end
          end
