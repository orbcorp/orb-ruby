    ...
    module Customers
      module Credits
        class TopUpListResponse < Orb::BaseModel
          ...
          sig { returns(Orb::Models::Customers::Credits::TopUpListResponse::InvoiceSettings) }
          ...
          sig { returns(Orb::Models::Customers::Credits::TopUpListResponse::Shape) }
          def to_h; end
          ...
          class InvoiceSettings < Orb::BaseModel
            ...
            sig { returns(Orb::Models::Customers::Credits::TopUpListResponse::InvoiceSettings::Shape) }
            def to_h; end
          end
