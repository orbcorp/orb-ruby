    ...
    module Customers
      module Credits
        class TopUpListResponse < Orb::BaseModel
          ...
          sig do
            params(
              invoice_settings: T.any(Orb::Models::Customers::Credits::TopUpListResponse::InvoiceSettings, Orb::Util::AnyHash)
            )
              .void
          end
          ...
          sig { returns(T.nilable(Orb::Models::Customers::Credits::TopUpListResponse::ExpiresAfterUnit::TaggedSymbol)) }
          ...
          sig do
            params(
              ...
              expires_after_unit: T.nilable(Orb::Models::Customers::Credits::TopUpListResponse::ExpiresAfterUnit::OrSymbol)
            )
              ...
              .returns(
                {
                  ...
                  threshold: String,
                  expires_after: T.nilable(Integer),
                  expires_after_unit: T.nilable(Orb::Models::Customers::Credits::TopUpListResponse::ExpiresAfterUnit::TaggedSymbol)
                }
              )
          end
          def to_hash
          ...
          module ExpiresAfterUnit
            ...
            OrSymbol =
              T.type_alias { T.any(Symbol, Orb::Models::Customers::Credits::TopUpListResponse::ExpiresAfterUnit::TaggedSymbol) }
            ...
            class << self
              sig do
                override
                  .returns(T::Array[Orb::Models::Customers::Credits::TopUpListResponse::ExpiresAfterUnit::TaggedSymbol])
              end
              def values
              end
            end
