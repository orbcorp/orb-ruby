  ...
  module Models
    module Customers
      class CostListResponse < Orb::BaseModel
        Shape = T.type_alias { {data: T::Array[Orb::Models::Customers::CostListResponse::Data]} }
        ...
        sig { returns(Orb::Models::Customers::CostListResponse::Shape) }
        def to_h; end
        ...
        class Data < Orb::BaseModel
          ...
          sig { returns(Orb::Models::Customers::CostListResponse::Data::Shape) }
          def to_h; end
          ...
          class PerPriceCost < Orb::BaseModel
            ...
            sig { returns(Orb::Models::Customers::CostListResponse::Data::PerPriceCost::Shape) }
            def to_h; end
          end
        end
      end
