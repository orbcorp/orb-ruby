...
module Orb
  module Models
    class CustomerUpdateParams < Orb::BaseModel
      ...
      sig { returns(T.nilable(Orb::Models::CustomerUpdateParams::TaxConfiguration::Variants)) }
      ...
      sig { returns(Orb::Models::CustomerUpdateParams::Shape) }
      def to_h; end

      class AccountingSyncConfiguration < Orb::BaseModel
        Shape = T.type_alias do
          {
            accounting_providers: T.nilable(T::Array[Orb::Models::CustomerUpdateParams::AccountingSyncConfiguration::AccountingProvider]), excluded: T.nilable(T::Boolean)
          }
        end

        sig do
          returns(T.nilable(T::Array[Orb::Models::CustomerUpdateParams::AccountingSyncConfiguration::AccountingProvider]))
        end
        ...
        sig { returns(Orb::Models::CustomerUpdateParams::AccountingSyncConfiguration::Shape) }
        def to_h; end

        class AccountingProvider < Orb::BaseModel
          Shape = T.type_alias { {external_provider_id: String, provider_type: String} }
          ...
          sig do
            returns(Orb::Models::CustomerUpdateParams::AccountingSyncConfiguration::AccountingProvider::Shape)
          end
          def to_h; end
        end
      end
      ...
      class BillingAddress < Orb::BaseModel
        ...
        sig { returns(Orb::Models::CustomerUpdateParams::BillingAddress::Shape) }
        def to_h; end
      end
      ...
      class ReportingConfiguration < Orb::BaseModel
        ...
        sig { returns(Orb::Models::CustomerUpdateParams::ReportingConfiguration::Shape) }
        def to_h; end
      end
      ...
      class ShippingAddress < Orb::BaseModel
        ...
        sig { returns(Orb::Models::CustomerUpdateParams::ShippingAddress::Shape) }
        def to_h; end
      end
      ...
      class TaxConfiguration < Orb::Union
        ...
        class NewAvalaraTaxConfiguration < Orb::BaseModel
          Shape = T.type_alias do
            {tax_exempt: T::Boolean, tax_provider: Symbol, tax_exemption_code: T.nilable(String)}
          end
          ...
          sig do
            returns(Orb::Models::CustomerUpdateParams::TaxConfiguration::NewAvalaraTaxConfiguration::Shape)
          end
          def to_h; end
        end

        class NewTaxJarConfiguration < Orb::BaseModel
          Shape = T.type_alias { {tax_exempt: T::Boolean, tax_provider: Symbol} }
          ...
          sig { returns(Orb::Models::CustomerUpdateParams::TaxConfiguration::NewTaxJarConfiguration::Shape) }
          def to_h; end
        end
        ...
        sig do
          override.returns(
            [
              [Symbol, Orb::Models::CustomerUpdateParams::TaxConfiguration::NewAvalaraTaxConfiguration],
              [Symbol, Orb::Models::CustomerUpdateParams::TaxConfiguration::NewTaxJarConfiguration]
            ]
          )
        end
      ...
      class TaxID < Orb::BaseModel
        ...
        sig { returns(Orb::Models::CustomerUpdateParams::TaxID::Shape) }
        def to_h; end
