  ...
  module Models
    class PriceModel < Orb::Union
      ...
      sig do
        override
          .returns(
            [[Symbol, Orb::Models::PriceModel::UnitPrice], [Symbol, Orb::Models::PriceModel::PackagePrice], [Symbol, Orb::Models::PriceModel::MatrixPrice], [Symbol, Orb::Models::PriceModel::TieredPrice], [Symbol, Orb::Models::PriceModel::TieredBpsPrice], [Symbol, Orb::Models::PriceModel::BpsPrice], [Symbol, Orb::Models::PriceModel::BulkBpsPrice], [Symbol, Orb::Models::PriceModel::BulkPrice], [Symbol, Orb::Models::PriceModel::ThresholdTotalAmountPrice], [Symbol, Orb::Models::PriceModel::TieredPackagePrice], [Symbol, Orb::Models::PriceModel::GroupedTieredPrice], [Symbol, Orb::Models::PriceModel::TieredWithMinimumPrice], [Symbol, Orb::Models::PriceModel::TieredPackageWithMinimumPrice], [Symbol, Orb::Models::PriceModel::PackageWithAllocationPrice], [Symbol, Orb::Models::PriceModel::UnitWithPercentPrice], [Symbol, Orb::Models::PriceModel::MatrixWithAllocationPrice], [Symbol, Orb::Models::PriceModel::TieredWithProrationPrice], [Symbol, Orb::Models::PriceModel::UnitWithProrationPrice], [Symbol, Orb::Models::PriceModel::GroupedAllocationPrice], [Symbol, Orb::Models::PriceModel::GroupedWithProratedMinimumPrice], [Symbol, Orb::Models::PriceModel::GroupedWithMeteredMinimumPrice], [Symbol, Orb::Models::PriceModel::MatrixWithDisplayNamePrice], [Symbol, Orb::Models::PriceModel::BulkWithProrationPrice], [Symbol, Orb::Models::PriceModel::GroupedTieredPackagePrice], [Symbol, Orb::Models::PriceModel::MaxGroupTieredPackagePrice], [Symbol, Orb::Models::PriceModel::ScalableMatrixWithUnitPricingPrice], [Symbol, Orb::Models::PriceModel::ScalableMatrixWithTieredPricingPrice], [Symbol, Orb::Models::PriceModel::CumulativeGroupedBulkPrice]]
          )
      end
