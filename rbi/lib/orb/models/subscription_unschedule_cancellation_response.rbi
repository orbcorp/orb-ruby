...
module Orb
  module Models
    class SubscriptionUnscheduleCancellationResponse < Orb::BaseModel
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval])
          .returns(T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval])
      end
      ...
      sig do
        params(_: Orb::Models::SubscriptionUnscheduleCancellationResponse::BillingCycleAnchorConfiguration)
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::FixedFeeQuantitySchedule])
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::MaximumInterval])
          .returns(T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::MaximumInterval])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::MinimumInterval])
          .returns(T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::MinimumInterval])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::PriceInterval])
          .returns(T::Array[Orb::Models::SubscriptionUnscheduleCancellationResponse::PriceInterval])
      end
      ...
      sig do
        params(_: T.nilable(Orb::Models::SubscriptionUnscheduleCancellationResponse::RedeemedCoupon))
          .returns(T.nilable(Orb::Models::SubscriptionUnscheduleCancellationResponse::RedeemedCoupon))
      end
      ...
      sig do
        params(_: Orb::Models::SubscriptionUnscheduleCancellationResponse::TrialInfo)
          .returns(Orb::Models::SubscriptionUnscheduleCancellationResponse::TrialInfo)
      end
      def trial_info=(_)
      end
