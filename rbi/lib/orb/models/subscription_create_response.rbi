...
module Orb
  module Models
    class SubscriptionCreateResponse < Orb::BaseModel
      Shape = T.type_alias do
        {
          ...
          discount_intervals: T::Array[Orb::Models::SubscriptionCreateResponse::DiscountInterval::Variants],
      ...
      sig { returns(T::Array[Orb::Models::SubscriptionCreateResponse::DiscountInterval::Variants]) }
      ...
      sig { returns(Orb::Models::SubscriptionCreateResponse::Shape) }
      def to_h; end
      ...
      class AdjustmentInterval < Orb::BaseModel
        Shape = T.type_alias do
          {
            id: String,
            adjustment: Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::Variants,
        ...
        sig { returns(Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::Variants) }
        ...
        sig { returns(Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Shape) }
        def to_h; end
        ...
        class Adjustment < Orb::Union
          ...
          class AmountDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class PercentageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class UsageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MinimumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MinimumAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MaximumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MaximumAdjustment::Shape)
            end
            def to_h; end
          end
      ...
      class BillingCycleAnchorConfiguration < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionCreateResponse::BillingCycleAnchorConfiguration::Shape) }
        def to_h; end
      end
      ...
      class DiscountInterval < Orb::Union
        ...
        class AmountDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionCreateResponse::DiscountInterval::AmountDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class PercentageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionCreateResponse::DiscountInterval::PercentageDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class UsageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionCreateResponse::DiscountInterval::UsageDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        sig do
          override.returns(
            [
              ...
              [Symbol, Orb::Models::SubscriptionCreateResponse::DiscountInterval::PercentageDiscountInterval],
              [Symbol, Orb::Models::SubscriptionCreateResponse::DiscountInterval::UsageDiscountInterval]
            ]
          )
        end
        private_class_method def self.variants; end
      ...
      class FixedFeeQuantitySchedule < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionCreateResponse::FixedFeeQuantitySchedule::Shape) }
        def to_h; end
      end
      ...
      class MaximumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionCreateResponse::MaximumInterval::Shape) }
        def to_h; end
      end
      ...
      class MinimumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionCreateResponse::MinimumInterval::Shape) }
        def to_h; end
      end
      ...
      class PriceInterval < Orb::BaseModel
        ...
        sig do
          returns(T.nilable(T::Array[Orb::Models::SubscriptionCreateResponse::PriceInterval::FixedFeeQuantityTransition]))
        end
        ...
        sig { returns(Orb::Models::SubscriptionCreateResponse::PriceInterval::Shape) }
        def to_h; end
        ...
        class FixedFeeQuantityTransition < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionCreateResponse::PriceInterval::FixedFeeQuantityTransition::Shape)
          end
          def to_h; end
        end
      end
      ...
      class RedeemedCoupon < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionCreateResponse::RedeemedCoupon::Shape) }
        def to_h; end
      end
      ...
      class TrialInfo < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionCreateResponse::TrialInfo::Shape) }
        def to_h; end
      end
    end
  end
