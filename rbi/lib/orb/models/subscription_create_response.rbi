...
module Orb
  module Models
    class SubscriptionCreateResponse < Orb::BaseModel
      ...
      sig do
        params(
          billing_cycle_anchor_configuration: T.any(Orb::Models::SubscriptionCreateResponse::BillingCycleAnchorConfiguration, Orb::Util::AnyHash)
        )
          .void
      end
      ...
      sig do
        params(
          redeemed_coupon: T.nilable(T.any(Orb::Models::SubscriptionCreateResponse::RedeemedCoupon, Orb::Util::AnyHash))
        )
          .void
      end
      ...
      sig { params(trial_info: T.any(Orb::Models::SubscriptionCreateResponse::TrialInfo, Orb::Util::AnyHash)).void }
      ...
      sig do
        params(
          ...
          adjustment_intervals: T::Array[T.any(Orb::Models::SubscriptionCreateResponse::AdjustmentInterval, Orb::Util::AnyHash)],
          ...
          fixed_fee_quantity_schedule: T::Array[T.any(Orb::Models::SubscriptionCreateResponse::FixedFeeQuantitySchedule, Orb::Util::AnyHash)],
          invoicing_threshold: T.nilable(String),
          maximum_intervals: T::Array[T.any(Orb::Models::SubscriptionCreateResponse::MaximumInterval, Orb::Util::AnyHash)],
          metadata: T::Hash[Symbol, String],
          minimum_intervals: T::Array[T.any(Orb::Models::SubscriptionCreateResponse::MinimumInterval, Orb::Util::AnyHash)],
          net_terms: Integer,
          plan: T.any(Orb::Models::Plan, Orb::Util::AnyHash),
          price_intervals: T::Array[T.any(Orb::Models::SubscriptionCreateResponse::PriceInterval, Orb::Util::AnyHash)],
          redeemed_coupon: T.nilable(T.any(Orb::Models::SubscriptionCreateResponse::RedeemedCoupon, Orb::Util::AnyHash)),
          start_date: Time,
          status: Orb::Models::SubscriptionCreateResponse::Status::OrSymbol,
          trial_info: T.any(Orb::Models::SubscriptionCreateResponse::TrialInfo, Orb::Util::AnyHash)
        )
      ...
      module Status
        ...
        OrSymbol = T.type_alias { T.any(Symbol, Orb::Models::SubscriptionCreateResponse::Status::TaggedSymbol) }
