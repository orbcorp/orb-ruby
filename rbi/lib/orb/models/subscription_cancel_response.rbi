...
module Orb
  module Models
    class SubscriptionCancelResponse < Orb::BaseModel
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionCancelResponse::AdjustmentInterval])
          .returns(T::Array[Orb::Models::SubscriptionCancelResponse::AdjustmentInterval])
      end
      ...
      sig do
        params(_: Orb::Models::SubscriptionCancelResponse::BillingCycleAnchorConfiguration)
          .returns(Orb::Models::SubscriptionCancelResponse::BillingCycleAnchorConfiguration)
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionCancelResponse::FixedFeeQuantitySchedule])
          .returns(T::Array[Orb::Models::SubscriptionCancelResponse::FixedFeeQuantitySchedule])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionCancelResponse::MaximumInterval])
          .returns(T::Array[Orb::Models::SubscriptionCancelResponse::MaximumInterval])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionCancelResponse::MinimumInterval])
          .returns(T::Array[Orb::Models::SubscriptionCancelResponse::MinimumInterval])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionCancelResponse::PriceInterval])
          .returns(T::Array[Orb::Models::SubscriptionCancelResponse::PriceInterval])
      end
      ...
      sig do
        params(_: T.nilable(Orb::Models::SubscriptionCancelResponse::RedeemedCoupon))
          .returns(T.nilable(Orb::Models::SubscriptionCancelResponse::RedeemedCoupon))
      end
      ...
      sig do
        params(_: Orb::Models::SubscriptionCancelResponse::TrialInfo)
          .returns(Orb::Models::SubscriptionCancelResponse::TrialInfo)
      end
      def trial_info=(_)
      end
        ...
        class Adjustment < Orb::Union
          ...
          class << self
            sig do
              override
                .returns(
                  [[Symbol, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PlanPhaseUsageDiscountAdjustment], [Symbol, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PlanPhaseAmountDiscountAdjustment], [Symbol, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PlanPhasePercentageDiscountAdjustment], [Symbol, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PlanPhaseMinimumAdjustment], [Symbol, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PlanPhaseMaximumAdjustment]]
                )
            end
      ...
      class DiscountInterval < Orb::Union
        ...
        class << self
          sig do
            override
              .returns(
                [[Symbol, Orb::Models::SubscriptionCancelResponse::DiscountInterval::AmountDiscountInterval], [Symbol, Orb::Models::SubscriptionCancelResponse::DiscountInterval::PercentageDiscountInterval], [Symbol, Orb::Models::SubscriptionCancelResponse::DiscountInterval::UsageDiscountInterval]]
              )
          end
          private def variants
          end
      ...
      class PriceInterval < Orb::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[Orb::Models::SubscriptionCancelResponse::PriceInterval::FixedFeeQuantityTransition])
          )
        end
