...
module Orb
  module Models
    class SubscriptionSchedulePlanChangeResponse < Orb::BaseModel
      Shape = T.type_alias do
        {
          ...
          discount_intervals: T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::Variants],
          ...
          maximum_intervals: T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::MaximumInterval],
      ...
      sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::BillingCycleAnchorConfiguration) }
      ...
      sig do
        returns(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::Variants])
      end
      ...
      sig { returns(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::FixedFeeQuantitySchedule]) }
      attr_accessor :fixed_fee_quantity_schedule

      sig { returns(T.nilable(String)) }
      attr_accessor :invoicing_threshold

      sig { returns(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::MaximumInterval]) }
      attr_accessor :maximum_intervals

      sig { returns(T::Hash[Symbol, String]) }
      attr_accessor :metadata

      sig { returns(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::MinimumInterval]) }
      ...
      sig { returns(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval]) }
      attr_accessor :price_intervals

      sig { returns(T.nilable(Orb::Models::SubscriptionSchedulePlanChangeResponse::RedeemedCoupon)) }
      ...
      sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::TrialInfo) }
      ...
      sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::Shape) }
      def to_h; end
      ...
      class AdjustmentInterval < Orb::BaseModel
        Shape = T.type_alias do
          {
            id: String,
            adjustment: Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::Variants,
        ...
        sig do
          returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::Variants)
        end
        ...
        sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Shape) }
        def to_h; end
        ...
        class Adjustment < Orb::Union
          ...
          class AmountDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class PercentageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class UsageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MinimumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::MinimumAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MaximumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::MaximumAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          sig do
            override.returns(
              [
                [
                  Symbol,
                  Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::MinimumAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::MaximumAdjustment
                ]
              ]
            )
          end
      ...
      class BillingCycleAnchorConfiguration < Orb::BaseModel
        ...
        sig do
          returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::BillingCycleAnchorConfiguration::Shape)
        end
        def to_h; end
      end
      ...
      class DiscountInterval < Orb::Union
        ...
        class AmountDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::AmountDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class PercentageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::PercentageDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class UsageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::UsageDiscountInterval::Shape)
          end
          def to_h; end
        end
      ...
      class FixedFeeQuantitySchedule < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::FixedFeeQuantitySchedule::Shape) }
        def to_h; end
      end
      ...
      class MaximumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::MaximumInterval::Shape) }
        def to_h; end
      end
      ...
      class MinimumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::MinimumInterval::Shape) }
        def to_h; end
      end
      ...
      class PriceInterval < Orb::BaseModel
        Shape = T.type_alias do
          {
            ...
            current_billing_period_start_date: T.nilable(Time),
            end_date: T.nilable(Time),
            fixed_fee_quantity_transitions: T.nilable(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval::FixedFeeQuantityTransition]),
        ...
        sig do
          returns(T.nilable(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval::FixedFeeQuantityTransition]))
        end
        ...
        sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval::Shape) }
        def to_h; end
        ...
        class FixedFeeQuantityTransition < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval::FixedFeeQuantityTransition::Shape)
          end
          def to_h; end
        end
      end
      ...
      class RedeemedCoupon < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::RedeemedCoupon::Shape) }
        def to_h; end
      end
      ...
      class TrialInfo < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionSchedulePlanChangeResponse::TrialInfo::Shape) }
        def to_h; end
      end
    end
  end
