    ...
    class SubscriptionSchedulePlanChangeResponse < Orb::Internal::Type::BaseModel
      ...
      sig do
        params(
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionSchedulePlanChangeResponse::RedeemedCoupon, Orb::Internal::AnyHash)
          )
        )
          .void
      end
      ...
      sig do
        params(
          ...
          adjustment_intervals: T::Array[T.any(Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval, Orb::Internal::AnyHash)],
