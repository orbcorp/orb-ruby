...
module Orb
  module Models
    class SubscriptionSchedulePlanChangeResponse < Orb::BaseModel
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::FixedFeeQuantitySchedule])
          .returns(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::FixedFeeQuantitySchedule])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::MaximumInterval])
          .returns(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::MaximumInterval])
      end
      ...
      sig do
        params(_: T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval])
          .returns(T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval])
      end
      ...
      sig do
        params(_: T.nilable(Orb::Models::SubscriptionSchedulePlanChangeResponse::RedeemedCoupon))
          .returns(T.nilable(Orb::Models::SubscriptionSchedulePlanChangeResponse::RedeemedCoupon))
      end
      ...
      sig do
        params(_: Orb::Models::SubscriptionSchedulePlanChangeResponse::TrialInfo)
      ...
      class DiscountInterval < Orb::Union
        ...
        class << self
          sig do
            override
              .returns(
                [[Symbol, Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::AmountDiscountInterval], [Symbol, Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::PercentageDiscountInterval], [Symbol, Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::UsageDiscountInterval]]
              )
          end
          private def variants
          end
      ...
      class PriceInterval < Orb::BaseModel
        ...
        sig do
          returns(
              T.nilable(
                T::Array[Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval::FixedFeeQuantityTransition]
              )
            )
        end
