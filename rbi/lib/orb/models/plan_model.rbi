...
module Orb
  module Models
    class PlanModel < Orb::BaseModel
      ...
      sig { returns(T.nilable(T::Array[Orb::Models::PlanModel::PlanPhase])) }
      def plan_phases
      end

      sig do
        params(_: T.nilable(T::Array[Orb::Models::PlanModel::PlanPhase]))
          .returns(T.nilable(T::Array[Orb::Models::PlanModel::PlanPhase]))
      end
      def plan_phases=(_)
      end
      ...
      sig { returns(Orb::Models::PlanModel::Product) }
      def product
      end

      sig { params(_: Orb::Models::PlanModel::Product).returns(Orb::Models::PlanModel::Product) }
      def product=(_)
      end
      ...
      sig { returns(Orb::Models::PlanModel::TrialConfig) }
      def trial_config
      end

      sig { params(_: Orb::Models::PlanModel::TrialConfig).returns(Orb::Models::PlanModel::TrialConfig) }
      def trial_config=(_)
      end
      ...
      sig do
        params(
          ...
          plan_phases: T.nilable(T::Array[Orb::Models::PlanModel::PlanPhase]),
          prices: T::Array[
          T.any(
            Orb::Models::PriceModel::UnitPrice,
            Orb::Models::PriceModel::PackagePrice,
