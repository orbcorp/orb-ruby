...
module Orb
  module Models
    class SubscriptionUpdateFixedFeeQuantityResponse < Orb::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PendingSubscriptionChange)) }
      ...
      sig do
        params(
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::RedeemedCoupon, Orb::Internal::AnyHash)
          )
        )
          .void
      end
      ...
      sig { returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Status::TaggedSymbol) }
      ...
      sig do
        params(
          trial_info: T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::TrialInfo, Orb::Internal::AnyHash)
        )
          .void
      end
      ...
      sig { returns(T.nilable(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::ChangedResources)) }
      attr_reader :changed_resources

      sig do
        params(
          changed_resources: T.nilable(
            T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::ChangedResources, Orb::Internal::AnyHash)
          )
        )
          .void
      end
      ...
      sig do
        params(
          ...
          adjustment_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval, Orb::Internal::AnyHash)],
          ...
          maximum_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::MaximumInterval, Orb::Internal::AnyHash)],
          metadata: T::Hash[Symbol, String],
          minimum_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::MinimumInterval, Orb::Internal::AnyHash)],
          net_terms: Integer,
          pending_subscription_change: T.nilable(
            T.any(
              Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PendingSubscriptionChange,
          ...
          price_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PriceInterval, Orb::Internal::AnyHash)],
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::RedeemedCoupon, Orb::Internal::AnyHash)
          ),
          start_date: Time,
          status: Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Status::OrSymbol,
          trial_info: T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::TrialInfo, Orb::Internal::AnyHash),
          changed_resources: T.nilable(
            T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::ChangedResources, Orb::Internal::AnyHash)
          )
          ...
          .returns(
            {
              ...
              net_terms: Integer,
              pending_subscription_change: T.nilable(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PendingSubscriptionChange),
              ...
              start_date: Time,
              status: Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Status::TaggedSymbol,
              trial_info: Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::TrialInfo,
              changed_resources: T.nilable(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::ChangedResources)
            }
          )
      end
      def to_hash; end
      ...
      module DiscountInterval
        ...
        sig do
          override
            .returns(
              [Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::AmountDiscountInterval, Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::PercentageDiscountInterval, Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::UsageDiscountInterval]
            )
        end
        def self.variants; end
      end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Status) }
        OrSymbol =
          T.type_alias { T.any(Symbol, String, Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Status::TaggedSymbol) }

        ACTIVE = T.let(:active, Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Status::TaggedSymbol)
        ENDED = T.let(:ended, Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Status::TaggedSymbol)
        UPCOMING =
          T.let(:upcoming, Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Status::TaggedSymbol)

        sig { override.returns(T::Array[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Status::TaggedSymbol]) }
        def self.values; end
      end
