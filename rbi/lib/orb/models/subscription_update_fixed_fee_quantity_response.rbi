...
module Orb
  module Models
    class SubscriptionUpdateFixedFeeQuantityResponse < Orb::BaseModel
      ...
      sig do
        params(
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::RedeemedCoupon, Orb::Util::AnyHash)
          )
        )
          .void
      end
      ...
      sig do
        params(
          trial_info: T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::TrialInfo, Orb::Util::AnyHash)
        )
          .void
      end
      ...
      sig do
        params(
          ...
          adjustment_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval, Orb::Util::AnyHash)],
          ...
          maximum_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::MaximumInterval, Orb::Util::AnyHash)],
          metadata: T::Hash[Symbol, String],
          minimum_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::MinimumInterval, Orb::Util::AnyHash)],
          net_terms: Integer,
          plan: T.any(Orb::Models::Plan, Orb::Util::AnyHash),
          price_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PriceInterval, Orb::Util::AnyHash)],
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::RedeemedCoupon, Orb::Util::AnyHash)
          ),
          start_date: Time,
