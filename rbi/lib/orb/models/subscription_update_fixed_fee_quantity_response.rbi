...
module Orb
  module Models
    class SubscriptionUpdateFixedFeeQuantityResponse < Orb::BaseModel
      Shape = T.type_alias do
        {
          ...
          discount_intervals: T::Array[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::Variants],
      ...
      sig do
        returns(T::Array[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::Variants])
      end
      ...
      sig { returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::Shape) }
      def to_h; end
      ...
      class AdjustmentInterval < Orb::BaseModel
        Shape = T.type_alias do
          {
            id: String,
            adjustment: Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::Variants,
        ...
        sig do
          returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::Variants)
        end
        ...
        sig { returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Shape) }
        def to_h; end
        ...
        class Adjustment < Orb::Union
          ...
          class AmountDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class PercentageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class UsageDiscountAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MinimumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::MinimumAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          class MaximumAdjustment < Orb::BaseModel
            ...
            sig do
              returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::MaximumAdjustment::Shape)
            end
            def to_h; end
          end
          ...
          sig do
            override.returns(
              [
                [
                  Symbol,
                  Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::MinimumAdjustment
                ],
                [
                  Symbol,
                  Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::MaximumAdjustment
                ]
              ]
            )
          end
      ...
      class BillingCycleAnchorConfiguration < Orb::BaseModel
        ...
        sig do
          returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::BillingCycleAnchorConfiguration::Shape)
        end
        def to_h; end
      end
      ...
      class DiscountInterval < Orb::Union
        ...
        class AmountDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::AmountDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class PercentageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::PercentageDiscountInterval::Shape)
          end
          def to_h; end
        end
        ...
        class UsageDiscountInterval < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::UsageDiscountInterval::Shape)
          end
          def to_h; end
        end
      ...
      class FixedFeeQuantitySchedule < Orb::BaseModel
        ...
        sig do
          returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::FixedFeeQuantitySchedule::Shape)
        end
        def to_h; end
      end
      ...
      class MaximumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::MaximumInterval::Shape) }
        def to_h; end
      end
      ...
      class MinimumInterval < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::MinimumInterval::Shape) }
        def to_h; end
      end
      ...
      class PriceInterval < Orb::BaseModel
        Shape = T.type_alias do
          {
            ...
            current_billing_period_start_date: T.nilable(Time),
            end_date: T.nilable(Time),
            fixed_fee_quantity_transitions: T.nilable(T::Array[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PriceInterval::FixedFeeQuantityTransition]),
        ...
        sig do
          returns(T.nilable(T::Array[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PriceInterval::FixedFeeQuantityTransition]))
        end
        ...
        sig { returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PriceInterval::Shape) }
        def to_h; end
        ...
        class FixedFeeQuantityTransition < Orb::BaseModel
          ...
          sig do
            returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PriceInterval::FixedFeeQuantityTransition::Shape)
          end
          def to_h; end
        end
      end
      ...
      class RedeemedCoupon < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::RedeemedCoupon::Shape) }
        def to_h; end
      end
      ...
      class TrialInfo < Orb::BaseModel
        ...
        sig { returns(Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::TrialInfo::Shape) }
        def to_h; end
      end
    end
  end
