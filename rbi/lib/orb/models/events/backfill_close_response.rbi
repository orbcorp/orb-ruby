  ...
  module Models
    module Events
      class BackfillCloseResponse < Orb::Internal::Type::BaseModel
        ...
        sig { returns(Orb::Models::Events::BackfillCloseResponse::Status::TaggedSymbol) }
        ...
        sig do
          params(
            ...
            status: Orb::Models::Events::BackfillCloseResponse::Status::OrSymbol,
            timeframe_end: Time,
            ...
            .returns(
              {
                ...
                replace_existing_events: T::Boolean,
                reverted_at: T.nilable(Time),
                status: Orb::Models::Events::BackfillCloseResponse::Status::TaggedSymbol,
                timeframe_end: Time,
                timeframe_start: Time,
                deprecation_filter: T.nilable(String)
              }
        ...
        module Status
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, Orb::Models::Events::BackfillCloseResponse::Status) }
          OrSymbol =
            T.type_alias { T.any(Symbol, String, Orb::Models::Events::BackfillCloseResponse::Status::TaggedSymbol) }

          PENDING = T.let(:pending, Orb::Models::Events::BackfillCloseResponse::Status::TaggedSymbol)
          REFLECTED = T.let(:reflected, Orb::Models::Events::BackfillCloseResponse::Status::TaggedSymbol)
          PENDING_REVERT = T.let(:pending_revert, Orb::Models::Events::BackfillCloseResponse::Status::TaggedSymbol)
