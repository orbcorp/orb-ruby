...
module Orb
  module Models
    class CreditNoteModel < Orb::BaseModel
      ...
      sig { returns(T::Array[Orb::Models::CreditNoteModel::LineItem]) }
      def line_items
      end

      sig do
        params(_: T::Array[Orb::Models::CreditNoteModel::LineItem])
          .returns(T::Array[Orb::Models::CreditNoteModel::LineItem])
      end
      def line_items=(_)
      end
      ...
      sig do
        params(
          ...
          invoice_id: String,
          line_items: T::Array[Orb::Models::CreditNoteModel::LineItem],
      ...
      class LineItem < Orb::BaseModel
        ...
        sig { returns(T.nilable(T::Array[Orb::Models::CreditNoteModel::LineItem::Discount])) }
        def discounts
        end

        sig do
          params(_: T::Array[Orb::Models::CreditNoteModel::LineItem::Discount])
