...
module Orb
  module Models
    class SubscriptionUpdateTrialResponse < Orb::BaseModel
      ...
      sig do
        params(
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionUpdateTrialResponse::RedeemedCoupon, Orb::Internal::Util::AnyHash)
          )
        )
          .void
      end
      ...
      sig do
        params(
          trial_info: T.any(Orb::Models::SubscriptionUpdateTrialResponse::TrialInfo, Orb::Internal::Util::AnyHash)
        )
          .void
      end
      ...
      sig do
        params(
          ...
          adjustment_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval, Orb::Internal::Util::AnyHash)],
          ...
          maximum_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateTrialResponse::MaximumInterval, Orb::Internal::Util::AnyHash)],
          metadata: T::Hash[Symbol, String],
          minimum_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateTrialResponse::MinimumInterval, Orb::Internal::Util::AnyHash)],
          net_terms: Integer,
          plan: T.any(Orb::Models::Plan, Orb::Internal::Util::AnyHash),
          price_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateTrialResponse::PriceInterval, Orb::Internal::Util::AnyHash)],
          redeemed_coupon: T.nilable(
            T.any(Orb::Models::SubscriptionUpdateTrialResponse::RedeemedCoupon, Orb::Internal::Util::AnyHash)
          ),
          start_date: Time,
