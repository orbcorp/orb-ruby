...
module Orb
  module Models
    class SubscriptionUpdateTrialResponse < Orb::BaseModel
      ...
      sig do
        params(
          billing_cycle_anchor_configuration: T.any(Orb::Models::SubscriptionUpdateTrialResponse::BillingCycleAnchorConfiguration, Orb::Util::AnyHash)
        )
          .void
      end
      ...
      sig do
        params(
          redeemed_coupon: T.nilable(T.any(Orb::Models::SubscriptionUpdateTrialResponse::RedeemedCoupon, Orb::Util::AnyHash))
        )
          .void
      end
      ...
      sig { params(trial_info: T.any(Orb::Models::SubscriptionUpdateTrialResponse::TrialInfo, Orb::Util::AnyHash)).void }
      ...
      sig do
        params(
          ...
          adjustment_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval, Orb::Util::AnyHash)],
          ...
          fixed_fee_quantity_schedule: T::Array[T.any(Orb::Models::SubscriptionUpdateTrialResponse::FixedFeeQuantitySchedule, Orb::Util::AnyHash)],
          invoicing_threshold: T.nilable(String),
          maximum_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateTrialResponse::MaximumInterval, Orb::Util::AnyHash)],
          metadata: T::Hash[Symbol, String],
          minimum_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateTrialResponse::MinimumInterval, Orb::Util::AnyHash)],
          net_terms: Integer,
          plan: T.any(Orb::Models::Plan, Orb::Util::AnyHash),
          price_intervals: T::Array[T.any(Orb::Models::SubscriptionUpdateTrialResponse::PriceInterval, Orb::Util::AnyHash)],
          redeemed_coupon: T.nilable(T.any(Orb::Models::SubscriptionUpdateTrialResponse::RedeemedCoupon, Orb::Util::AnyHash)),
          start_date: Time,
          status: Orb::Models::SubscriptionUpdateTrialResponse::Status::OrSymbol,
          trial_info: T.any(Orb::Models::SubscriptionUpdateTrialResponse::TrialInfo, Orb::Util::AnyHash)
        )
      ...
      module Status
        ...
        OrSymbol =
          T.type_alias { T.any(Symbol, Orb::Models::SubscriptionUpdateTrialResponse::Status::TaggedSymbol) }
