...
module Orb
  module Models
    class AddCreditTopUpRequest < Orb::BaseModel
      ...
      sig { returns(Orb::Models::AddCreditTopUpRequest::InvoiceSettings) }
      def invoice_settings
      end

      sig do
        params(_: Orb::Models::AddCreditTopUpRequest::InvoiceSettings)
          .returns(Orb::Models::AddCreditTopUpRequest::InvoiceSettings)
      end
