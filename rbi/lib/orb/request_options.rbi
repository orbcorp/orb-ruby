...
module Orb
  module RequestParameters
    ...
    sig { returns(T.any(Orb::RequestOptions, T::Hash[Symbol, T.anything])) }
    def request_options
    end

    sig do
      params(_: T.any(Orb::RequestOptions, T::Hash[Symbol, T.anything]))
        .returns(T.any(Orb::RequestOptions, T::Hash[Symbol, T.anything]))
    end
