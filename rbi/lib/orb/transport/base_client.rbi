...
module Orb
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[Orb::Type::BasePage[Orb::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(Orb::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: Orb::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: Orb::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(Orb::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(Orb::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(req: Orb::Transport::BaseClient::RequestComponentsShape, opts: Orb::Util::AnyHash)
          .returns(Orb::Transport::BaseClient::RequestInputShape)
      end
