  ...
  module Resources
    ...
    class CouponsResource
      ...
      def initialize(client:)
        @client = client
        @subscriptions =
          Orb::Resources::Coupons::SubscriptionsResource.new(client: client)
      end
      def create(
        discount: Orb::NotGiven.instance,
        redemption_code: Orb::NotGiven.instance,
        duration_in_months: Orb::NotGiven.instance,
        max_redemptions: Orb::NotGiven.instance
      )
        request = {
          method: :post,
          path: "/coupons",
      ...
      def list(
        ...
        redemption_code: Orb::NotGiven.instance,
        show_archived: Orb::NotGiven.instance
      )
        request = {
          method: :get,
          path: "/coupons",
