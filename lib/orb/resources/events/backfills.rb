    ...
    module Events
      ...
      class BackfillsResource
        ...
        def create(
          ...
          close_time: Orb::NotGiven.instance,
          customer_id: Orb::NotGiven.instance,
          external_customer_id: Orb::NotGiven.instance,
          replace_existing_events: Orb::NotGiven.instance
        )
          request = {
            method: :post,
        ...
        def close(backfill_id)
          request = {
            method: :post,
            path: "/events/backfills/#{backfill_id}/close",
            query: nil
          }
        ...
        def revert(backfill_id)
          request = {
            method: :post,
            path: "/events/backfills/#{backfill_id}/revert",
            query: nil
          }
