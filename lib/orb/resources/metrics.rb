...
module Orb
    module Resources
        ...
        class MetricsResource
                ...
                def create(description: Orb::NotGiven.instance, item_id: Orb::NotGiven.instance, name: Orb::NotGiven.instance, sql: Orb::NotGiven.instance, metadata: Orb::NotGiven.instance)
                ...
                def list(created_at_gt: Orb::NotGiven.instance, created_at_gte: Orb::NotGiven.instance, created_at_lt: Orb::NotGiven.instance, created_at_lte: Orb::NotGiven.instance, cursor: Orb::NotGiven.instance, limit: Orb::NotGiven.instance)
                    request = {method: :get, path: "/metrics", query: {created_at[gt]: created_at_gt, created_at[gte]: created_at_gte, created_at[lt]: created_at_lt, created_at[lte]: created_at_lte, cursor: cursor, limit: limit, }, }
