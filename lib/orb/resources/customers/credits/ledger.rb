    ...
    module Customers
      module Credits
        ...
        class LedgerListByExternalIDResponsePage < Page
          required :data,
                   Orb::ArrayOf.new(Orb::Models::LedgerListByExternalIDResponse)
        end
        ...
        class LedgerResource
          ...
          def list(
            ...
            entry_status: Orb::NotGiven.instance,
            entry_type: Orb::NotGiven.instance,
            limit: Orb::NotGiven.instance,
            minimum_amount: Orb::NotGiven.instance
          )
            request = {
              method: :get,
          ...
          def create_entry(
            ...
            expiry_date: Orb::NotGiven.instance,
            invoice_settings: Orb::NotGiven.instance,
            metadata: Orb::NotGiven.instance,
            per_unit_cost_basis: Orb::NotGiven.instance
          )
            request = {
              method: :post,
              path: "/customers/#{customer_id}/credits/ledger_entry",
              body: {
                amount: amount,
                entry_type: entry_type,
          ...
          def create_entry(
            ...
            entry_type: Orb::NotGiven.instance,
            expiry_date: Orb::NotGiven.instance,
            target_expiry_date: Orb::NotGiven.instance,
            amount: Orb::NotGiven.instance,
            block_id: Orb::NotGiven.instance,
            description: Orb::NotGiven.instance,
            metadata: Orb::NotGiven.instance
          )
            request = {
          ...
          def create_entry(
            ...
            description: Orb::NotGiven.instance,
            metadata: Orb::NotGiven.instance,
            void_reason: Orb::NotGiven.instance
          )
            request = {
              method: :post,
              path: "/customers/#{customer_id}/credits/ledger_entry",
