    ...
    class Customers
      class Credits
        class TopUps
          ...
          #
          #   @option params [Orb::Models::Customers::Credits::AddCreditTopUpRequest::InvoiceSettings] :invoice_settings Settings for invoices generated by triggered top-ups.
          #
          ...
          #     does not expire.
          #
          #   @option params [Symbol, Orb::Models::Customers::Credits::AddCreditTopUpRequest::ExpiresAfterUnit, nil] :expires_after_unit The unit of expires_after.
          #
