    ...
    module Resources
        module Customers
            class UsageResource
                    ...
                    def update(id, events: Orb::NotGiven.instance, timeframe_end: Orb::NotGiven.instance, timeframe_start: Orb::NotGiven.instance)
                    ...
                    def update_by_external_id(id, events: Orb::NotGiven.instance, timeframe_end: Orb::NotGiven.instance, timeframe_start: Orb::NotGiven.instance)
                        ...
                        @client.request(model: Orb::Models::UsageUpdateByExternalIDResponse, **request)
                    end
