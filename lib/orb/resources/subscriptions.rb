...
module Orb
  module Resources
    ...
    class SubscriptionFetchScheduleResponsePage < Page
      required :data,
               Orb::ArrayOf.new(Orb::Models::SubscriptionFetchScheduleResponse)
    end
    ...
    class SubscriptionsResource
      ...
      def create(
        align_billing_with_subscription_start_date: Orb::NotGiven.instance,
        auto_collection: Orb::NotGiven.instance,
        aws_region: Orb::NotGiven.instance,
        coupon_redemption_code: Orb::NotGiven.instance,
        credits_overage_rate: Orb::NotGiven.instance,
        customer_id: Orb::NotGiven.instance,
        default_invoice_memo: Orb::NotGiven.instance,
        end_date: Orb::NotGiven.instance,
        external_customer_id: Orb::NotGiven.instance,
        external_marketplace: Orb::NotGiven.instance,
        external_marketplace_reporting_id: Orb::NotGiven.instance,
        external_plan_id: Orb::NotGiven.instance,
        initial_phase_order: Orb::NotGiven.instance,
        invoicing_threshold: Orb::NotGiven.instance,
        metadata: Orb::NotGiven.instance,
        net_terms: Orb::NotGiven.instance,
        per_credit_overage_amount: Orb::NotGiven.instance,
        plan_id: Orb::NotGiven.instance,
        price_overrides: Orb::NotGiven.instance,
      ...
      def cancel(
        subscription_id,
        cancel_option: Orb::NotGiven.instance,
        cancellation_date: Orb::NotGiven.instance
      )
        request = {
          method: :post,
      ...
      def fetch_costs(
        subscription_id,
        group_by: Orb::NotGiven.instance,
        timeframe_end: Orb::NotGiven.instance,
        timeframe_start: Orb::NotGiven.instance,
        view_mode: Orb::NotGiven.instance
      )
        request = {
          method: :get,
          path: "/subscriptions/#{subscription_id}/costs",
          query: {
            group_by: group_by,
      ...
      def fetch_schedule(
        ...
        cursor: Orb::NotGiven.instance,
        limit: Orb::NotGiven.instance,
        start_date_gt: Orb::NotGiven.instance,
        start_date_gte: Orb::NotGiven.instance,
        start_date_lt: Orb::NotGiven.instance,
        start_date_lte: Orb::NotGiven.instance
      )
        request = {
          method: :get,
          ...
          query: {
            cursor: cursor,
            limit: limit,
            "start_date[gt]": start_date_gt,
            "start_date[gte]": start_date_gte,
            "start_date[lt]": start_date_lt,
            "start_date[lte]": start_date_lte
          }
        }
      ...
      def fetch_usage(
        subscription_id,
        billable_metric_id: Orb::NotGiven.instance,
        cursor: Orb::NotGiven.instance,
        first_dimension_key: Orb::NotGiven.instance,
        first_dimension_value: Orb::NotGiven.instance,
        granularity: Orb::NotGiven.instance,
        group_by: Orb::NotGiven.instance,
        limit: Orb::NotGiven.instance,
        second_dimension_key: Orb::NotGiven.instance,
        second_dimension_value: Orb::NotGiven.instance,
        timeframe_end: Orb::NotGiven.instance,
        timeframe_start: Orb::NotGiven.instance,
        view_mode: Orb::NotGiven.instance
      )
      ...
      def price_intervals(
        subscription_id,
        add: Orb::NotGiven.instance,
        edit: Orb::NotGiven.instance
      )
        request = {
          method: :post,
          path: "/subscriptions/#{subscription_id}/price_intervals",
          body: {
            add: add,
            edit: edit
          },
      ...
      def schedule_plan_change(
        subscription_id,
        change_option: Orb::NotGiven.instance,
        align_billing_with_plan_change_date: Orb::NotGiven.instance,
        billing_cycle_alignment: Orb::NotGiven.instance,
        change_date: Orb::NotGiven.instance,
        coupon_redemption_code: Orb::NotGiven.instance,
        credits_overage_rate: Orb::NotGiven.instance,
        external_plan_id: Orb::NotGiven.instance,
        initial_phase_order: Orb::NotGiven.instance,
      ...
      def trigger_phase(subscription_id, effective_date: Orb::NotGiven.instance)
        request = {
          method: :post,
          path: "/subscriptions/#{subscription_id}/trigger_phase",
          body: {
      ...
      def unschedule_cancellation(subscription_id)
        request = {
          method: :post,
          path: "/subscriptions/#{subscription_id}/unschedule_cancellation",
          query: nil
        }
      ...
      def unschedule_fixed_fee_quantity_updates(
        subscription_id,
        price_id: Orb::NotGiven.instance
      )
        request = {
          method: :post,
          path:
      ...
      def update_fixed_fee_quantity(
        ...
        change_option: Orb::NotGiven.instance,
        effective_date: Orb::NotGiven.instance
      )
        request = {
          method: :post,
          path: "/subscriptions/#{subscription_id}/update_fixed_fee_quantity",
          body: {
            price_id: price_id,
            quantity: quantity,
            change_option: change_option,
