...
module Orb
    module Resources
        class InvoiceLineItemsResource
                ...
                def create(amount: Orb::NotGiven.instance, end_date: Orb::NotGiven.instance, invoice_id: Orb::NotGiven.instance, name: Orb::NotGiven.instance, quantity: Orb::NotGiven.instance, start_date: Orb::NotGiven.instance)
