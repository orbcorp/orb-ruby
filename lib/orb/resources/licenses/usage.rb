  ...
  module Resources
    class Licenses
      class Usage
        ...
        #
        # @overload get_all_usage(license_type_id:, subscription_id:, cursor: nil, end_date: nil, group_by: nil, limit: nil, start_date: nil, request_options: {})
        #
        ...
        #
        # @return [Orb::Models::Licenses::UsageGetAllUsageResponse]
        #
        ...
        # Date range defaults to the current billing period if not specified.
        #
        # @overload get_usage(license_id, cursor: nil, end_date: nil, group_by: nil, limit: nil, start_date: nil, request_options: {})
        #
        ...
        # @param request_options [Orb::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Orb::Models::Licenses::UsageGetUsageResponse]
        #
