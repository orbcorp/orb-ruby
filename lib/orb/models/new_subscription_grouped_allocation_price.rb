...
module Orb
  module Models
    class NewSubscriptionGroupedAllocationPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::NewSubscriptionGroupedAllocationPrice::Cadence]
      ...
      #
      #   @return [Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered, nil]
      ...
      #   {Orb::Models::NewSubscriptionGroupedAllocationPrice} for more details.
      #
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      # The cadence to bill for this price on.
      #
      # @see Orb::Models::NewSubscriptionGroupedAllocationPrice#cadence
      module Cadence
      ...
      # The configuration for the rate of the price currency to the invoicing currency.
      #
      # @see Orb::Models::NewSubscriptionGroupedAllocationPrice#conversion_rate_config
      module ConversionRateConfig
        extend Orb::Internal::Type::Union

        discriminator :conversion_rate_type

        variant :unit, -> { Orb::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Unit }

        variant :tiered, -> { Orb::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Unit::UnitConfig]
          ...
          #   @param unit_config [Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered::TieredConfig]
          ...
          #   @param tiered_config [Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionGroupedAllocationPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
