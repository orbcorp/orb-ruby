...
module Orb
  module Models
    class NewSubscriptionCumulativeGroupedBulkPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::Cadence]
      ...
      #
      #   @return [Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered, nil]
      ...
      #   {Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice} for more details.
      #
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      # The cadence to bill for this price on.
      #
      # @see Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice#cadence
      module Cadence
      ...
      # The configuration for the rate of the price currency to the invoicing currency.
      #
      # @see Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice#conversion_rate_config
      module ConversionRateConfig
        extend Orb::Internal::Type::Union

        discriminator :conversion_rate_type

        variant :unit, -> { Orb::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Unit }

        variant :tiered, -> { Orb::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Unit::UnitConfig]
          required :unit_config,
                   -> {
                     Orb::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Unit::UnitConfig
                   }

          # @!method initialize(unit_config:, conversion_rate_type: :unit)
          #   @param unit_config [Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered::TieredConfig]
          required :tiered_config,
                   -> {
                     Orb::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered::TieredConfig
                   }

          # @!method initialize(tiered_config:, conversion_rate_type: :tiered)
          #   @param tiered_config [Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionCumulativeGroupedBulkPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
