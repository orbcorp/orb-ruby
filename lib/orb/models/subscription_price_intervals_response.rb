...
module Orb
  module Models
    ...
    #   adjustment_intervals: -> { Orb::ArrayOf[Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval] === _1 },
    ...
    class SubscriptionPriceIntervalsResponse < Orb::BaseModel
      ...
      required :adjustment_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval] }
      ...
      required :discount_intervals,
               -> { Orb::ArrayOf[union: Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval] }
      ...
      required :fixed_fee_quantity_schedule,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionPriceIntervalsResponse::FixedFeeQuantitySchedule] }
      ...
      required :maximum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionPriceIntervalsResponse::MaximumInterval] }
      ...
      required :minimum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionPriceIntervalsResponse::MinimumInterval] }
      ...
      required :price_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval] }
      ...
      #   # @param adjustment_intervals [Array<Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval>]
      ...
      #   # @param discount_intervals [Array<Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::AmountDiscountInterval, Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::PercentageDiscountInterval, Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::UsageDiscountInterval>]
      ...
      #   # @param maximum_intervals [Array<Orb::Models::SubscriptionPriceIntervalsResponse::MaximumInterval>]
      #   # @param metadata [Hash{Symbol=>String}]
      #   # @param minimum_intervals [Array<Orb::Models::SubscriptionPriceIntervalsResponse::MinimumInterval>]
      #   # @param net_terms [Integer]
      #   # @param plan [Orb::Models::Plan]
      #   # @param price_intervals [Array<Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval>]
      ...
      class AdjustmentInterval < Orb::BaseModel
        ...
        #
        #   @return [Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseUsageDiscountAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseAmountDiscountAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhasePercentageDiscountAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseMinimumAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseMaximumAdjustment]
        required :adjustment,
        ...
        # @!parse
        #   # @param id [String]
        #   # @param adjustment [Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseUsageDiscountAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseAmountDiscountAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhasePercentageDiscountAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseMinimumAdjustment, Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseMaximumAdjustment]
        ...
        # }
        #   # Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseUsageDiscountAdjustment ...
        # in {
        ...
        #   applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }
        # }
        #   # Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseAmountDiscountAdjustment ...
        # in {
        ...
        #   is_invoice_level: Orb::BooleanModel
        # }
        #   # Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhasePercentageDiscountAdjustment ...
        # in {
        ...
        # ```ruby
        # case adjustment
        # in Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseUsageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseAmountDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhasePercentageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseMinimumAdjustment
        #   # ...
        # in Orb::Models::SubscriptionPriceIntervalsResponse::AdjustmentInterval::Adjustment::PlanPhaseMaximumAdjustment
        #   # ...
        # end
        # ```
      ...
      # ```ruby
      # case discount_interval
      # in Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::AmountDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::PercentageDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionPriceIntervalsResponse::DiscountInterval::UsageDiscountInterval
      #   # ...
      # end
      # ```
      ...
      class PriceInterval < Orb::BaseModel
        ...
        required :fixed_fee_quantity_transitions,
                 -> { Orb::ArrayOf[Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval::FixedFeeQuantityTransition] },
                 nil?: true
        ...
        #   # @param current_billing_period_start_date [Time, nil]
        #   # @param end_date [Time, nil]
        #   # @param fixed_fee_quantity_transitions [Array<Orb::Models::SubscriptionPriceIntervalsResponse::PriceInterval::FixedFeeQuantityTransition>, nil]
