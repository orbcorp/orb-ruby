...
module Orb
  module Models
    ...
    class SubscriptionPriceIntervalsResponse < Orb::Internal::Type::BaseModel
      ...
      #   @param pending_subscription_change [Orb::Models::SubscriptionPriceIntervalsResponse::PendingSubscriptionChange, nil]
      ...
      #   @param changed_resources [Orb::Models::SubscriptionPriceIntervalsResponse::ChangedResources, nil]
