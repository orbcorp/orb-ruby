...
module Orb
  module Models
    # @example
    # ```ruby
    # subscription_unschedule_cancellation_response => {
    #   id: String,
    #   active_plan_phase_order: Integer,
    #   adjustment_intervals: -> { Orb::ArrayOf[Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval] === _1 },
    ...
    class SubscriptionUnscheduleCancellationResponse < Orb::BaseModel
      ...
      #
      #   @return [Orb::Models::SubscriptionUnscheduleCancellationResponse::BillingCycleAnchorConfiguration]
      ...
      required :maximum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUnscheduleCancellationResponse::MaximumInterval] }
      ...
      required :minimum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUnscheduleCancellationResponse::MinimumInterval] }
      ...
      #
      #   @return [Array<Orb::Models::SubscriptionUnscheduleCancellationResponse::PriceInterval>]
      required :price_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUnscheduleCancellationResponse::PriceInterval] }

      # @!attribute redeemed_coupon
      #
      #   @return [Orb::Models::SubscriptionUnscheduleCancellationResponse::RedeemedCoupon, nil]
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::SubscriptionUnscheduleCancellationResponse::Status]
      required :status, enum: -> { Orb::Models::SubscriptionUnscheduleCancellationResponse::Status }

      # @!attribute trial_info
      #
      #   @return [Orb::Models::SubscriptionUnscheduleCancellationResponse::TrialInfo]
      required :trial_info, -> { Orb::Models::SubscriptionUnscheduleCancellationResponse::TrialInfo }

      # @!parse
      #   # @param id [String]
      #   # @param active_plan_phase_order [Integer, nil]
      #   # @param adjustment_intervals [Array<Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval>]
      #   # @param auto_collection [Boolean, nil]
      #   # @param billing_cycle_anchor_configuration [Orb::Models::SubscriptionUnscheduleCancellationResponse::BillingCycleAnchorConfiguration]
      ...
      #   # @param discount_intervals [Array<Orb::Models::SubscriptionUnscheduleCancellationResponse::DiscountInterval::AmountDiscountInterval, Orb::Models::SubscriptionUnscheduleCancellationResponse::DiscountInterval::PercentageDiscountInterval, Orb::Models::SubscriptionUnscheduleCancellationResponse::DiscountInterval::UsageDiscountInterval>]
      #   # @param end_date [Time, nil]
      #   # @param fixed_fee_quantity_schedule [Array<Orb::Models::SubscriptionUnscheduleCancellationResponse::FixedFeeQuantitySchedule>]
      #   # @param invoicing_threshold [String, nil]
      #   # @param maximum_intervals [Array<Orb::Models::SubscriptionUnscheduleCancellationResponse::MaximumInterval>]
      #   # @param metadata [Hash{Symbol=>String}]
      #   # @param minimum_intervals [Array<Orb::Models::SubscriptionUnscheduleCancellationResponse::MinimumInterval>]
      #   # @param net_terms [Integer]
      #   # @param plan [Orb::Models::Plan]
      #   # @param price_intervals [Array<Orb::Models::SubscriptionUnscheduleCancellationResponse::PriceInterval>]
      #   # @param redeemed_coupon [Orb::Models::SubscriptionUnscheduleCancellationResponse::RedeemedCoupon, nil]
      #   # @param start_date [Time]
      #   # @param status [Symbol, Orb::Models::SubscriptionUnscheduleCancellationResponse::Status]
      #   # @param trial_info [Orb::Models::SubscriptionUnscheduleCancellationResponse::TrialInfo]
      #   #
      #   def initialize(
      #     id:,
      ...
      # adjustment_interval => {
      #   id: String,
      #   adjustment: Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment,
      ...
      class AdjustmentInterval < Orb::BaseModel
        ...
        #
        #   @return [Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::MaximumAdjustment]
        required :adjustment,
                 union: -> {
        ...
        # @!parse
        #   # @param id [String]
        #   # @param adjustment [Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::MaximumAdjustment]
        ...
        #   # Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment ...
        ...
        #   # Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment ...
        # in {adjustment_type: "usage_discount", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment ...
        # in {adjustment_type: "minimum", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::MinimumAdjustment ...
        # in {adjustment_type: "maximum", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::MaximumAdjustment ...
        # end
        # ```
        #
        # @example
        # ```ruby
        # case adjustment
        # in Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::MinimumAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUnscheduleCancellationResponse::AdjustmentInterval::Adjustment::MaximumAdjustment
        #   # ...
        # end
        # ```
      ...
      # ```ruby
      # case discount_interval
      # in Orb::Models::SubscriptionUnscheduleCancellationResponse::DiscountInterval::AmountDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionUnscheduleCancellationResponse::DiscountInterval::PercentageDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionUnscheduleCancellationResponse::DiscountInterval::UsageDiscountInterval
      #   # ...
      # end
      # ```
      ...
      class PriceInterval < Orb::BaseModel
        ...
        #   # @param current_billing_period_start_date [Time, nil]
        #   # @param end_date [Time, nil]
        #   # @param fixed_fee_quantity_transitions [Array<Orb::Models::SubscriptionUnscheduleCancellationResponse::PriceInterval::FixedFeeQuantityTransition>, nil]
