...
module Orb
  module Models
    class NewPlanUnitWithProrationPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewPlanUnitWithProrationPrice::UnitWithProrationConfig]
      required :unit_with_proration_config, -> { Orb::NewPlanUnitWithProrationPrice::UnitWithProrationConfig }
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewPlanUnitWithProrationPrice::ModelType] The pricing model type
      #
      #   @param name [String] The name of the price.
      #
      #   @param unit_with_proration_config [Orb::Models::NewPlanUnitWithProrationPrice::UnitWithProrationConfig] Configuration for unit_with_proration pricing
      #
      ...
      # @see Orb::Models::NewPlanUnitWithProrationPrice#unit_with_proration_config
