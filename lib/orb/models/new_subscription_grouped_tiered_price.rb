...
module Orb
  module Models
    class NewSubscriptionGroupedTieredPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewSubscriptionGroupedTieredPrice::GroupedTieredConfig]
      required :grouped_tiered_config, -> { Orb::NewSubscriptionGroupedTieredPrice::GroupedTieredConfig }
      ...
      #
      #   @param grouped_tiered_config [Orb::Models::NewSubscriptionGroupedTieredPrice::GroupedTieredConfig] Configuration for grouped_tiered pricing
      #
      #   @param item_id [String] The id of the item the price will be associated with.
      #
      #   @param model_type [Symbol, Orb::Models::NewSubscriptionGroupedTieredPrice::ModelType] The pricing model type
      #
      ...
      # @see Orb::Models::NewSubscriptionGroupedTieredPrice#grouped_tiered_config
      class GroupedTieredConfig < Orb::Internal::Type::BaseModel
        ...
        #   key
        #
        #   @return [Array<Orb::Models::NewSubscriptionGroupedTieredPrice::GroupedTieredConfig::Tier>]
        required :tiers,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewSubscriptionGroupedTieredPrice::GroupedTieredConfig::Tier] }

        # @!method initialize(grouping_key:, tiers:)
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::NewSubscriptionGroupedTieredPrice::GroupedTieredConfig} for more
        #   details.
        #
        #   Configuration for grouped_tiered pricing
        #
        ...
        #
        #   @param tiers [Array<Orb::Models::NewSubscriptionGroupedTieredPrice::GroupedTieredConfig::Tier>] Apply tiered pricing to each segment generated after grouping with the provided
