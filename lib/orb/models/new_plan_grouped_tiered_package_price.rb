...
module Orb
  module Models
    class NewPlanGroupedTieredPackagePrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewPlanGroupedTieredPackagePrice::GroupedTieredPackageConfig]
      ...
      #
      #   @param grouped_tiered_package_config [Orb::Models::NewPlanGroupedTieredPackagePrice::GroupedTieredPackageConfig] Configuration for grouped_tiered_package pricing
      #
      #   @param item_id [String] The id of the item the price will be associated with.
      #
      #   @param model_type [Symbol, Orb::Models::NewPlanGroupedTieredPackagePrice::ModelType] The pricing model type
      #
      ...
      # @see Orb::Models::NewPlanGroupedTieredPackagePrice#grouped_tiered_package_config
      class GroupedTieredPackageConfig < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Orb::Models::NewPlanGroupedTieredPackagePrice::GroupedTieredPackageConfig::Tier>]
        required :tiers,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewPlanGroupedTieredPackagePrice::GroupedTieredPackageConfig::Tier] }

        # @!method initialize(grouping_key:, package_size:, tiers:)
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::NewPlanGroupedTieredPackagePrice::GroupedTieredPackageConfig} for
        #   more details.
        #
        #   Configuration for grouped_tiered_package pricing
        #
        ...
        #
        #   @param tiers [Array<Orb::Models::NewPlanGroupedTieredPackagePrice::GroupedTieredPackageConfig::Tier>] Apply tiered pricing after rounding up the quantity to the package size. Tiers a
