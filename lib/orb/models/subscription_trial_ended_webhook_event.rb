...
module Orb
  module Models
    class SubscriptionTrialEndedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::SubscriptionTrialEndedWebhookEvent::Type]
      required :type, enum: -> { Orb::SubscriptionTrialEndedWebhookEvent::Type }

      # @!method initialize(id:, created_at:, properties:, subscription:, type:)
      #   Some parameter documentations has been truncated, see
      #   {Orb::Models::SubscriptionTrialEndedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, Orb::Models::SubscriptionTrialEndedWebhookEvent::Type] The event this payload describes.

      # The event this payload describes.
      #
      # @see Orb::Models::SubscriptionTrialEndedWebhookEvent#type
      module Type
