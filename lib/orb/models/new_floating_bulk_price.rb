...
module Orb
  module Models
    class NewFloatingBulkPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::NewFloatingBulkPrice::Cadence]
      required :cadence, enum: -> { Orb::NewFloatingBulkPrice::Cadence }
      ...
      #
      #   @return [Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Tiered, nil]
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      # The cadence to bill for this price on.
      #
      # @see Orb::Models::NewFloatingBulkPrice#cadence
      module Cadence
      ...
      module ConversionRateConfig
        ...
        variant :unit, -> { Orb::NewFloatingBulkPrice::ConversionRateConfig::Unit }

        variant :tiered, -> { Orb::NewFloatingBulkPrice::ConversionRateConfig::Tiered }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Unit::UnitConfig]
          required :unit_config, -> { Orb::NewFloatingBulkPrice::ConversionRateConfig::Unit::UnitConfig }

          # @!method initialize(unit_config:, conversion_rate_type: :unit)
          #   @param unit_config [Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Tiered::TieredConfig]
          required :tiered_config,
                   -> {
                     Orb::NewFloatingBulkPrice::ConversionRateConfig::Tiered::TieredConfig
                   }

          # @!method initialize(tiered_config:, conversion_rate_type: :tiered)
          #   @param tiered_config [Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewFloatingBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingBulkPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
