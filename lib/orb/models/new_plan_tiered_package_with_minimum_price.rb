...
module Orb
  module Models
    class NewPlanTieredPackageWithMinimumPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::NewPlanTieredPackageWithMinimumPrice::Cadence]
      required :cadence, enum: -> { Orb::NewPlanTieredPackageWithMinimumPrice::Cadence }
      ...
      #
      #   @return [Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered, nil]
      optional :conversion_rate_config,
               union: -> { Orb::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig },
               nil?: true
      ...
      #
      #   @param cadence [Symbol, Orb::Models::NewPlanTieredPackageWithMinimumPrice::Cadence] The cadence to bill for this price on.
      #
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      # The cadence to bill for this price on.
      #
      # @see Orb::Models::NewPlanTieredPackageWithMinimumPrice#cadence
      module Cadence
      ...
      # The configuration for the rate of the price currency to the invoicing currency.
      #
      # @see Orb::Models::NewPlanTieredPackageWithMinimumPrice#conversion_rate_config
      module ConversionRateConfig
        extend Orb::Internal::Type::Union

        discriminator :conversion_rate_type

        variant :unit, -> { Orb::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Unit }

        variant :tiered, -> { Orb::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Unit::UnitConfig]
          ...
          #   @param unit_config [Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig]
          ...
          #   @param tiered_config [Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewPlanTieredPackageWithMinimumPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
