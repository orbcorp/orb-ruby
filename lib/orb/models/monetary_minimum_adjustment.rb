...
module Orb
  module Models
    class MonetaryMinimumAdjustment < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Orb::Models::MonetaryMinimumAdjustment::Filter>]
      required :filters, -> { Orb::Internal::Type::ArrayOf[Orb::MonetaryMinimumAdjustment::Filter] }
      ...
      #
      #   @param filters [Array<Orb::Models::MonetaryMinimumAdjustment::Filter>] The filters that determine which prices to apply this adjustment to.
      #
      ...
      class Filter < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::MonetaryMinimumAdjustment::Filter::Field]
        required :field, enum: -> { Orb::MonetaryMinimumAdjustment::Filter::Field }

        # @!attribute operator
        #   Should prices that match the filter be included or excluded.
        #
        #   @return [Symbol, Orb::Models::MonetaryMinimumAdjustment::Filter::Operator]
        required :operator, enum: -> { Orb::MonetaryMinimumAdjustment::Filter::Operator }
        ...
        #   @param field [Symbol, Orb::Models::MonetaryMinimumAdjustment::Filter::Field] The property of the price to filter on.
        #
        #   @param operator [Symbol, Orb::Models::MonetaryMinimumAdjustment::Filter::Operator] Should prices that match the filter be included or excluded.
        #
        #   @param values [Array<String>] The IDs or values that match this filter.

        # The property of the price to filter on.
        #
        # @see Orb::Models::MonetaryMinimumAdjustment::Filter#field
        module Field
          extend Orb::Internal::Type::Enum
        ...
        # Should prices that match the filter be included or excluded.
        #
        # @see Orb::Models::MonetaryMinimumAdjustment::Filter#operator
        module Operator
          extend Orb::Internal::Type::Enum
