...
module Orb
  module Models
    class TransactionAccountingSyncFailedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::TransactionAccountingSyncFailedWebhookEvent::AccountingSyncRecord]
      ...
      #
      #   @return [Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Properties]
      required :properties, -> { Orb::TransactionAccountingSyncFailedWebhookEvent::Properties }

      # @!attribute transaction
      #
      #   @return [Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Transaction]
      required :transaction, -> { Orb::TransactionAccountingSyncFailedWebhookEvent::Transaction }

      # @!attribute type
      #   The event this payload describes.
      #
      #   @return [Symbol, Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Type]
      ...
      #
      #   @param accounting_sync_record [Orb::Models::TransactionAccountingSyncFailedWebhookEvent::AccountingSyncRecord]
      #
      #   @param created_at [Time] The time at which this event was created, to the second.
      #
      #   @param properties [Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Properties]
      #
      #   @param transaction [Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Transaction]
      #
      #   @param type [Symbol, Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Type] The event this payload describes.

      # @see Orb::Models::TransactionAccountingSyncFailedWebhookEvent#accounting_sync_record
      class AccountingSyncRecord < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::TransactionAccountingSyncFailedWebhookEvent::AccountingSyncRecord::RecordType]
        required :record_type,
                 enum: -> { Orb::TransactionAccountingSyncFailedWebhookEvent::AccountingSyncRecord::RecordType }
        ...
        #   @param record_type [Symbol, Orb::Models::TransactionAccountingSyncFailedWebhookEvent::AccountingSyncRecord::RecordType]
        ...
        # @see Orb::Models::TransactionAccountingSyncFailedWebhookEvent::AccountingSyncRecord#record_type
        module RecordType
      ...
      # @see Orb::Models::TransactionAccountingSyncFailedWebhookEvent#properties
      ...
      # @see Orb::Models::TransactionAccountingSyncFailedWebhookEvent#transaction
      class Transaction < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Transaction::PaymentProvider, nil]
        required :payment_provider,
                 enum: -> { Orb::TransactionAccountingSyncFailedWebhookEvent::Transaction::PaymentProvider },
                 nil?: true
        ...
        #   {Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Transaction} for more
        #   details.
        #
        ...
        #
        #   @param payment_provider [Symbol, Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Transaction::PaymentProvider, nil] The payment provider that attempted to collect the payment.
        #
        ...
        # The payment provider that attempted to collect the payment.
        #
        # @see Orb::Models::TransactionAccountingSyncFailedWebhookEvent::Transaction#payment_provider
      ...
      # The event this payload describes.
      #
      # @see Orb::Models::TransactionAccountingSyncFailedWebhookEvent#type
      module Type
        extend Orb::Internal::Type::Enum

        TRANSACTION_ACCOUNTING_SYNC_FAILED = :"transaction.accounting_sync_failed"
