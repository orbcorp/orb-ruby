...
module Orb
  module Models
    class NewSubscriptionScalableMatrixWithTieredPricingPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewSubscriptionScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig]
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewSubscriptionScalableMatrixWithTieredPricingPrice::ModelType] The pricing model type
      #
      #   @param name [String] The name of the price.
      #
      #   @param scalable_matrix_with_tiered_pricing_config [Orb::Models::NewSubscriptionScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig] Configuration for scalable_matrix_with_tiered_pricing pricing
      #
      ...
      # @see Orb::Models::NewSubscriptionScalableMatrixWithTieredPricingPrice#scalable_matrix_with_tiered_pricing_config
      class ScalableMatrixWithTieredPricingConfig < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Orb::Models::NewSubscriptionScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig::MatrixScalingFactor>]
        ...
        #
        #   @return [Array<Orb::Models::NewSubscriptionScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig::Tier>]
        required :tiers,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewSubscriptionScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig::Tier] }
        ...
        #
        #   @param matrix_scaling_factors [Array<Orb::Models::NewSubscriptionScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig::MatrixScalingFactor>] Apply a scaling factor to each dimension
        #
        #   @param tiers [Array<Orb::Models::NewSubscriptionScalableMatrixWithTieredPricingPrice::ScalableMatrixWithTieredPricingConfig::Tier>] Tier pricing structure
        #
