...
module Orb
  module Models
    class NewFloatingMatrixWithDisplayNamePrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered, nil]
      optional :conversion_rate_config,
               union: -> { Orb::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig },
               nil?: true
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      # The configuration for the rate of the price currency to the invoicing currency.
      #
      # @see Orb::Models::NewFloatingMatrixWithDisplayNamePrice#conversion_rate_config
      module ConversionRateConfig
        extend Orb::Internal::Type::Union

        discriminator :conversion_rate_type

        variant :unit, -> { Orb::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Unit }

        variant :tiered, -> { Orb::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Unit::UnitConfig]
          required :unit_config,
                   -> { Orb::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Unit::UnitConfig }

          # @!method initialize(unit_config:, conversion_rate_type: :unit)
          #   @param unit_config [Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered::TieredConfig]
          required :tiered_config,
                   -> {
                     Orb::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered::TieredConfig
                   }

          # @!method initialize(tiered_config:, conversion_rate_type: :tiered)
          #   @param tiered_config [Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingMatrixWithDisplayNamePrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
