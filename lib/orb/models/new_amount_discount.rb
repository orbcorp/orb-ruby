...
module Orb
  module Models
    class NewAmountDiscount < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Orb::Models::NewAmountDiscount::Filter>, nil]
      optional :filters, -> { Orb::Internal::Type::ArrayOf[Orb::NewAmountDiscount::Filter] }, nil?: true
      ...
      #
      #   @param filters [Array<Orb::Models::NewAmountDiscount::Filter>, nil] A list of filters that determine which prices this adjustment will apply to.
      #
      ...
      class Filter < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::NewAmountDiscount::Filter::Field]
        required :field, enum: -> { Orb::NewAmountDiscount::Filter::Field }

        # @!attribute operator
        #   Should prices that match the filter be included or excluded.
        #
        #   @return [Symbol, Orb::Models::NewAmountDiscount::Filter::Operator]
        required :operator, enum: -> { Orb::NewAmountDiscount::Filter::Operator }
        ...
        #   @param field [Symbol, Orb::Models::NewAmountDiscount::Filter::Field] The property of the price to filter on.
        #
        #   @param operator [Symbol, Orb::Models::NewAmountDiscount::Filter::Operator] Should prices that match the filter be included or excluded.
        #
        #   @param values [Array<String>] The IDs or values that match this filter.

        # The property of the price to filter on.
        #
        # @see Orb::Models::NewAmountDiscount::Filter#field
        module Field
          extend Orb::Internal::Type::Enum
        ...
        # Should prices that match the filter be included or excluded.
        #
        # @see Orb::Models::NewAmountDiscount::Filter#operator
        module Operator
          extend Orb::Internal::Type::Enum
