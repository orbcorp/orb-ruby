...
module Orb
  module Models
    class MonetaryAmountDiscountAdjustment < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Orb::Models::MonetaryAmountDiscountAdjustment::Filter>]
      required :filters, -> { Orb::Internal::Type::ArrayOf[Orb::MonetaryAmountDiscountAdjustment::Filter] }
      ...
      #
      #   @param filters [Array<Orb::Models::MonetaryAmountDiscountAdjustment::Filter>] The filters that determine which prices to apply this adjustment to.
      #
      ...
      class Filter < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::MonetaryAmountDiscountAdjustment::Filter::Field]
        required :field, enum: -> { Orb::MonetaryAmountDiscountAdjustment::Filter::Field }

        # @!attribute operator
        #   Should prices that match the filter be included or excluded.
        #
        #   @return [Symbol, Orb::Models::MonetaryAmountDiscountAdjustment::Filter::Operator]
        required :operator, enum: -> { Orb::MonetaryAmountDiscountAdjustment::Filter::Operator }
        ...
        #   @param field [Symbol, Orb::Models::MonetaryAmountDiscountAdjustment::Filter::Field] The property of the price to filter on.
        #
        #   @param operator [Symbol, Orb::Models::MonetaryAmountDiscountAdjustment::Filter::Operator] Should prices that match the filter be included or excluded.
        #
        #   @param values [Array<String>] The IDs or values that match this filter.

        # The property of the price to filter on.
        #
        # @see Orb::Models::MonetaryAmountDiscountAdjustment::Filter#field
        module Field
          extend Orb::Internal::Type::Enum
        ...
        # Should prices that match the filter be included or excluded.
        #
        # @see Orb::Models::MonetaryAmountDiscountAdjustment::Filter#operator
        module Operator
          extend Orb::Internal::Type::Enum
