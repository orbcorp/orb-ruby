...
module Orb
  module Models
    class TrialDiscountModel < Orb::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::TrialDiscountModel::DiscountType]
      ...
      #   # @param discount_type [Symbol, Orb::Models::TrialDiscountModel::DiscountType]
