...
module Orb
  module Models
    class NewFloatingScalableMatrixWithUnitPricingPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered, nil]
      optional :conversion_rate_config,
               union: -> { Orb::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig },
               nil?: true
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      # The configuration for the rate of the price currency to the invoicing currency.
      #
      # @see Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice#conversion_rate_config
      module ConversionRateConfig
        extend Orb::Internal::Type::Union

        discriminator :conversion_rate_type

        variant :unit, -> { Orb::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit }

        variant :tiered,
                -> {
                  Orb::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered
                }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit::UnitConfig]
          required :unit_config,
                   -> {
                     Orb::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit::UnitConfig
                   }

          # @!method initialize(unit_config:, conversion_rate_type: :unit)
          #   @param unit_config [Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::TieredConfig]
          required :tiered_config,
                   -> {
                     Orb::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::TieredConfig
                   }

          # @!method initialize(tiered_config:, conversion_rate_type: :tiered)
          #   @param tiered_config [Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
