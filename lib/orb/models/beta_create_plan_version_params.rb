    ...
    class BetaCreatePlanVersionParams < Orb::Internal::Type::BaseModel
      ...
      class AddPrice < Orb::Internal::Type::BaseModel
        ...
        module Price
          ...
          variant :minimum, -> { Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum }
          ...
          class Minimum < Orb::Internal::Type::BaseModel
            ...
            #   The cadence to bill for this price on.
            #
            #   @return [Symbol, Orb::Models::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::Cadence]
            required :cadence, enum: -> { Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::Cadence }
            ...
            #
            #   @return [Orb::Models::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::MinimumConfig]
            required :minimum_config, -> { Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::MinimumConfig }
            ...
            optional :conversion_rate_config,
                     union: -> {
                       Orb::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::ConversionRateConfig
                     },
                     nil?: true
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::BetaCreatePlanVersionParams::AddPrice::Price::Minimum} for more
            #   details.
            #
            ...
            #   @param item_id [String] The id of the item the price will be associated with.
            #
            #   @param minimum_config [Orb::Models::BetaCreatePlanVersionParams::AddPrice::Price::Minimum::MinimumConfig] Configuration for minimum pricing
            #
            #   @param name [String] The name of the price.
            #
            #   @param billable_metric_id [String, nil] The id of the billable metric for the price. Only needed if the price is usage-b
            ...
            # The cadence to bill for this price on.
            #
            # @see Orb::Models::BetaCreatePlanVersionParams::AddPrice::Price::Minimum#cadence
            module Cadence
              extend Orb::Internal::Type::Enum
            ...
            # @see Orb::Models::BetaCreatePlanVersionParams::AddPrice::Price::Minimum#minimum_config
      ...
      class ReplacePrice < Orb::Internal::Type::BaseModel
        ...
        module Price
          ...
          variant :minimum, -> { Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum }
          ...
          class Minimum < Orb::Internal::Type::BaseModel
            ...
            #   The cadence to bill for this price on.
            #
            #   @return [Symbol, Orb::Models::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::Cadence]
            required :cadence, enum: -> { Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::Cadence }
            ...
            #   Configuration for minimum pricing
            #
            #   @return [Orb::Models::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::MinimumConfig]
            ...
            optional :conversion_rate_config,
                     union: -> {
                       Orb::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::ConversionRateConfig
                     },
                     nil?: true
            ...
            # @!method initialize(cadence:, item_id:, minimum_config:, name:, billable_metric_id: nil, billed_in_advance: nil, billing_cycle_configuration: nil, conversion_rate: nil, conversion_rate_config: nil, currency: nil, dimensional_price_configuration: nil, external_price_id: nil, fixed_price_quantity: nil, invoice_grouping_key: nil, invoicing_cycle_configuration: nil, metadata: nil, reference_id: nil, model_type: :minimum)
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum} for
            #   more details.
            #
            ...
            #   @param item_id [String] The id of the item the price will be associated with.
            #
            #   @param minimum_config [Orb::Models::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum::MinimumConfig] Configuration for minimum pricing
            #
            #   @param name [String] The name of the price.
            #
            #   @param billable_metric_id [String, nil] The id of the billable metric for the price. Only needed if the price is usage-b
            ...
            # The cadence to bill for this price on.
            #
            # @see Orb::Models::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum#cadence
            module Cadence
              extend Orb::Internal::Type::Enum
            ...
            # @see Orb::Models::BetaCreatePlanVersionParams::ReplacePrice::Price::Minimum#minimum_config
            class MinimumConfig < Orb::Internal::Type::BaseModel
              # @!attribute minimum_amount
              #   The minimum amount to apply
              #
