...
module Orb
  module Models
    # @example
    # ```ruby
    # subscription_schedule_plan_change_response => {
    #   id: String,
    #   active_plan_phase_order: Integer,
    #   adjustment_intervals: -> { Orb::ArrayOf[Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval] === _1 },
    ...
    class SubscriptionSchedulePlanChangeResponse < Orb::BaseModel
      ...
      required :adjustment_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval] }
      ...
      required :discount_intervals,
               -> {
                 Orb::ArrayOf[union: Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval]
               }
      ...
      required :fixed_fee_quantity_schedule,
               -> {
                 Orb::ArrayOf[Orb::Models::SubscriptionSchedulePlanChangeResponse::FixedFeeQuantitySchedule]
               }
      ...
      required :maximum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionSchedulePlanChangeResponse::MaximumInterval] }
      ...
      required :minimum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionSchedulePlanChangeResponse::MinimumInterval] }
      ...
      required :price_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval] }
      ...
      #   # @param adjustment_intervals [Array<Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval>]
      ...
      #   # @param discount_intervals [Array<Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::AmountDiscountInterval, Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::PercentageDiscountInterval, Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::UsageDiscountInterval>]
      ...
      #   # @param maximum_intervals [Array<Orb::Models::SubscriptionSchedulePlanChangeResponse::MaximumInterval>]
      #   # @param metadata [Hash{Symbol=>String}]
      #   # @param minimum_intervals [Array<Orb::Models::SubscriptionSchedulePlanChangeResponse::MinimumInterval>]
      #   # @param net_terms [Integer]
      #   # @param plan [Orb::Models::Plan]
      #   # @param price_intervals [Array<Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval>]
      ...
      # adjustment_interval => {
      #   id: String,
      #   adjustment: Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment,
      ...
      class AdjustmentInterval < Orb::BaseModel
        ...
        required :adjustment,
                 union: -> {
                   Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment
                 }
        ...
        #   # Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhaseUsageDiscountAdjustment ...
        # in {adjustment_type: "amount_discount", id: String, amount_discount: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }}
        #   # Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhaseAmountDiscountAdjustment ...
        ...
        #   # Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhasePercentageDiscountAdjustment ...
        # in {adjustment_type: "minimum", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhaseMinimumAdjustment ...
        # in {adjustment_type: "maximum", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhaseMaximumAdjustment ...
        # end
        # ```
        #
        # @example
        # ```ruby
        # case adjustment
        # in Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhaseUsageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhaseAmountDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhasePercentageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhaseMinimumAdjustment
        #   # ...
        # in Orb::Models::SubscriptionSchedulePlanChangeResponse::AdjustmentInterval::Adjustment::PlanPhaseMaximumAdjustment
        #   # ...
        # end
        # ```
      ...
      # ```ruby
      # case discount_interval
      # in Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::AmountDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::PercentageDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::UsageDiscountInterval
      #   # ...
      # end
      # ```
      ...
      class PriceInterval < Orb::BaseModel
        ...
        required :fixed_fee_quantity_transitions,
                 -> {
                   Orb::ArrayOf[Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval::FixedFeeQuantityTransition]
                 },
                 nil?: true
        ...
        #   # @param current_billing_period_start_date [Time, nil]
        #   # @param end_date [Time, nil]
        #   # @param fixed_fee_quantity_transitions [Array<Orb::Models::SubscriptionSchedulePlanChangeResponse::PriceInterval::FixedFeeQuantityTransition>, nil]
