...
module Orb
  module Models
    ...
    class SubscriptionSchedulePlanChangeResponse < Orb::Internal::Type::BaseModel
      ...
      #   ...
      #
      #   @param discount_intervals [Array<Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::AmountDiscountInterval, Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::PercentageDiscountInterval, Orb::Models::SubscriptionSchedulePlanChangeResponse::DiscountInterval::UsageDiscountInterval>] The discount intervals for this subscription sorted by the start_date.
      #
