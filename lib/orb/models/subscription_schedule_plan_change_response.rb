...
module Orb
  module Models
    ...
    class SubscriptionSchedulePlanChangeResponse < Orb::Internal::Type::BaseModel
      ...
      #   @param pending_subscription_change [Orb::Models::SubscriptionSchedulePlanChangeResponse::PendingSubscriptionChange, nil]
      ...
      #   @param changed_resources [Orb::Models::SubscriptionSchedulePlanChangeResponse::ChangedResources, nil]
