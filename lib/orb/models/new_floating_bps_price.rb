...
module Orb
  module Models
    class NewFloatingBPSPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::NewFloatingBPSPrice::Cadence]
      required :cadence, enum: -> { Orb::NewFloatingBPSPrice::Cadence }
      ...
      #
      #   @return [Symbol, Orb::Models::NewFloatingBPSPrice::ModelType]
      required :model_type, enum: -> { Orb::NewFloatingBPSPrice::ModelType }
      ...
      #
      #   @return [Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Tiered, nil]
      ...
      #
      #   @param cadence [Symbol, Orb::Models::NewFloatingBPSPrice::Cadence] The cadence to bill for this price on.
      #
      #   @param currency [String] An ISO 4217 currency string for which this price is billed in.
      #
      #   @param item_id [String] The id of the item the price will be associated with.
      #
      #   @param model_type [Symbol, Orb::Models::NewFloatingBPSPrice::ModelType]
      #
      ...
      # The cadence to bill for this price on.
      #
      # @see Orb::Models::NewFloatingBPSPrice#cadence
      module Cadence
      ...
      # @see Orb::Models::NewFloatingBPSPrice#model_type
      module ModelType
        extend Orb::Internal::Type::Enum
      ...
      module ConversionRateConfig
        ...
        variant :unit, -> { Orb::NewFloatingBPSPrice::ConversionRateConfig::Unit }

        variant :tiered, -> { Orb::NewFloatingBPSPrice::ConversionRateConfig::Tiered }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Unit::UnitConfig]
          required :unit_config, -> { Orb::NewFloatingBPSPrice::ConversionRateConfig::Unit::UnitConfig }

          # @!method initialize(unit_config:, conversion_rate_type: :unit)
          #   @param unit_config [Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Tiered::TieredConfig]
          required :tiered_config, -> { Orb::NewFloatingBPSPrice::ConversionRateConfig::Tiered::TieredConfig }

          # @!method initialize(tiered_config:, conversion_rate_type: :tiered)
          #   @param tiered_config [Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewFloatingBPSPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }
        ...
        #   @return [Array(Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingBPSPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
