...
module Orb
  module Models
    class NewPlanGroupedWithMeteredMinimumPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::Cadence]
      ...
      #
      #   @return [Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered, nil]
      optional :conversion_rate_config,
               union: -> { Orb::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig },
               nil?: true
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      # The cadence to bill for this price on.
      #
      # @see Orb::Models::NewPlanGroupedWithMeteredMinimumPrice#cadence
      module Cadence
      ...
      # The configuration for the rate of the price currency to the invoicing currency.
      #
      # @see Orb::Models::NewPlanGroupedWithMeteredMinimumPrice#conversion_rate_config
      module ConversionRateConfig
        extend Orb::Internal::Type::Union

        discriminator :conversion_rate_type

        variant :unit, -> { Orb::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit }

        variant :tiered, -> { Orb::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit::UnitConfig]
          required :unit_config,
                   -> { Orb::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit::UnitConfig }

          # @!method initialize(unit_config:, conversion_rate_type: :unit)
          #   @param unit_config [Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig]
          required :tiered_config,
                   -> {
                     Orb::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig
                   }

          # @!method initialize(tiered_config:, conversion_rate_type: :tiered)
          #   @param tiered_config [Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewPlanGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
