...
module Orb
  module Models
    class NewPlanUnitWithPercentPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewPlanUnitWithPercentPrice::UnitWithPercentConfig]
      required :unit_with_percent_config, -> { Orb::NewPlanUnitWithPercentPrice::UnitWithPercentConfig }
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewPlanUnitWithPercentPrice::ModelType] The pricing model type
      #
      #   @param name [String] The name of the price.
      #
      #   @param unit_with_percent_config [Orb::Models::NewPlanUnitWithPercentPrice::UnitWithPercentConfig] Configuration for unit_with_percent pricing
      #
      ...
      # @see Orb::Models::NewPlanUnitWithPercentPrice#unit_with_percent_config
