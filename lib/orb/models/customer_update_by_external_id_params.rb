  ...
  module Models
    class CustomerUpdateByExternalIDParams < Orb::BaseModel
      ...
      optional :payment_provider,
               enum: -> { Orb::Models::CustomerUpdateByExternalIDParams::PaymentProvider },
               nil?: true
      ...
      optional :reporting_configuration,
               -> { Orb::Models::CustomerUpdateByExternalIDParams::ReportingConfiguration },
               nil?: true
      ...
      optional :tax_id, -> { Orb::Models::CustomerUpdateByExternalIDParams::TaxID }, nil?: true
      ...
      #   accounting_providers: -> { Orb::ArrayOf[Orb::Models::CustomerUpdateByExternalIDParams::AccountingSyncConfiguration::AccountingProvider] === _1 },
      ...
      # ```ruby
      # case tax_configuration
      # in Orb::Models::CustomerUpdateByExternalIDParams::TaxConfiguration::NewAvalaraTaxConfiguration
      #   # ...
      # in Orb::Models::CustomerUpdateByExternalIDParams::TaxConfiguration::NewTaxJarConfiguration
      #   # ...
      # end
      # ```
      ...
      #   type: Orb::Models::CustomerUpdateByExternalIDParams::TaxID::Type,
      #   value: String
      # }
      # ```
      class TaxID < Orb::BaseModel
        ...
        required :country, enum: -> { Orb::Models::CustomerUpdateByExternalIDParams::TaxID::Country }

        # @!attribute type
        #
        #   @return [Symbol, Orb::Models::CustomerUpdateByExternalIDParams::TaxID::Type]
        required :type, enum: -> { Orb::Models::CustomerUpdateByExternalIDParams::TaxID::Type }
