...
module Orb
  module Models
    # @see Orb::Resources::Invoices#list_summary
    class InvoiceListSummaryResponse < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::InvoiceListSummaryResponse::AutoCollection]
      required :auto_collection, -> { Orb::Models::InvoiceListSummaryResponse::AutoCollection }
      ...
      #
      #   @return [Array<Orb::Models::InvoiceListSummaryResponse::CreditNote>]
      required :credit_notes,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::InvoiceListSummaryResponse::CreditNote] }
      ...
      #
      #   @return [Array<Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction>]
      required :customer_balance_transactions,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction] }
      ...
      #
      #   @return [Symbol, Orb::Models::InvoiceListSummaryResponse::InvoiceSource]
      required :invoice_source, enum: -> { Orb::Models::InvoiceListSummaryResponse::InvoiceSource }
      ...
      #
      #   @return [Array<Orb::Models::InvoiceListSummaryResponse::PaymentAttempt>]
      required :payment_attempts,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::InvoiceListSummaryResponse::PaymentAttempt] }
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::InvoiceListSummaryResponse::Status]
      required :status, enum: -> { Orb::Models::InvoiceListSummaryResponse::Status }
      ...
      #
      #   @param auto_collection [Orb::Models::InvoiceListSummaryResponse::AutoCollection]
      #
      #   @param billing_address [Orb::Models::Address, nil]
      #
      #   @param created_at [Time] The creation time of the resource in Orb.
      #
      #   @param credit_notes [Array<Orb::Models::InvoiceListSummaryResponse::CreditNote>] A list of credit notes associated with the invoice
      #
      #   @param currency [String] An ISO 4217 currency string or `credits`
      #
      #   @param customer [Orb::Models::CustomerMinified]
      #
      #   @param customer_balance_transactions [Array<Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction>]
      #
      ...
      #
      #   @param invoice_source [Symbol, Orb::Models::InvoiceListSummaryResponse::InvoiceSource]
      #
      ...
      #
      #   @param payment_attempts [Array<Orb::Models::InvoiceListSummaryResponse::PaymentAttempt>] A list of payment attempts associated with the invoice
      #
      ...
      #
      #   @param status [Symbol, Orb::Models::InvoiceListSummaryResponse::Status]
      #
      ...
      # @see Orb::Models::InvoiceListSummaryResponse#auto_collection
      class AutoCollection < Orb::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::InvoiceListSummaryResponse::AutoCollection} for more details.
        #
      ...
      class CreditNote < Orb::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::InvoiceListSummaryResponse::CreditNote} for more details.
        #
        #   @param id [String]
        #
      ...
      class CustomerBalanceTransaction < Orb::Internal::Type::BaseModel
        ...
        # @!attribute action
        #
        #   @return [Symbol, Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction::Action]
        required :action, enum: -> { Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction::Action }
        ...
        # @!attribute type
        #
        #   @return [Symbol, Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction::Type]
        required :type, enum: -> { Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction::Type }

        # @!method initialize(id:, action:, amount:, created_at:, credit_note:, description:, ending_balance:, invoice:, starting_balance:, type:)
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction} for more
        #   details.
        #
        #   @param id [String] A unique id for this transaction.
        #
        #   @param action [Symbol, Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction::Action]
        #
        ...
        #
        #   @param type [Symbol, Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction::Type]

        # @see Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction#action
        module Action
        ...
        # @see Orb::Models::InvoiceListSummaryResponse::CustomerBalanceTransaction#type
        module Type
          extend Orb::Internal::Type::Enum
      ...
      # @see Orb::Models::InvoiceListSummaryResponse#invoice_source
      ...
      class PaymentAttempt < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::InvoiceListSummaryResponse::PaymentAttempt::PaymentProvider, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::InvoiceListSummaryResponse::PaymentAttempt} for more details.
        #
        ...
        #
        #   @param payment_provider [Symbol, Orb::Models::InvoiceListSummaryResponse::PaymentAttempt::PaymentProvider, nil] The payment provider that attempted to collect the payment.
        #
        ...
        # The payment provider that attempted to collect the payment.
        #
        # @see Orb::Models::InvoiceListSummaryResponse::PaymentAttempt#payment_provider
      ...
      # @see Orb::Models::InvoiceListSummaryResponse#status
      module Status
        extend Orb::Internal::Type::Enum
