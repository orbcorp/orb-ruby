...
module Orb
  module Models
    class NewFloatingTieredPackagePrice < Orb::Internal::Type::BaseModel
      ...
      # @!method initialize(cadence:, currency:, item_id:, model_type:, name:, tiered_package_config:, billable_metric_id: nil, billed_in_advance: nil, billing_cycle_configuration: nil, conversion_rate: nil, dimensional_price_configuration: nil, external_price_id: nil, fixed_price_quantity: nil, invoice_grouping_key: nil, invoicing_cycle_configuration: nil, metadata: nil)
