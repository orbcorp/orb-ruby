...
module Orb
  module Models
    class NewSubscriptionUnitWithPercentPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewSubscriptionUnitWithPercentPrice::UnitWithPercentConfig]
      required :unit_with_percent_config, -> { Orb::NewSubscriptionUnitWithPercentPrice::UnitWithPercentConfig }
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewSubscriptionUnitWithPercentPrice::ModelType] The pricing model type
      #
      #   @param name [String] The name of the price.
      #
      #   @param unit_with_percent_config [Orb::Models::NewSubscriptionUnitWithPercentPrice::UnitWithPercentConfig] Configuration for unit_with_percent pricing
      #
      ...
      # @see Orb::Models::NewSubscriptionUnitWithPercentPrice#unit_with_percent_config
