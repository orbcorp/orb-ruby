...
module Orb
  module Models
    ...
    class LicenseRetrieveByExternalIDResponse < Orb::Internal::Type::BaseModel
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::LicenseRetrieveByExternalIDResponse::Status]
      required :status, enum: -> { Orb::Models::LicenseRetrieveByExternalIDResponse::Status }
      ...
      #   @param status [Symbol, Orb::Models::LicenseRetrieveByExternalIDResponse::Status]
      #   @param subscription_id [String]

      # @see Orb::Models::LicenseRetrieveByExternalIDResponse#status
      module Status
