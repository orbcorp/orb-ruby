...
module Orb
  module Models
    class NewPlanThresholdTotalAmountPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewPlanThresholdTotalAmountPrice::ThresholdTotalAmountConfig]
      required :threshold_total_amount_config,
               -> { Orb::NewPlanThresholdTotalAmountPrice::ThresholdTotalAmountConfig }
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewPlanThresholdTotalAmountPrice::ModelType] The pricing model type
      #
      #   @param name [String] The name of the price.
      #
      #   @param threshold_total_amount_config [Orb::Models::NewPlanThresholdTotalAmountPrice::ThresholdTotalAmountConfig] Configuration for threshold_total_amount pricing
      #
      ...
      # @see Orb::Models::NewPlanThresholdTotalAmountPrice#threshold_total_amount_config
      class ThresholdTotalAmountConfig < Orb::Internal::Type::BaseModel
        # @!attribute consumption_table
        #   When the quantity consumed passes a provided threshold, the configured total
        #   will be charged
        #
        #   @return [Array<Orb::Models::NewPlanThresholdTotalAmountPrice::ThresholdTotalAmountConfig::ConsumptionTable>]
        required :consumption_table,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewPlanThresholdTotalAmountPrice::ThresholdTotalAmountConfig::ConsumptionTable] }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::NewPlanThresholdTotalAmountPrice::ThresholdTotalAmountConfig} for
        #   more details.
        #
        #   Configuration for threshold_total_amount pricing
        #
        #   @param consumption_table [Array<Orb::Models::NewPlanThresholdTotalAmountPrice::ThresholdTotalAmountConfig::ConsumptionTable>] When the quantity consumed passes a provided threshold, the configured total wil
        #
