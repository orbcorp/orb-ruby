...
module Orb
  module Models
    class SubscriptionModel < Orb::BaseModel
      ...
      required :discount_intervals, -> { Orb::ArrayOf[union: Orb::Models::SubscriptionModel::DiscountInterval] }
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::SubscriptionModel::Status]
      required :status, enum: -> { Orb::Models::SubscriptionModel::Status }
      ...
      #   # @param status [Symbol, Orb::Models::SubscriptionModel::Status]
