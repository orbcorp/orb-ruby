...
module Orb
  module Models
    ...
    class SubscriptionCreateResponse < Orb::Internal::Type::BaseModel
      ...
      #   # @param pending_subscription_change [Orb::Models::SubscriptionCreateResponse::PendingSubscriptionChange, nil]
      ...
      #   # @param changed_resources [Orb::Models::SubscriptionCreateResponse::ChangedResources, nil]
      #   #
      #   def initialize(
      #     id:,
