  ...
  module Models
    ...
    class SubscriptionCreateResponse < Orb::BaseModel
      ...
      required :adjustment_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionCreateResponse::AdjustmentInterval] }
      ...
      required :discount_intervals,
               -> { Orb::ArrayOf[union: Orb::Models::SubscriptionCreateResponse::DiscountInterval] }
      ...
      required :fixed_fee_quantity_schedule,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionCreateResponse::FixedFeeQuantitySchedule] }
      ...
      required :maximum_intervals,
               -> {
                 Orb::ArrayOf[Orb::Models::SubscriptionCreateResponse::MaximumInterval]
               }
      ...
      required :minimum_intervals,
               -> {
                 Orb::ArrayOf[Orb::Models::SubscriptionCreateResponse::MinimumInterval]
               }
      ...
      required :price_intervals, -> { Orb::ArrayOf[Orb::Models::SubscriptionCreateResponse::PriceInterval] }
      ...
      #   # @param adjustment_intervals [Array<Orb::Models::SubscriptionCreateResponse::AdjustmentInterval>]
      ...
      #   # @param discount_intervals [Array<Orb::Models::SubscriptionCreateResponse::DiscountInterval::AmountDiscountInterval, Orb::Models::SubscriptionCreateResponse::DiscountInterval::PercentageDiscountInterval, Orb::Models::SubscriptionCreateResponse::DiscountInterval::UsageDiscountInterval>]
      ...
      #   # @param maximum_intervals [Array<Orb::Models::SubscriptionCreateResponse::MaximumInterval>]
      #   # @param metadata [Hash{Symbol=>String}]
      #   # @param minimum_intervals [Array<Orb::Models::SubscriptionCreateResponse::MinimumInterval>]
      #   # @param net_terms [Integer]
      #   # @param plan [Orb::Models::Plan]
      #   # @param price_intervals [Array<Orb::Models::SubscriptionCreateResponse::PriceInterval>]
      ...
      class AdjustmentInterval < Orb::BaseModel
        ...
        #
        #   @return [Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MaximumAdjustment]
        required :adjustment,
        ...
        # @!parse
        #   # @param id [String]
        #   # @param adjustment [Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MaximumAdjustment]
        ...
        #   # Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment ...
        ...
        #   # Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment ...
        # in {adjustment_type: "usage_discount", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment ...
        # in {adjustment_type: "minimum", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MinimumAdjustment ...
        # in {adjustment_type: "maximum", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MaximumAdjustment ...
        # end
        # ```
        #
        # @example
        # ```ruby
        # case adjustment
        # in Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MinimumAdjustment
        #   # ...
        # in Orb::Models::SubscriptionCreateResponse::AdjustmentInterval::Adjustment::MaximumAdjustment
        #   # ...
        # end
        # ```
      ...
      class PriceInterval < Orb::BaseModel
        ...
        required :fixed_fee_quantity_transitions,
                 -> {
                   Orb::ArrayOf[Orb::Models::SubscriptionCreateResponse::PriceInterval::FixedFeeQuantityTransition]
                 },
                 nil?: true
