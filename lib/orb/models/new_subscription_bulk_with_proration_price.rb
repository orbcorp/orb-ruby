...
module Orb
  module Models
    class NewSubscriptionBulkWithProrationPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewSubscriptionBulkWithProrationPrice::BulkWithProrationConfig]
      ...
      #
      #   @param bulk_with_proration_config [Orb::Models::NewSubscriptionBulkWithProrationPrice::BulkWithProrationConfig] Configuration for bulk_with_proration pricing
      #
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewSubscriptionBulkWithProrationPrice::ModelType] The pricing model type
      #
      ...
      # @see Orb::Models::NewSubscriptionBulkWithProrationPrice#bulk_with_proration_config
      class BulkWithProrationConfig < Orb::Internal::Type::BaseModel
        # @!attribute tiers
        #   Bulk tiers for rating based on total usage volume
        #
        #   @return [Array<Orb::Models::NewSubscriptionBulkWithProrationPrice::BulkWithProrationConfig::Tier>]
        required :tiers,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewSubscriptionBulkWithProrationPrice::BulkWithProrationConfig::Tier] }

        # @!method initialize(tiers:)
        #   Configuration for bulk_with_proration pricing
        #
        #   @param tiers [Array<Orb::Models::NewSubscriptionBulkWithProrationPrice::BulkWithProrationConfig::Tier>] Bulk tiers for rating based on total usage volume
