      ...
      class Price < Orb::Internal::Type::BaseModel
        ...
        module Price
          ...
          class TieredMatrixWithAllocation < Orb::Internal::Type::BaseModel
            ...
            #   The cadence to bill for this price on.
            #
            #   @return [Symbol, Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::Cadence]
            required :cadence, enum: -> { Orb::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::Cadence }
            ...
            #
            #   @return [Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::TieredMatrixWithAllocationConfig]
            required :tiered_matrix_with_allocation_config,
                     -> { Orb::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::TieredMatrixWithAllocationConfig }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation} for
            #   more details.
            #
            #   @param cadence [Symbol, Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::Cadence] The cadence to bill for this price on.
            #
            #   @param item_id [String] The id of the item the price will be associated with.
            #
            #   @param name [String] The name of the price.
            #
            #   @param tiered_matrix_with_allocation_config [Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::TieredMatrixWithAllocationConfig] Configuration for tiered_matrix_with_allocation pricing
            #
            #   @param billable_metric_id [String, nil] The id of the billable metric for the price. Only needed if the price is usage-b
            #
            #   @param billed_in_advance [Boolean, nil] If the Price represents a fixed cost, the price will be billed in-advance if thi
            ...
            # The cadence to bill for this price on.
            #
            # @see Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation#cadence
            module Cadence
              extend Orb::Internal::Type::Enum
            ...
            # @see Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation#tiered_matrix_with_allocation_config
            class TieredMatrixWithAllocationConfig < Orb::Internal::Type::BaseModel
              ...
              #   own rows
              #
              #   @return [Array<Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::TieredMatrixWithAllocationConfig::Tier>]
              required :tiers,
                       -> { Orb::Internal::Type::ArrayOf[Orb::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::TieredMatrixWithAllocationConfig::Tier] }

              # @!method initialize(allocation:, default_unit_amount:, dimensions:, tiers:)
              #   Some parameter documentations has been truncated, see
              #   {Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::TieredMatrixWithAllocationConfig}
              #   for more details.
              #
              #   Configuration for tiered_matrix_with_allocation pricing
              #
              ...
              #
              #   @param tiers [Array<Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::TieredMatrixWithAllocationConfig::Tier>] Graduated tiers keyed by matrix cell; usage in a cell is tiered only against its
              ...
              class Tier < Orb::Internal::Type::BaseModel
                ...
                #   Some parameter documentations has been truncated, see
                #   {Orb::Models::PlanCreateParams::Price::Price::TieredMatrixWithAllocation::TieredMatrixWithAllocationConfig::Tier}
                #   for more details.
                #
