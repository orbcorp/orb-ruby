    ...
    class SubscriptionPriceIntervalsParams < Orb::Internal::Type::BaseModel
      ...
      class Add < Orb::Internal::Type::BaseModel
        ...
        module Price
          ...
          variant :minimum, -> { Orb::SubscriptionPriceIntervalsParams::Add::Price::Minimum }
          ...
          class CumulativeGroupedAllocation < Orb::Internal::Type::BaseModel
            ...
            #   The cadence to bill for this price on.
            #
            #   @return [Symbol, Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::CumulativeGroupedAllocation::Cadence]
            required :cadence,
                     enum: -> { Orb::SubscriptionPriceIntervalsParams::Add::Price::CumulativeGroupedAllocation::Cadence }

            # @!attribute cumulative_grouped_allocation_config
            #   Configuration for cumulative_grouped_allocation pricing
            #
            #   @return [Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::CumulativeGroupedAllocation::CumulativeGroupedAllocationConfig]
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::CumulativeGroupedAllocation}
            #   for more details.
            #
            #   @param cadence [Symbol, Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::CumulativeGroupedAllocation::Cadence] The cadence to bill for this price on.
            #
            #   @param cumulative_grouped_allocation_config [Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::CumulativeGroupedAllocation::CumulativeGroupedAllocationConfig] Configuration for cumulative_grouped_allocation pricing
            #
            #   @param currency [String] An ISO 4217 currency string for which this price is billed in.
            #
            #   @param item_id [String] The id of the item the price will be associated with.
            ...
            # The cadence to bill for this price on.
            #
            # @see Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::CumulativeGroupedAllocation#cadence
            module Cadence
              extend Orb::Internal::Type::Enum
            ...
            # @see Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::CumulativeGroupedAllocation#cumulative_grouped_allocation_config
          ...
          class Minimum < Orb::Internal::Type::BaseModel
            ...
            #   The cadence to bill for this price on.
            #
            #   @return [Symbol, Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::Minimum::Cadence]
            required :cadence, enum: -> { Orb::SubscriptionPriceIntervalsParams::Add::Price::Minimum::Cadence }
            ...
            #
            #   @return [Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::Minimum::MinimumConfig]
            required :minimum_config, -> { Orb::SubscriptionPriceIntervalsParams::Add::Price::Minimum::MinimumConfig }
            ...
            optional :conversion_rate_config,
                     union: -> {
                       Orb::SubscriptionPriceIntervalsParams::Add::Price::Minimum::ConversionRateConfig
                     },
                     nil?: true
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::Minimum} for more
            #   details.
            #
            ...
            #   @param item_id [String] The id of the item the price will be associated with.
            #
            #   @param minimum_config [Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::Minimum::MinimumConfig] Configuration for minimum pricing
            #
            #   @param name [String] The name of the price.
            #
            #   @param billable_metric_id [String, nil] The id of the billable metric for the price. Only needed if the price is usage-b
            ...
            # The cadence to bill for this price on.
            #
            # @see Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::Minimum#cadence
            module Cadence
              extend Orb::Internal::Type::Enum
            ...
            # @see Orb::Models::SubscriptionPriceIntervalsParams::Add::Price::Minimum#minimum_config
