...
module Orb
  module Models
    class MonetaryMaximumAdjustment < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Orb::Models::MonetaryMaximumAdjustment::Filter>]
      required :filters, -> { Orb::Internal::Type::ArrayOf[Orb::MonetaryMaximumAdjustment::Filter] }
      ...
      #
      #   @param filters [Array<Orb::Models::MonetaryMaximumAdjustment::Filter>] The filters that determine which prices to apply this adjustment to.
      #
      ...
      class Filter < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::MonetaryMaximumAdjustment::Filter::Field]
        required :field, enum: -> { Orb::MonetaryMaximumAdjustment::Filter::Field }

        # @!attribute operator
        #   Should prices that match the filter be included or excluded.
        #
        #   @return [Symbol, Orb::Models::MonetaryMaximumAdjustment::Filter::Operator]
        required :operator, enum: -> { Orb::MonetaryMaximumAdjustment::Filter::Operator }
        ...
        #   @param field [Symbol, Orb::Models::MonetaryMaximumAdjustment::Filter::Field] The property of the price to filter on.
        #
        #   @param operator [Symbol, Orb::Models::MonetaryMaximumAdjustment::Filter::Operator] Should prices that match the filter be included or excluded.
        #
        #   @param values [Array<String>] The IDs or values that match this filter.

        # The property of the price to filter on.
        #
        # @see Orb::Models::MonetaryMaximumAdjustment::Filter#field
        module Field
          extend Orb::Internal::Type::Enum
        ...
        # Should prices that match the filter be included or excluded.
        #
        # @see Orb::Models::MonetaryMaximumAdjustment::Filter#operator
        module Operator
          extend Orb::Internal::Type::Enum
