...
module Orb
  module Models
    class InvoiceEditedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::InvoiceEditedWebhookEvent::Properties]
      required :properties, -> { Orb::InvoiceEditedWebhookEvent::Properties }

      # @!attribute type
      #   The event this payload describes.
      #
      #   @return [Symbol, Orb::Models::InvoiceEditedWebhookEvent::Type]
      required :type, enum: -> { Orb::InvoiceEditedWebhookEvent::Type }

      # @!method initialize(id:, created_at:, invoice:, properties:, type:)
      #   Some parameter documentations has been truncated, see
      #   {Orb::Models::InvoiceEditedWebhookEvent} for more details.
      #
      ...
      #
      #   @param properties [Orb::Models::InvoiceEditedWebhookEvent::Properties]
      #
      #   @param type [Symbol, Orb::Models::InvoiceEditedWebhookEvent::Type] The event this payload describes.

      # @see Orb::Models::InvoiceEditedWebhookEvent#properties
      class Properties < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes]
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::InvoiceEditedWebhookEvent::Properties} for more details.
        #
        #   @param previous_attributes [Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes] `due_date` is an ISO-8601 string rather than a datetime: the untyped message cal

        # @see Orb::Models::InvoiceEditedWebhookEvent::Properties#previous_attributes
        class PreviousAttributes < Orb::Internal::Type::BaseModel
          ...
          # @!attribute discounts
          #
          #   @return [Array<Orb::Models::PercentageDiscount, Orb::Models::AmountDiscount, Orb::Models::TrialDiscount, Orb::Models::InvoiceLevelDiscount::TieredPercentage>, nil]
          optional :discounts,
                   -> {
          ...
          #
          #   @return [Array<Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem>, nil]
          optional :line_items,
                   -> {
          ...
          # @!method initialize(amount_due: nil, discounts: nil, due_date: nil, line_items: nil, maximum: nil, metadata: nil, minimum: nil, net_terms: nil, subtotal: nil, total: nil)
          #   `due_date` is an ISO-8601 string rather than a datetime: the untyped message
          #   called `.isoformat()` on it, so it keeps microseconds where the webhook JSON
          #   provider would have truncated them.
          #
          #   @param amount_due [String, nil]
          #   @param discounts [Array<Orb::Models::PercentageDiscount, Orb::Models::AmountDiscount, Orb::Models::TrialDiscount, Orb::Models::InvoiceLevelDiscount::TieredPercentage>, nil]
          #   @param due_date [String, nil]
          #   @param line_items [Array<Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem>, nil]
          ...
          class LineItem < Orb::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Orb::Models::MonetaryUsageDiscountAdjustment, Orb::Models::MonetaryAmountDiscountAdjustment, Orb::Models::MonetaryPercentageDiscountAdjustment, Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount, Orb::Models::MonetaryMinimumAdjustment, Orb::Models::MonetaryMaximumAdjustment>]
            required :adjustments,
                     -> { Orb::Internal::Type::ArrayOf[union: Orb::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment] }
            ...
            required :sub_line_items,
                     -> { Orb::Internal::Type::ArrayOf[union: Orb::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::SubLineItem] }
            ...
            #
            #   @param adjustments [Array<Orb::Models::MonetaryUsageDiscountAdjustment, Orb::Models::MonetaryAmountDiscountAdjustment, Orb::Models::MonetaryPercentageDiscountAdjustment, Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount, Orb::Models::MonetaryMinimumAdjustment, Orb::Models::MonetaryMaximumAdjustment>] All adjustments applied to the line item in the order they were applied based on
            #
            ...
            module Adjustment
              ...
              class TieredPercentageDiscount < Orb::Internal::Type::BaseModel
                ...
                #
                #   @return [Array<Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter>]
                required :filters,
                         -> do
                ...
                #
                #   @return [Array<Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Tier>]
                required :tiers,
                         -> do
                           Orb::Internal::Type::ArrayOf[
                ...
                #   Some parameter documentations has been truncated, see
                #   {Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount}
                #   for more details.
                #
                #   @param id [String]
                #
                ...
                #
                #   @param filters [Array<Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter>] The filters that determine which prices to apply this adjustment to.
                #
                ...
                #
                #   @param tiers [Array<Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Tier>] The ordered, contiguous bands of cumulative eligible spend, each discounted at i
                #
                ...
                class Filter < Orb::Internal::Type::BaseModel
                  ...
                  #
                  #   @return [Symbol, Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter::Field]
                  required :field,
                           enum: -> { Orb::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter::Field }

                  # @!attribute operator
                  #   Should prices that match the filter be included or excluded.
                  #
                  #   @return [Symbol, Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter::Operator]
                  required :operator,
                           enum: -> { Orb::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter::Operator }
                  ...
                  #   @param field [Symbol, Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter::Field] The property of the price to filter on.
                  #
                  #   @param operator [Symbol, Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter::Operator] Should prices that match the filter be included or excluded.
                  #
                  #   @param values [Array<String>] The IDs or values that match this filter.

                  # The property of the price to filter on.
                  #
                  # @see Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter#field
                  module Field
                  ...
                  # Should prices that match the filter be included or excluded.
                  #
                  # @see Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Filter#operator
                  module Operator
                    extend Orb::Internal::Type::Enum
                ...
                class Tier < Orb::Internal::Type::BaseModel
                  ...
                  #   Some parameter documentations has been truncated, see
                  #   {Orb::Models::InvoiceEditedWebhookEvent::Properties::PreviousAttributes::LineItem::Adjustment::TieredPercentageDiscount::Tier}
                  #   for more details.
                  #
      ...
      # The event this payload describes.
      #
      # @see Orb::Models::InvoiceEditedWebhookEvent#type
      module Type
        extend Orb::Internal::Type::Enum
