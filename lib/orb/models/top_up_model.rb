...
module Orb
  module Models
    class TopUpModel < Orb::BaseModel
      ...
      #
      #   @return [Orb::Models::TopUpModel::InvoiceSettings]
      ...
      #
      #   @return [Symbol, Orb::Models::TopUpModel::ExpiresAfterUnit, nil]
      optional :expires_after_unit, enum: -> { Orb::Models::TopUpModel::ExpiresAfterUnit }, nil?: true

      # @!parse
      #   # @param id [String]
      #   # @param amount [String]
      #   # @param currency [String]
      #   # @param invoice_settings [Orb::Models::TopUpModel::InvoiceSettings]
      #   # @param per_unit_cost_basis [String]
      #   # @param threshold [String]
      #   # @param expires_after [Integer, nil]
      #   # @param expires_after_unit [Symbol, Orb::Models::TopUpModel::ExpiresAfterUnit, nil]
      #   #
      #   def initialize(
      #     id:,
      #     amount:,
