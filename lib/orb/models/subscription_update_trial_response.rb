...
module Orb
  module Models
    ...
    #   adjustment_intervals: -> { Orb::ArrayOf[Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval] === _1 },
    ...
    class SubscriptionUpdateTrialResponse < Orb::BaseModel
      ...
      required :adjustment_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval] }
      ...
      required :discount_intervals,
               -> { Orb::ArrayOf[union: Orb::Models::SubscriptionUpdateTrialResponse::DiscountInterval] }
      ...
      required :fixed_fee_quantity_schedule,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUpdateTrialResponse::FixedFeeQuantitySchedule] }
      ...
      required :maximum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUpdateTrialResponse::MaximumInterval] }
      ...
      required :minimum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUpdateTrialResponse::MinimumInterval] }
      ...
      # adjustment_interval => {
      #   id: String,
      #   adjustment: Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment,
      ...
      class AdjustmentInterval < Orb::BaseModel
        ...
        # @!parse
        #   # @param id [String]
        #   # @param adjustment [Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::MaximumAdjustment]
        ...
        # ```ruby
        # case adjustment
        # in Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::MinimumAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUpdateTrialResponse::AdjustmentInterval::Adjustment::MaximumAdjustment
        #   # ...
        # end
        # ```
      ...
      # ```ruby
      # case discount_interval
      # in Orb::Models::SubscriptionUpdateTrialResponse::DiscountInterval::AmountDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionUpdateTrialResponse::DiscountInterval::PercentageDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionUpdateTrialResponse::DiscountInterval::UsageDiscountInterval
      #   # ...
      # end
      # ```
