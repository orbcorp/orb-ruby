...
module Orb
  module Models
    class PaymentMethodCreatedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::PaymentMethodCreatedWebhookEvent::PaymentMethod]
      required :payment_method, -> { Orb::PaymentMethodCreatedWebhookEvent::PaymentMethod }
      ...
      #
      #   @return [Symbol, Orb::Models::PaymentMethodCreatedWebhookEvent::Type]
      required :type, enum: -> { Orb::PaymentMethodCreatedWebhookEvent::Type }

      # @!method initialize(id:, created_at:, payment_method:, properties:, type:)
      #   Some parameter documentations has been truncated, see
      #   {Orb::Models::PaymentMethodCreatedWebhookEvent} for more details.
      #
      ...
      #
      #   @param payment_method [Orb::Models::PaymentMethodCreatedWebhookEvent::PaymentMethod] A payment method represents a customer's stored payment instrument held with an
      #
      #   @param properties [Object]
      #
      #   @param type [Symbol, Orb::Models::PaymentMethodCreatedWebhookEvent::Type] The event this payload describes.

      # @see Orb::Models::PaymentMethodCreatedWebhookEvent#payment_method
      class PaymentMethod < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::PaymentMethodCreatedWebhookEvent::PaymentMethod::PaymentMethodType]
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::PaymentMethodCreatedWebhookEvent::PaymentMethod} for more details.
        #
        #   A payment method represents a customer's stored payment instrument held with an
        #   external payment provider (such as Adyen or Stripe).
        #
        ...
        #
        #   @param payment_method_type [Symbol, Orb::Models::PaymentMethodCreatedWebhookEvent::PaymentMethod::PaymentMethodType] The type of the underlying payment instrument, e.g. `card` or `us_bank_account`.
        #
        #   @param provider_type [String, nil] The external payment provider this method belongs to, derived from the linked pa

        # The type of the underlying payment instrument, e.g. `card` or `us_bank_account`.
        #
        # @see Orb::Models::PaymentMethodCreatedWebhookEvent::PaymentMethod#payment_method_type
      ...
      # The event this payload describes.
      #
      # @see Orb::Models::PaymentMethodCreatedWebhookEvent#type
      module Type
        extend Orb::Internal::Type::Enum
