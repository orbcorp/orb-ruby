...
module Orb
  module Models
    class PlanPhaseAmountDiscountAdjustment < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Orb::Models::PlanPhaseAmountDiscountAdjustment::Filter>]
      ...
      #
      #   @param filters [Array<Orb::Models::PlanPhaseAmountDiscountAdjustment::Filter>] The filters that determine which prices to apply this adjustment to.
      #
      ...
      class Filter < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::PlanPhaseAmountDiscountAdjustment::Filter::Field]
        required :field, enum: -> { Orb::PlanPhaseAmountDiscountAdjustment::Filter::Field }

        # @!attribute operator
        #   Should prices that match the filter be included or excluded.
        #
        #   @return [Symbol, Orb::Models::PlanPhaseAmountDiscountAdjustment::Filter::Operator]
        required :operator, enum: -> { Orb::PlanPhaseAmountDiscountAdjustment::Filter::Operator }
        ...
        #   @param field [Symbol, Orb::Models::PlanPhaseAmountDiscountAdjustment::Filter::Field] The property of the price to filter on.
        #
        #   @param operator [Symbol, Orb::Models::PlanPhaseAmountDiscountAdjustment::Filter::Operator] Should prices that match the filter be included or excluded.
        #
        #   @param values [Array<String>] The IDs or values that match this filter.

        # The property of the price to filter on.
        #
        # @see Orb::Models::PlanPhaseAmountDiscountAdjustment::Filter#field
        module Field
          extend Orb::Internal::Type::Enum
        ...
        # Should prices that match the filter be included or excluded.
        #
        # @see Orb::Models::PlanPhaseAmountDiscountAdjustment::Filter#operator
        module Operator
          extend Orb::Internal::Type::Enum
