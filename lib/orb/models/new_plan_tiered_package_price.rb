...
module Orb
  module Models
    class NewPlanTieredPackagePrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewPlanTieredPackagePrice::TieredPackageConfig]
      required :tiered_package_config, -> { Orb::NewPlanTieredPackagePrice::TieredPackageConfig }
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewPlanTieredPackagePrice::ModelType] The pricing model type
      #
      #   @param name [String] The name of the price.
      #
      #   @param tiered_package_config [Orb::Models::NewPlanTieredPackagePrice::TieredPackageConfig] Configuration for tiered_package pricing
      #
      ...
      # @see Orb::Models::NewPlanTieredPackagePrice#tiered_package_config
      class TieredPackageConfig < Orb::Internal::Type::BaseModel
        ...
        required :tiers,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewPlanTieredPackagePrice::TieredPackageConfig::Tier] }

        # @!method initialize(package_size:, tiers:)
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::NewPlanTieredPackagePrice::TieredPackageConfig} for more details.
        #
        #   Configuration for tiered_package pricing
        #
        #   @param package_size [String]
        #
        #   @param tiers [Array<Orb::Models::NewPlanTieredPackagePrice::TieredPackageConfig::Tier>] Apply tiered pricing after rounding up the quantity to the package size. Tiers a
