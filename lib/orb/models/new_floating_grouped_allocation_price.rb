...
module Orb
  module Models
    class NewFloatingGroupedAllocationPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewFloatingGroupedAllocationPrice::GroupedAllocationConfig]
      required :grouped_allocation_config,
               -> { Orb::NewFloatingGroupedAllocationPrice::GroupedAllocationConfig }
      ...
      #
      #   @param grouped_allocation_config [Orb::Models::NewFloatingGroupedAllocationPrice::GroupedAllocationConfig] Configuration for grouped_allocation pricing
      #
      #   @param item_id [String] The id of the item the price will be associated with.
      #
      #   @param model_type [Symbol, Orb::Models::NewFloatingGroupedAllocationPrice::ModelType] The pricing model type
      #
      ...
      # @see Orb::Models::NewFloatingGroupedAllocationPrice#grouped_allocation_config
