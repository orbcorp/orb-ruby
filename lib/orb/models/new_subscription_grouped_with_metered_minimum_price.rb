...
module Orb
  module Models
    class NewSubscriptionGroupedWithMeteredMinimumPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered, nil]
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      module ConversionRateConfig
        ...
        variant :unit, -> { Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit }

        variant :tiered,
                -> {
                  Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered
                }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit::UnitConfig]
          required :unit_config,
                   -> {
                     Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit::UnitConfig
                   }

          # @!method initialize(unit_config:, conversion_rate_type: :unit)
          #   @param unit_config [Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig]
          required :tiered_config,
                   -> {
                     Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig
                   }

          # @!method initialize(tiered_config:, conversion_rate_type: :tiered)
          #   @param tiered_config [Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionGroupedWithMeteredMinimumPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
