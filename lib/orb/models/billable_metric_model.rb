...
module Orb
  module Models
    class BillableMetricModel < Orb::BaseModel
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::BillableMetricModel::Status]
      required :status, enum: -> { Orb::Models::BillableMetricModel::Status }
      ...
      #   # @param name [String]
      #   # @param status [Symbol, Orb::Models::BillableMetricModel::Status]
      #   #
