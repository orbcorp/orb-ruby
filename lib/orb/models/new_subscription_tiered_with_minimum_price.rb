...
module Orb
  module Models
    class NewSubscriptionTieredWithMinimumPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered, nil]
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      # The configuration for the rate of the price currency to the invoicing currency.
      #
      # @see Orb::Models::NewSubscriptionTieredWithMinimumPrice#conversion_rate_config
      module ConversionRateConfig
        extend Orb::Internal::Type::Union

        discriminator :conversion_rate_type

        variant :unit, -> { Orb::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Unit }

        variant :tiered, -> { Orb::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Unit::UnitConfig]
          required :unit_config,
                   -> { Orb::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Unit::UnitConfig }

          # @!method initialize(unit_config:, conversion_rate_type: :unit)
          #   @param unit_config [Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig]
          required :tiered_config,
                   -> {
                     Orb::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig
                   }

          # @!method initialize(tiered_config:, conversion_rate_type: :tiered)
          #   @param tiered_config [Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Unit, Orb::Models::NewSubscriptionTieredWithMinimumPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
