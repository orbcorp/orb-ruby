...
module Orb
  module Models
    class SubscriptionSpendExceededWebhookEvent < Orb::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties]
      required :properties, -> { Orb::SubscriptionSpendExceededWebhookEvent::Properties }
      ...
      #
      #   @return [Symbol, Orb::Models::SubscriptionSpendExceededWebhookEvent::Type]
      required :type, enum: -> { Orb::SubscriptionSpendExceededWebhookEvent::Type }

      # @!method initialize(id:, created_at:, properties:, subscription:, type:)
      #   Some parameter documentations has been truncated, see
      #   {Orb::Models::SubscriptionSpendExceededWebhookEvent} for more details.
      #
      ...
      #
      #   @param properties [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties]
      #
      #   @param subscription [Orb::Models::Subscription] A [subscription](/core-concepts#subscription) represents the purchase of a plan
      #
      #   @param type [Symbol, Orb::Models::SubscriptionSpendExceededWebhookEvent::Type] The event this payload describes.

      # @see Orb::Models::SubscriptionSpendExceededWebhookEvent#properties
      class Properties < Orb::Internal::Type::BaseModel
        ...
        #   subscriptions.
        #
        #   @return [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration]
        required :alert_configuration,
                 -> { Orb::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties} for more
        #   details.
        #
        #   @param alert_configuration [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration] [Alerts within Orb](/product-catalog/configuring-alerts) monitor spending,
        #
        ...
        # @see Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties#alert_configuration
        class AlertConfiguration < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Metric, nil]
          required :metric,
          ...
          #
          #   @return [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Plan, nil]
          required :plan,
          ...
          #   triggered.
          #
          #   @return [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Threshold>, nil]
          required :thresholds,
                   -> {
          ...
          #
          #   @return [Symbol, Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Type]
          required :type,
          ...
          #   alerts.
          #
          #   @return [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::BalanceAlertStatus>, nil]
          ...
          #
          #   @return [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::LicenseType, nil]
          ...
          #
          #   @return [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter>, nil]
          ...
          #
          #   @return [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride>, nil]
          ...
          #   Some parameter documentations has been truncated, see
          #   {Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration}
          #   for more details.
          #
          #   [Alerts within Orb](/product-catalog/configuring-alerts) monitor spending,
          #   usage, or credit balance and trigger webhooks when a threshold is exceeded.
          ...
          #
          #   @param metric [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Metric, nil] The metric the alert applies to.
          #
          #   @param plan [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Plan, nil] The plan the alert applies to.
          #
          #   @param subscription [Orb::Models::SubscriptionMinified, nil] The subscription the alert applies to.
          #
          #   @param thresholds [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Threshold>, nil] The thresholds that define the conditions under which the alert will be triggere
          #
          #   @param type [Symbol, Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Type] The type of alert. This must be a valid alert type.
          #
          #   @param balance_alert_status [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::BalanceAlertStatus>, nil] The current status of the alert. This field is only present for credit balance a
          #
          #   @param grouping_keys [Array<String>, nil] The property keys to group cost alerts by. Only present for cost alerts with gro
          #
          #   @param license_type [Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::LicenseType, nil] Minified license type for alert serialization.
          #
          #   @param price_filters [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter>, nil] Filters scoping which prices are included in spend and grouped cost alert evalua
          #
          #   @param threshold_overrides [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride>, nil] Per-group threshold overrides. Each override maps a specific combination of grou

          # @see Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration#metric
          ...
          # @see Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration#plan
          class Plan < Orb::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Plan}
            #   for more details.
            #
            #   The plan the alert applies to.
            #
          ...
          class Threshold < Orb::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::Threshold}
            #   for more details.
            #
          ...
          # The type of alert. This must be a valid alert type.
          #
          # @see Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration#type
          module Type
          ...
          # @see Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration#license_type
          ...
          class PriceFilter < Orb::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field]
            required :field,
                     enum: -> { Orb::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field }

            # @!attribute operator
            #   Should prices that match the filter be included or excluded.
            #
            #   @return [Symbol, Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator]
            required :operator,
                     enum: -> { Orb::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator }
            ...
            #   @param field [Symbol, Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Field] The property of the price to filter on.
            #
            #   @param operator [Symbol, Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter::Operator] Should prices that match the filter be included or excluded.
            #
            #   @param values [Array<String>] The IDs or values that match this filter.

            # The property of the price to filter on.
            #
            # @see Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter#field
            module Field
              extend Orb::Internal::Type::Enum
            ...
            # Should prices that match the filter be included or excluded.
            #
            # @see Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::PriceFilter#operator
            module Operator
              extend Orb::Internal::Type::Enum
          ...
          class ThresholdOverride < Orb::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::Threshold>]
            required :thresholds,
                     -> { Orb::Internal::Type::ArrayOf[Orb::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::Threshold] }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride}
            #   for more details.
            #
            ...
            #
            #   @param thresholds [Array<Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::Threshold>] The thresholds applied to this group. An empty list means the group is silenced.
            #
            ...
            class Threshold < Orb::Internal::Type::BaseModel
              ...
              # @!method initialize(value:)
              #   Some parameter documentations has been truncated, see
              #   {Orb::Models::SubscriptionSpendExceededWebhookEvent::Properties::AlertConfiguration::ThresholdOverride::Threshold}
              #   for more details.
              #
              #   Thresholds are used to define the conditions under which an alert will be
              #   triggered.
      ...
      # The event this payload describes.
      #
      # @see Orb::Models::SubscriptionSpendExceededWebhookEvent#type
      module Type
        extend Orb::Internal::Type::Enum

        SUBSCRIPTION_SPEND_EXCEEDED = :"subscription.spend_exceeded"
