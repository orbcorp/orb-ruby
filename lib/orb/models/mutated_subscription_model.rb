...
module Orb
  module Models
    class MutatedSubscriptionModel < Orb::BaseModel
      # @!attribute id
      #
      #   @return [String]
      required :id, String
      ...
      required :discount_intervals,
               -> { Orb::ArrayOf[union: Orb::Models::MutatedSubscriptionModel::DiscountInterval] }
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::MutatedSubscriptionModel::Status]
      required :status, enum: -> { Orb::Models::MutatedSubscriptionModel::Status }
      ...
      #   # @param status [Symbol, Orb::Models::MutatedSubscriptionModel::Status]
