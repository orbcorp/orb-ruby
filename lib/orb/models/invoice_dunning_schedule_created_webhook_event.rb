...
module Orb
  module Models
    class InvoiceDunningScheduleCreatedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent::Properties]
      required :properties, -> { Orb::InvoiceDunningScheduleCreatedWebhookEvent::Properties }

      # @!attribute type
      #   The event this payload describes.
      #
      #   @return [Symbol, Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent::Type]
      required :type, enum: -> { Orb::InvoiceDunningScheduleCreatedWebhookEvent::Type }

      # @!method initialize(id:, created_at:, invoice:, properties:, type:)
      #   Some parameter documentations has been truncated, see
      #   {Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent} for more details.
      #
      ...
      #
      #   @param properties [Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent::Properties]
      #
      #   @param type [Symbol, Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent::Type] The event this payload describes.

      # @see Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent#properties
      class Properties < Orb::Internal::Type::BaseModel
        # @!attribute dunning_schedule
        #
        #   @return [Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent::Properties::DunningSchedule]
        required :dunning_schedule,
                 -> { Orb::InvoiceDunningScheduleCreatedWebhookEvent::Properties::DunningSchedule }

        # @!attribute dunning_steps
        #
        #   @return [Array<Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent::Properties::DunningStep>]
        required :dunning_steps,
                 -> { Orb::Internal::Type::ArrayOf[Orb::InvoiceDunningScheduleCreatedWebhookEvent::Properties::DunningStep] }
        ...
        # @!method initialize(dunning_schedule:, dunning_steps:, source:)
        #   @param dunning_schedule [Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent::Properties::DunningSchedule]
        #   @param dunning_steps [Array<Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent::Properties::DunningStep>]
        #   @param source [String]

        # @see Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent::Properties#dunning_schedule
      ...
      # The event this payload describes.
      #
      # @see Orb::Models::InvoiceDunningScheduleCreatedWebhookEvent#type
      module Type
        extend Orb::Internal::Type::Enum

        INVOICE_DUNNING_SCHEDULE_CREATED = :"invoice.dunning_schedule_created"
