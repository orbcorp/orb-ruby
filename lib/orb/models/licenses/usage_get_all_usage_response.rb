  ...
  module Models
    module Licenses
      ...
      class UsageGetAllUsageResponse < Orb::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Orb::Models::Licenses::UsageGetAllUsageResponse::Data>]
        required :data, -> { Orb::Internal::Type::ArrayOf[Orb::Models::Licenses::UsageGetAllUsageResponse::Data] }
        ...
        #   @param data [Array<Orb::Models::Licenses::UsageGetAllUsageResponse::Data>]
