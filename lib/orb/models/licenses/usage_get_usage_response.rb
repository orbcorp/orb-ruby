...
module Orb
  module Models
    module Licenses
      ...
      class UsageGetUsageResponse < Orb::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Orb::Models::Licenses::UsageGetUsageResponse::Data>]
        required :data, -> { Orb::Internal::Type::ArrayOf[Orb::Models::Licenses::UsageGetUsageResponse::Data] }
        ...
        #   @param data [Array<Orb::Models::Licenses::UsageGetUsageResponse::Data>]
        ...
        class Data < Orb::Internal::Type::BaseModel
          ...
          #   {Orb::Models::Licenses::UsageGetUsageResponse::Data} for more details.
          #
