    ...
    class PriceEvaluatePreviewEventsParams < Orb::Internal::Type::BaseModel
      ...
      class PriceEvaluation < Orb::Internal::Type::BaseModel
        ...
        module Price
          ...
          variant :minimum, -> { Orb::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::Minimum }
          ...
          class BulkWithFilters < Orb::Internal::Type::BaseModel
            ...
            #
            #   @return [Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters::BulkWithFiltersConfig]
            ...
            #
            #   @return [Symbol, Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters::Cadence]
            required :cadence,
                     enum: -> { Orb::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters::Cadence }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters}
            #   for more details.
            #
            #   @param bulk_with_filters_config [Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters::BulkWithFiltersConfig] Configuration for bulk_with_filters pricing
            #
            #   @param cadence [Symbol, Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters::Cadence] The cadence to bill for this price on.
            #
            ...
            # @see Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters#bulk_with_filters_config
            class BulkWithFiltersConfig < Orb::Internal::Type::BaseModel
              # @!attribute filters
              #   Property filters to apply (all must match)
              #
              #   @return [Array<Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters::BulkWithFiltersConfig::Filter>]
              required :filters,
                       -> do
              ...
              #
              #   @return [Array<Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters::BulkWithFiltersConfig::Tier>]
              required :tiers,
                       -> do
                         Orb::Internal::Type::ArrayOf[
              ...
              #   Configuration for bulk_with_filters pricing
              #
              #   @param filters [Array<Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters::BulkWithFiltersConfig::Filter>] Property filters to apply (all must match)
              #
              #   @param tiers [Array<Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters::BulkWithFiltersConfig::Tier>] Bulk tiers for rating based on total usage volume
            ...
            # The cadence to bill for this price on.
            #
            # @see Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::BulkWithFilters#cadence
            module Cadence
          ...
          class CumulativeGroupedAllocation < Orb::Internal::Type::BaseModel
            ...
            #   The cadence to bill for this price on.
            #
            #   @return [Symbol, Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::CumulativeGroupedAllocation::Cadence]
            required :cadence,
                     enum: -> { Orb::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::CumulativeGroupedAllocation::Cadence }

            # @!attribute cumulative_grouped_allocation_config
            #   Configuration for cumulative_grouped_allocation pricing
            #
            #   @return [Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::CumulativeGroupedAllocation::CumulativeGroupedAllocationConfig]
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::CumulativeGroupedAllocation}
            #   for more details.
            #
            #   @param cadence [Symbol, Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::CumulativeGroupedAllocation::Cadence] The cadence to bill for this price on.
            #
            #   @param cumulative_grouped_allocation_config [Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::CumulativeGroupedAllocation::CumulativeGroupedAllocationConfig] Configuration for cumulative_grouped_allocation pricing
            #
            #   @param currency [String] An ISO 4217 currency string for which this price is billed in.
            #
            #   @param item_id [String] The id of the item the price will be associated with.
            ...
            # The cadence to bill for this price on.
            #
            # @see Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::CumulativeGroupedAllocation#cadence
            module Cadence
              extend Orb::Internal::Type::Enum
            ...
            # @see Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::CumulativeGroupedAllocation#cumulative_grouped_allocation_config
          ...
          class Minimum < Orb::Internal::Type::BaseModel
            ...
            #   The cadence to bill for this price on.
            #
            #   @return [Symbol, Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::Minimum::Cadence]
            required :cadence,
                     enum: -> { Orb::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::Minimum::Cadence }
            ...
            #
            #   @return [Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::Minimum::MinimumConfig]
            ...
            optional :conversion_rate_config,
                     union: -> {
                       Orb::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::Minimum::ConversionRateConfig
                     },
                     nil?: true
            ...
            # @!method initialize(cadence:, currency:, item_id:, minimum_config:, name:, billable_metric_id: nil, billed_in_advance: nil, billing_cycle_configuration: nil, conversion_rate: nil, conversion_rate_config: nil, dimensional_price_configuration: nil, external_price_id: nil, fixed_price_quantity: nil, invoice_grouping_key: nil, invoicing_cycle_configuration: nil, metadata: nil, model_type: :minimum)
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::Minimum}
            #   for more details.
            #
            ...
            #   @param item_id [String] The id of the item the price will be associated with.
            #
            #   @param minimum_config [Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::Minimum::MinimumConfig] Configuration for minimum pricing
            #
            #   @param name [String] The name of the price.
            #
            #   @param billable_metric_id [String, nil] The id of the billable metric for the price. Only needed if the price is usage-b
            ...
            # The cadence to bill for this price on.
            #
            # @see Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::Minimum#cadence
            module Cadence
              extend Orb::Internal::Type::Enum
            ...
            # @see Orb::Models::PriceEvaluatePreviewEventsParams::PriceEvaluation::Price::Minimum#minimum_config
