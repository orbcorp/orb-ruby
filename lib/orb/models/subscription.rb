...
module Orb
  module Models
    ...
    #   adjustment_intervals: -> { Orb::ArrayOf[Orb::Models::Subscription::AdjustmentInterval] === _1 },
    ...
    class Subscription < Orb::BaseModel
      ...
      required :fixed_fee_quantity_schedule,
               -> { Orb::ArrayOf[Orb::Models::Subscription::FixedFeeQuantitySchedule] }
      ...
      required :price_intervals, -> { Orb::ArrayOf[Orb::Models::Subscription::PriceInterval] }

      # @!attribute redeemed_coupon
      #
      #   @return [Orb::Models::Subscription::RedeemedCoupon, nil]
      required :redeemed_coupon, -> { Orb::Models::Subscription::RedeemedCoupon }, nil?: true
      ...
      # adjustment_interval => {
      #   id: String,
      #   adjustment: Orb::Models::Subscription::AdjustmentInterval::Adjustment,
      ...
      class AdjustmentInterval < Orb::BaseModel
        ...
        #
        #   @return [Orb::Models::Subscription::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::Subscription::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::Subscription::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::Subscription::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::Subscription::AdjustmentInterval::Adjustment::MaximumAdjustment]
        ...
        # @!parse
        #   # @param id [String]
        #   # @param adjustment [Orb::Models::Subscription::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::Subscription::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::Subscription::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::Subscription::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::Subscription::AdjustmentInterval::Adjustment::MaximumAdjustment]
        ...
        # ```ruby
        # case adjustment
        # in Orb::Models::Subscription::AdjustmentInterval::Adjustment::AmountDiscountAdjustment
        #   # ...
        # in Orb::Models::Subscription::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment
        #   # ...
        # in Orb::Models::Subscription::AdjustmentInterval::Adjustment::UsageDiscountAdjustment
        #   # ...
        # in Orb::Models::Subscription::AdjustmentInterval::Adjustment::MinimumAdjustment
        #   # ...
        # in Orb::Models::Subscription::AdjustmentInterval::Adjustment::MaximumAdjustment
        #   # ...
        # end
        # ```
      ...
      # ```ruby
      # case discount_interval
      # in Orb::Models::Subscription::DiscountInterval::AmountDiscountInterval
      #   # ...
      # in Orb::Models::Subscription::DiscountInterval::PercentageDiscountInterval
      #   # ...
      # in Orb::Models::Subscription::DiscountInterval::UsageDiscountInterval
      #   # ...
      # end
      # ```
      ...
      class PriceInterval < Orb::BaseModel
        ...
        required :fixed_fee_quantity_transitions,
                 -> { Orb::ArrayOf[Orb::Models::Subscription::PriceInterval::FixedFeeQuantityTransition] },
                 nil?: true
