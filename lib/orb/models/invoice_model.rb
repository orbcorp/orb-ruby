...
module Orb
  module Models
    class InvoiceModel < Orb::BaseModel
      # @!attribute id
      #
      #   @return [String]
      required :id, String
      ...
      #
      #   @return [Symbol, Orb::Models::InvoiceModel::InvoiceSource]
      required :invoice_source, enum: -> { Orb::Models::InvoiceModel::InvoiceSource }
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::InvoiceModel::Status]
      required :status, enum: -> { Orb::Models::InvoiceModel::Status }
      ...
      #   # @param invoice_source [Symbol, Orb::Models::InvoiceModel::InvoiceSource]
      ...
      #   # @param status [Symbol, Orb::Models::InvoiceModel::Status]
