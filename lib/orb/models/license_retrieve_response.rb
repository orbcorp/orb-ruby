...
module Orb
  module Models
    ...
    class LicenseRetrieveResponse < Orb::Internal::Type::BaseModel
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::LicenseRetrieveResponse::Status]
      required :status, enum: -> { Orb::Models::LicenseRetrieveResponse::Status }
      ...
      #   @param status [Symbol, Orb::Models::LicenseRetrieveResponse::Status]
      #   @param subscription_id [String]

      # @see Orb::Models::LicenseRetrieveResponse#status
      module Status
