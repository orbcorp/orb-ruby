...
module Orb
  module Models
    class NewPlanMinimumCompositePrice < Orb::Internal::Type::BaseModel
      # @!attribute cadence
      #   The cadence to bill for this price on.
      #
      #   @return [Symbol, Orb::Models::NewPlanMinimumCompositePrice::Cadence]
      required :cadence, enum: -> { Orb::NewPlanMinimumCompositePrice::Cadence }
      ...
      #
      #   @return [Orb::Models::NewPlanMinimumCompositePrice::MinimumCompositeConfig]
      required :minimum_composite_config, -> { Orb::NewPlanMinimumCompositePrice::MinimumCompositeConfig }

      # @!attribute model_type
      #   The pricing model type
      #
      #   @return [Symbol, Orb::Models::NewPlanMinimumCompositePrice::ModelType]
      required :model_type, enum: -> { Orb::NewPlanMinimumCompositePrice::ModelType }
      ...
      optional :conversion_rate_config,
               union: -> { Orb::NewPlanMinimumCompositePrice::ConversionRateConfig },
               nil?: true
      ...
      #
      #   @param minimum_composite_config [Orb::Models::NewPlanMinimumCompositePrice::MinimumCompositeConfig] Configuration for minimum_composite pricing
      #
      #   @param model_type [Symbol, Orb::Models::NewPlanMinimumCompositePrice::ModelType] The pricing model type
      #
      ...
      # The cadence to bill for this price on.
      #
      # @see Orb::Models::NewPlanMinimumCompositePrice#cadence
      module Cadence
      ...
      # @see Orb::Models::NewPlanMinimumCompositePrice#minimum_composite_config
      ...
      # The pricing model type
      #
      # @see Orb::Models::NewPlanMinimumCompositePrice#model_type
      module ModelType
        extend Orb::Internal::Type::Enum
