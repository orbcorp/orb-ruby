  ...
  module Models
    class NewSubscriptionTieredPackagePrice < Orb::Internal::Type::BaseModel
      ...
      optional :conversion_rate_config,
               union: -> { Orb::NewSubscriptionTieredPackagePrice::UnnamedTypeWithobjectParent74 },
               nil?: true
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewSubscriptionTieredPackagePrice::ModelType]
      #
