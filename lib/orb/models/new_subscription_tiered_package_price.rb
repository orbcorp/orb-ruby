...
module Orb
  module Models
    class NewSubscriptionTieredPackagePrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::NewSubscriptionTieredPackagePrice::Cadence]
      required :cadence, enum: -> { Orb::NewSubscriptionTieredPackagePrice::Cadence }
      ...
      #
      #   @return [Symbol, Orb::Models::NewSubscriptionTieredPackagePrice::ModelType]
      required :model_type, enum: -> { Orb::NewSubscriptionTieredPackagePrice::ModelType }
      ...
      #
      #   @return [Orb::Models::NewSubscriptionTieredPackagePrice::TieredPackageConfig]
      required :tiered_package_config, -> { Orb::NewSubscriptionTieredPackagePrice::TieredPackageConfig }
      ...
      #
      #   @param cadence [Symbol, Orb::Models::NewSubscriptionTieredPackagePrice::Cadence] The cadence to bill for this price on.
      #
      #   @param item_id [String] The id of the item the price will be associated with.
      #
      #   @param model_type [Symbol, Orb::Models::NewSubscriptionTieredPackagePrice::ModelType] The pricing model type
      #
      #   @param name [String] The name of the price.
      #
      #   @param tiered_package_config [Orb::Models::NewSubscriptionTieredPackagePrice::TieredPackageConfig] Configuration for tiered_package pricing
      #
      ...
      # The cadence to bill for this price on.
      #
      # @see Orb::Models::NewSubscriptionTieredPackagePrice#cadence
      module Cadence
      ...
      # The pricing model type
      #
      # @see Orb::Models::NewSubscriptionTieredPackagePrice#model_type
      module ModelType
        extend Orb::Internal::Type::Enum
      ...
      class TieredPackageConfig < Orb::Internal::Type::BaseModel
        ...
        required :tiers,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewSubscriptionTieredPackagePrice::TieredPackageConfig::Tier] }

        # @!method initialize(package_size:, tiers:)
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::NewSubscriptionTieredPackagePrice::TieredPackageConfig} for more
        #   details.
        #
        #   Configuration for tiered_package pricing
        #
