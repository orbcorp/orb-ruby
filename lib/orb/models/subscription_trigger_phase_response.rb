  ...
  module Models
    ...
    class SubscriptionTriggerPhaseResponse < Orb::Internal::Type::BaseModel
      ...
      required :adjustment_intervals,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval] }
      ...
      required :discount_intervals,
               -> { Orb::Internal::Type::ArrayOf[union: Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval] }
      ...
      required :fixed_fee_quantity_schedule,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::SubscriptionTriggerPhaseResponse::FixedFeeQuantitySchedule] }
      ...
      required :maximum_intervals,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::SubscriptionTriggerPhaseResponse::MaximumInterval] }
      ...
      #
      #   @return [Orb::Models::SubscriptionTriggerPhaseResponse::PendingSubscriptionChange, nil]
      ...
      required :price_intervals,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval] }
      ...
      #
      #   @return [Orb::Models::SubscriptionTriggerPhaseResponse::ChangedResources, nil]
      ...
      #
      #   @param adjustment_intervals [Array<Orb::Models::SubscriptionTriggerPhaseResponse::AdjustmentInterval>] The adjustment intervals for this subscription sorted by the start_date of the a
      #
      ...
      #
      #   @param discount_intervals [Array<Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Amount, Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Percentage, Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Usage>] The discount intervals for this subscription sorted by the start_date.
      #
      ...
      #
      #   @param maximum_intervals [Array<Orb::Models::SubscriptionTriggerPhaseResponse::MaximumInterval>] The maximum intervals for this subscription sorted by the start_date.
      #
      ...
      #
      #   @param changed_resources [Orb::Models::SubscriptionTriggerPhaseResponse::ChangedResources, nil] The resources that were changed as part of this operation. Only present when fet
      ...
      # @see Orb::Models::SubscriptionTriggerPhaseResponse#billing_cycle_anchor_configuration
      ...
      module DiscountInterval
        ...
        variant :amount, -> { Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Amount }

        variant :percentage, -> { Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Percentage }

        variant :usage, -> { Orb::Models::SubscriptionTriggerPhaseResponse::DiscountInterval::Usage }
      ...
      class PriceInterval < Orb::Internal::Type::BaseModel
        ...
        required :fixed_fee_quantity_transitions,
                 -> { Orb::Internal::Type::ArrayOf[Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval::FixedFeeQuantityTransition] },
                 nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::SubscriptionTriggerPhaseResponse::PriceInterval} for more details.
        #
      ...
      # @see Orb::Models::SubscriptionTriggerPhaseResponse#redeemed_coupon
