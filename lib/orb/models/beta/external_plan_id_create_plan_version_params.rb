      ...
      class ExternalPlanIDCreatePlanVersionParams < Orb::Internal::Type::BaseModel
        ...
        class AddPrice < Orb::Internal::Type::BaseModel
          ...
          module Price
            ...
            variant :minimum, -> { Orb::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum }
            ...
            class Minimum < Orb::Internal::Type::BaseModel
              ...
              #   The cadence to bill for this price on.
              #
              #   @return [Symbol, Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum::Cadence]
              required :cadence,
                       enum: -> { Orb::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum::Cadence }
              ...
              #
              #   @return [Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum::MinimumConfig]
              required :minimum_config,
                       -> { Orb::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum::MinimumConfig }
              ...
              optional :conversion_rate_config,
                       union: -> {
                         Orb::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum::UnnamedTypeWithobjectParent1
                       },
                       nil?: true
              ...
              #   Some parameter documentations has been truncated, see
              #   {Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum}
              #   for more details.
              #
              #   @param cadence [Symbol, Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum::Cadence] The cadence to bill for this price on.
              #
              #   @param item_id [String] The id of the item the price will be associated with.
              #
              #   @param minimum_config [Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum::MinimumConfig]
              #
              #   @param name [String] The name of the price.
              #
              #   @param billable_metric_id [String, nil] The id of the billable metric for the price. Only needed if the price is usage-b
              ...
              # The cadence to bill for this price on.
              #
              # @see Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum#cadence
              module Cadence
                extend Orb::Internal::Type::Enum
              ...
              # @see Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum#minimum_config
              class MinimumConfig < Orb::Internal::Type::BaseModel
                ...
                #   Some parameter documentations has been truncated, see
                #   {Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::AddPrice::Price::Minimum::MinimumConfig}
                #   for more details.
                #
        ...
        class ReplacePrice < Orb::Internal::Type::BaseModel
          ...
          #
          #   @param price [Orb::Models::NewPlanUnitPrice, Orb::Models::NewPlanPackagePrice, Orb::Models::NewPlanMatrixPrice, Orb::Models::NewPlanTieredPrice, Orb::Models::NewPlanBulkPrice, Orb::Models::NewPlanThresholdTotalAmountPrice, Orb::Models::NewPlanTieredPackagePrice, Orb::Models::NewPlanTieredWithMinimumPrice, Orb::Models::NewPlanUnitWithPercentPrice, Orb::Models::NewPlanPackageWithAllocationPrice, Orb::Models::NewPlanTierWithProrationPrice, Orb::Models::NewPlanUnitWithProrationPrice, Orb::Models::NewPlanGroupedAllocationPrice, Orb::Models::NewPlanGroupedWithProratedMinimumPrice, Orb::Models::NewPlanGroupedWithMeteredMinimumPrice, Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::GroupedWithMinMaxThresholds, Orb::Models::NewPlanMatrixWithDisplayNamePrice, Orb::Models::NewPlanBulkWithProrationPrice, Orb::Models::NewPlanGroupedTieredPackagePrice, Orb::Models::NewPlanMaxGroupTieredPackagePrice, Orb::Models::NewPlanScalableMatrixWithUnitPricingPrice, Orb::Models::NewPlanScalableMatrixWithTieredPricingPrice, Orb::Models::NewPlanCumulativeGroupedBulkPrice, Orb::Models::NewPlanTieredPackageWithMinimumPrice, Orb::Models::NewPlanMatrixWithAllocationPrice, Orb::Models::NewPlanGroupedTieredPrice, Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum, nil] The price to add to the plan
          ...
          module Price
            ...
            variant :minimum, -> { Orb::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum }
            ...
            class GroupedWithMinMaxThresholds < Orb::Internal::Type::BaseModel
              ...
              optional :conversion_rate_config,
                       union: -> {
                         Orb::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::GroupedWithMinMaxThresholds::UnnamedTypeWithobjectParent2
                       },
                       nil?: true
            ...
            class Minimum < Orb::Internal::Type::BaseModel
              ...
              #   The cadence to bill for this price on.
              #
              #   @return [Symbol, Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum::Cadence]
              required :cadence,
                       enum: -> { Orb::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum::Cadence }
              ...
              # @!attribute minimum_config
              #
              #   @return [Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum::MinimumConfig]
              required :minimum_config,
                       -> { Orb::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum::MinimumConfig }
              ...
              optional :conversion_rate_config,
                       union: -> {
                         Orb::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum::UnnamedTypeWithobjectParent3
                       },
                       nil?: true
              ...
              # @!method initialize(cadence:, item_id:, minimum_config:, name:, billable_metric_id: nil, billed_in_advance: nil, billing_cycle_configuration: nil, conversion_rate: nil, conversion_rate_config: nil, currency: nil, dimensional_price_configuration: nil, external_price_id: nil, fixed_price_quantity: nil, invoice_grouping_key: nil, invoicing_cycle_configuration: nil, metadata: nil, reference_id: nil, model_type: :minimum)
              #   Some parameter documentations has been truncated, see
              #   {Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum}
              #   for more details.
              #
              #   @param cadence [Symbol, Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum::Cadence] The cadence to bill for this price on.
              #
              #   @param item_id [String] The id of the item the price will be associated with.
              #
              #   @param minimum_config [Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum::MinimumConfig]
              #
              #   @param name [String] The name of the price.
              #
              #   @param billable_metric_id [String, nil] The id of the billable metric for the price. Only needed if the price is usage-b
              ...
              # The cadence to bill for this price on.
              #
              # @see Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum#cadence
              module Cadence
                extend Orb::Internal::Type::Enum
              ...
              # @see Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum#minimum_config
              class MinimumConfig < Orb::Internal::Type::BaseModel
                # @!attribute minimum_amount
                #   The minimum amount to apply
                #
                ...
                # @!method initialize(minimum_amount:, prorated: nil)
                #   Some parameter documentations has been truncated, see
                #   {Orb::Models::Beta::ExternalPlanIDCreatePlanVersionParams::ReplacePrice::Price::Minimum::MinimumConfig}
                #   for more details.
                #
                #   @param minimum_amount [String] The minimum amount to apply
                #
