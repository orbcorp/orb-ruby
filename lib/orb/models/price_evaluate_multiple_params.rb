  ...
  module Models
    ...
    class PriceEvaluateMultipleParams < Orb::Internal::Type::BaseModel
      ...
      class PriceEvaluation < Orb::Internal::Type::BaseModel
        ...
        #
        #   @param price [Orb::Models::NewFloatingUnitPrice, Orb::Models::NewFloatingPackagePrice, Orb::Models::NewFloatingMatrixPrice, Orb::Models::NewFloatingMatrixWithAllocationPrice, Orb::Models::NewFloatingTieredPrice, Orb::Models::NewFloatingBulkPrice, Orb::Models::NewFloatingThresholdTotalAmountPrice, Orb::Models::NewFloatingTieredPackagePrice, Orb::Models::NewFloatingGroupedTieredPrice, Orb::Models::NewFloatingMaxGroupTieredPackagePrice, Orb::Models::NewFloatingTieredWithMinimumPrice, Orb::Models::NewFloatingPackageWithAllocationPrice, Orb::Models::NewFloatingTieredPackageWithMinimumPrice, Orb::Models::NewFloatingUnitWithPercentPrice, Orb::Models::NewFloatingTieredWithProrationPrice, Orb::Models::NewFloatingUnitWithProrationPrice, Orb::Models::NewFloatingGroupedAllocationPrice, Orb::Models::NewFloatingGroupedWithProratedMinimumPrice, Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice, Orb::Models::NewFloatingMatrixWithDisplayNamePrice, Orb::Models::NewFloatingBulkWithProrationPrice, Orb::Models::NewFloatingGroupedTieredPackagePrice, Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice, Orb::Models::NewFloatingScalableMatrixWithTieredPricingPrice, Orb::Models::NewFloatingCumulativeGroupedBulkPrice, Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::GroupedWithMinMaxThresholds, Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum, nil] An inline price definition to evaluate, allowing you to test price configuration
        #
        ...
        module Price
          ...
          variant :minimum, -> { Orb::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum }
          ...
          class GroupedWithMinMaxThresholds < Orb::Internal::Type::BaseModel
            ...
            optional :conversion_rate_config,
                     union: -> {
                       Orb::PriceEvaluateMultipleParams::PriceEvaluation::Price::GroupedWithMinMaxThresholds::UnnamedTypeWithobjectParent112
                     },
                     nil?: true
          ...
          class Minimum < Orb::Internal::Type::BaseModel
            ...
            #   The cadence to bill for this price on.
            #
            #   @return [Symbol, Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum::Cadence]
            required :cadence, enum: -> { Orb::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum::Cadence }
            ...
            #
            #   @return [Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum::MinimumConfig]
            ...
            optional :conversion_rate_config,
                     union: -> {
                       Orb::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum::UnnamedTypeWithobjectParent113
                     },
                     nil?: true
            ...
            #   Some parameter documentations has been truncated, see
            #   {Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum} for
            #   more details.
            #
            ...
            #   @param item_id [String] The id of the item the price will be associated with.
            #
            #   @param minimum_config [Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum::MinimumConfig]
            #
            #   @param name [String] The name of the price.
            #
            #   @param billable_metric_id [String, nil] The id of the billable metric for the price. Only needed if the price is usage-b
            ...
            # The cadence to bill for this price on.
            #
            # @see Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum#cadence
            module Cadence
              extend Orb::Internal::Type::Enum
            ...
            # @see Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum#minimum_config
            class MinimumConfig < Orb::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum::MinimumConfig}
              #   for more details.
              #
          ...
          #   @return [Array(Orb::Models::NewFloatingUnitPrice, Orb::Models::NewFloatingPackagePrice, Orb::Models::NewFloatingMatrixPrice, Orb::Models::NewFloatingMatrixWithAllocationPrice, Orb::Models::NewFloatingTieredPrice, Orb::Models::NewFloatingBulkPrice, Orb::Models::NewFloatingThresholdTotalAmountPrice, Orb::Models::NewFloatingTieredPackagePrice, Orb::Models::NewFloatingGroupedTieredPrice, Orb::Models::NewFloatingMaxGroupTieredPackagePrice, Orb::Models::NewFloatingTieredWithMinimumPrice, Orb::Models::NewFloatingPackageWithAllocationPrice, Orb::Models::NewFloatingTieredPackageWithMinimumPrice, Orb::Models::NewFloatingUnitWithPercentPrice, Orb::Models::NewFloatingTieredWithProrationPrice, Orb::Models::NewFloatingUnitWithProrationPrice, Orb::Models::NewFloatingGroupedAllocationPrice, Orb::Models::NewFloatingGroupedWithProratedMinimumPrice, Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice, Orb::Models::NewFloatingMatrixWithDisplayNamePrice, Orb::Models::NewFloatingBulkWithProrationPrice, Orb::Models::NewFloatingGroupedTieredPackagePrice, Orb::Models::NewFloatingScalableMatrixWithUnitPricingPrice, Orb::Models::NewFloatingScalableMatrixWithTieredPricingPrice, Orb::Models::NewFloatingCumulativeGroupedBulkPrice, Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::GroupedWithMinMaxThresholds, Orb::Models::PriceEvaluateMultipleParams::PriceEvaluation::Price::Minimum)]
        end
      end
    end
  end
