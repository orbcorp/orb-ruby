...
module Orb
    module Models
        class InvoiceFetchUpcomingResponse < Orb::Model
                ...
                class CustomerBalanceTransactions < Orb::Model
                        ...
                        required :id, String
                        # @!attribute [rw] action
                        required :action, Orb::Enum.new([:"applied_to_invoice", :"manual_adjustment", :"prorated_refund", :"revert_prorated_refund", :"return_from_voiding", :"credit_note_applied", :"credit_note_voided", :"overpayment_refund"])
                        # @!attribute [rw] amount
                ...
                class CustomerTaxID < Orb::Model
                        ...
                        # @!attribute [rw] country
                        required :country, Orb::Enum.new([:"AE", :"AT", :"AU", :"BE", :"BG", :"BR", :"CA", :"CH", :"CL", :"CY", :"CZ", :"DE", :"DK", :"EE", :"EG", :"ES", :"EU", :"FI", :"FR", :"GB", :"GE", :"GR", :"HK", :"HR", :"HU", :"ID", :"IE", :"IL", :"IN", :"IS", :"IT", :"JP", :"KE", :"KR", :"LI", :"LT", :"LU", :"LV", :"MT", :"MX", :"MY", :"NL", :"NO", :"NZ", :"PH", :"PL", :"PT", :"RO", :"RU", :"SA", :"SE", :"SG", :"SI", :"SK", :"TH", :"TR", :"TW", :"UA", :"US", :"ZA"])
                        # @!attribute [rw] type
                        required :type, Orb::Enum.new([:"ae_trn", :"eu_vat", :"au_abn", :"au_arn", :"bg_uic", :"br_cnpj", :"br_cpf", :"ca_bn", :"ca_gst_hst", :"ca_pst_bc", :"ca_pst_mb", :"ca_pst_sk", :"ca_qst", :"ch_vat", :"cl_tin", :"eg_tin", :"es_cif", :"eu_oss_vat", :"gb_vat", :"ge_vat", :"hk_br", :"hu_tin", :"id_npwp", :"il_vat", :"in_gst", :"is_vat", :"jp_cn", :"jp_rn", :"jp_trn", :"ke_pin", :"kr_brn", :"li_uid", :"mx_rfc", :"my_frp", :"my_itn", :"my_sst", :"no_vat", :"nz_gst", :"ph_tin", :"ru_inn", :"ru_kpp", :"sa_vat", :"sg_gst", :"sg_uen", :"si_tin", :"th_vat", :"tr_tin", :"tw_vat", :"ua_vat", :"us_ein", :"za_vat"])
                        # @!attribute [rw] value
                ...
                required :customer_balance_transactions, Orb::ArrayOf.new(CustomerBalanceTransactions)
                ...
                # @!attribute [rw] status
                required :status, Orb::Enum.new([:"issued", :"paid", :"synced", :"void", :"draft"])
                ...
                # @!attribute [rw] target_date
                required :target_date, String
                # @!attribute [rw] total
                required :total, String
                # @!attribute [rw] voided_at
                required :voided_at, String
