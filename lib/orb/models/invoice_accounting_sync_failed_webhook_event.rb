...
module Orb
  module Models
    class InvoiceAccountingSyncFailedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::InvoiceAccountingSyncFailedWebhookEvent::AccountingSyncRecord]
      ...
      #
      #   @return [Orb::Models::InvoiceAccountingSyncFailedWebhookEvent::Properties]
      required :properties, -> { Orb::InvoiceAccountingSyncFailedWebhookEvent::Properties }

      # @!attribute type
      #   The event this payload describes.
      #
      #   @return [Symbol, Orb::Models::InvoiceAccountingSyncFailedWebhookEvent::Type]
      required :type, enum: -> { Orb::InvoiceAccountingSyncFailedWebhookEvent::Type }

      # @!method initialize(id:, accounting_sync_record:, created_at:, invoice:, properties:, type:)
      #   Some parameter documentations has been truncated, see
      #   {Orb::Models::InvoiceAccountingSyncFailedWebhookEvent} for more details.
      #
      #   Issued when an invoice accounting sync fails.
      #
      #   @param id [String] The ID of this webhook event.
      #
      #   @param accounting_sync_record [Orb::Models::InvoiceAccountingSyncFailedWebhookEvent::AccountingSyncRecord]
      #
      ...
      #
      #   @param properties [Orb::Models::InvoiceAccountingSyncFailedWebhookEvent::Properties]
      #
      #   @param type [Symbol, Orb::Models::InvoiceAccountingSyncFailedWebhookEvent::Type] The event this payload describes.

      # @see Orb::Models::InvoiceAccountingSyncFailedWebhookEvent#accounting_sync_record
      class AccountingSyncRecord < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::InvoiceAccountingSyncFailedWebhookEvent::AccountingSyncRecord::RecordType]
        required :record_type,
                 enum: -> { Orb::InvoiceAccountingSyncFailedWebhookEvent::AccountingSyncRecord::RecordType }
        ...
        #   @param record_type [Symbol, Orb::Models::InvoiceAccountingSyncFailedWebhookEvent::AccountingSyncRecord::RecordType]
        ...
        # @see Orb::Models::InvoiceAccountingSyncFailedWebhookEvent::AccountingSyncRecord#record_type
        module RecordType
      ...
      # @see Orb::Models::InvoiceAccountingSyncFailedWebhookEvent#properties
      ...
      # The event this payload describes.
      #
      # @see Orb::Models::InvoiceAccountingSyncFailedWebhookEvent#type
      module Type
        extend Orb::Internal::Type::Enum

        INVOICE_ACCOUNTING_SYNC_FAILED = :"invoice.accounting_sync_failed"
