...
module Orb
  module Models
    class NewFloatingScalableMatrixWithTieredPricingPrice < Orb::Internal::Type::BaseModel
      ...
      # @!method initialize(cadence:, currency:, item_id:, model_type:, name:, scalable_matrix_with_tiered_pricing_config:, billable_metric_id: nil, billed_in_advance: nil, billing_cycle_configuration: nil, conversion_rate: nil, dimensional_price_configuration: nil, external_price_id: nil, fixed_price_quantity: nil, invoice_grouping_key: nil, invoicing_cycle_configuration: nil, metadata: nil)
