...
module Orb
  module Models
    ...
    #   adjustment_intervals: -> { Orb::ArrayOf[Orb::Models::SubscriptionCancelResponse::AdjustmentInterval] === _1 },
    ...
    # }
    # ```
    class SubscriptionCancelResponse < Orb::BaseModel
      # @!attribute id
      #
      #   @return [String]
      required :id, String
      ...
      required :adjustment_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionCancelResponse::AdjustmentInterval] }
      ...
      #
      #   @return [Orb::Models::SubscriptionCancelResponse::BillingCycleAnchorConfiguration]
      ...
      required :discount_intervals,
               -> { Orb::ArrayOf[union: Orb::Models::SubscriptionCancelResponse::DiscountInterval] }
      ...
      #
      #   @return [Array<Orb::Models::SubscriptionCancelResponse::FixedFeeQuantitySchedule>]
      required :fixed_fee_quantity_schedule,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionCancelResponse::FixedFeeQuantitySchedule] }
      ...
      required :maximum_intervals,
               -> {
                 Orb::ArrayOf[Orb::Models::SubscriptionCancelResponse::MaximumInterval]
               }
      ...
      required :minimum_intervals,
               -> {
                 Orb::ArrayOf[Orb::Models::SubscriptionCancelResponse::MinimumInterval]
               }
      ...
      #
      #   @return [Array<Orb::Models::SubscriptionCancelResponse::PriceInterval>]
      required :price_intervals, -> { Orb::ArrayOf[Orb::Models::SubscriptionCancelResponse::PriceInterval] }

      # @!attribute redeemed_coupon
      #
      #   @return [Orb::Models::SubscriptionCancelResponse::RedeemedCoupon, nil]
      required :redeemed_coupon, -> { Orb::Models::SubscriptionCancelResponse::RedeemedCoupon }, nil?: true
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::SubscriptionCancelResponse::Status]
      required :status, enum: -> { Orb::Models::SubscriptionCancelResponse::Status }
      ...
      #   # @param adjustment_intervals [Array<Orb::Models::SubscriptionCancelResponse::AdjustmentInterval>]
      #   # @param auto_collection [Boolean, nil]
      #   # @param billing_cycle_anchor_configuration [Orb::Models::SubscriptionCancelResponse::BillingCycleAnchorConfiguration]
      ...
      #   # @param discount_intervals [Array<Orb::Models::SubscriptionCancelResponse::DiscountInterval::AmountDiscountInterval, Orb::Models::SubscriptionCancelResponse::DiscountInterval::PercentageDiscountInterval, Orb::Models::SubscriptionCancelResponse::DiscountInterval::UsageDiscountInterval>]
      #   # @param end_date [Time, nil]
      #   # @param fixed_fee_quantity_schedule [Array<Orb::Models::SubscriptionCancelResponse::FixedFeeQuantitySchedule>]
      #   # @param invoicing_threshold [String, nil]
      #   # @param maximum_intervals [Array<Orb::Models::SubscriptionCancelResponse::MaximumInterval>]
      ...
      # adjustment_interval => {
      #   id: String,
      #   adjustment: Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment,
      ...
      class AdjustmentInterval < Orb::BaseModel
        ...
        #
        #   @return [Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::MaximumAdjustment]
        required :adjustment,
        ...
        # @!parse
        #   # @param id [String]
        #   # @param adjustment [Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::MinimumAdjustment, Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::MaximumAdjustment]
        ...
        #   # Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment ...
        ...
        #   # Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment ...
        # in {adjustment_type: "usage_discount", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment ...
        # in {adjustment_type: "minimum", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::MinimumAdjustment ...
        # in {adjustment_type: "maximum", id: String, applies_to_price_ids: -> { Orb::ArrayOf[String] === _1 }, is_invoice_level: Orb::BooleanModel}
        #   # Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::MaximumAdjustment ...
        # end
        # ```
        #
        # @example
        # ```ruby
        # case adjustment
        # in Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::MinimumAdjustment
        #   # ...
        # in Orb::Models::SubscriptionCancelResponse::AdjustmentInterval::Adjustment::MaximumAdjustment
        #   # ...
        # end
        # ```
      ...
      # ```ruby
      # case discount_interval
      # in Orb::Models::SubscriptionCancelResponse::DiscountInterval::AmountDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionCancelResponse::DiscountInterval::PercentageDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionCancelResponse::DiscountInterval::UsageDiscountInterval
      #   # ...
      # end
      # ```
      ...
      class PriceInterval < Orb::BaseModel
        ...
        #
        #   @return [Array<Orb::Models::SubscriptionCancelResponse::PriceInterval::FixedFeeQuantityTransition>, nil]
        required :fixed_fee_quantity_transitions,
                 -> {
                   Orb::ArrayOf[Orb::Models::SubscriptionCancelResponse::PriceInterval::FixedFeeQuantityTransition]
                 },
                 nil?: true
        ...
        #   # @param current_billing_period_start_date [Time, nil]
        #   # @param end_date [Time, nil]
        #   # @param fixed_fee_quantity_transitions [Array<Orb::Models::SubscriptionCancelResponse::PriceInterval::FixedFeeQuantityTransition>, nil]
