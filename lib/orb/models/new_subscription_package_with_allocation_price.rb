...
module Orb
  module Models
    class NewSubscriptionPackageWithAllocationPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewSubscriptionPackageWithAllocationPrice::PackageWithAllocationConfig]
      required :package_with_allocation_config,
               -> { Orb::NewSubscriptionPackageWithAllocationPrice::PackageWithAllocationConfig }
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewSubscriptionPackageWithAllocationPrice::ModelType] The pricing model type
      #
      #   @param name [String] The name of the price.
      #
      #   @param package_with_allocation_config [Orb::Models::NewSubscriptionPackageWithAllocationPrice::PackageWithAllocationConfig] Configuration for package_with_allocation pricing
      #
      ...
      # @see Orb::Models::NewSubscriptionPackageWithAllocationPrice#package_with_allocation_config
