...
module Orb
  module Models
    class CreditNoteIssuedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::CreditNoteIssuedWebhookEvent::Type]
      ...
      #   {Orb::Models::CreditNoteIssuedWebhookEvent} for more details.
      #
      ...
      #
      #   @param type [Symbol, Orb::Models::CreditNoteIssuedWebhookEvent::Type] The event this payload describes.

      # The event this payload describes.
      #
      # @see Orb::Models::CreditNoteIssuedWebhookEvent#type
      module Type
