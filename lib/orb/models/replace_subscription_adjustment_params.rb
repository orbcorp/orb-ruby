...
module Orb
  module Models
    class ReplaceSubscriptionAdjustmentParams < Orb::BaseModel
      ...
      # @!parse
      #   # @param adjustment [Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewPercentageDiscount, Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewUsageDiscount, Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewAmountDiscount, Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewMinimum, Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewMaximum]
      ...
      # ```ruby
      # case adjustment
      # in Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewPercentageDiscount
      #   # ...
      # in Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewUsageDiscount
      #   # ...
      # in Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewAmountDiscount
      #   # ...
      # in Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewMinimum
      #   # ...
      # in Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewMaximum
      #   # ...
      # end
      # ```
      class Adjustment < Orb::Union
        ...
        variant :minimum, -> { Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewMinimum }

        variant :maximum, -> { Orb::Models::ReplaceSubscriptionAdjustmentParams::Adjustment::NewMaximum }
