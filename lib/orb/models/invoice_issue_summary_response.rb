...
module Orb
  module Models
    ...
    class InvoiceIssueSummaryResponse < Orb::Internal::Type::BaseModel
      # @!attribute id
      #
      #   @return [String]
      required :id, String
      ...
      #
      #   @return [Orb::Models::InvoiceIssueSummaryResponse::AutoCollection]
      required :auto_collection, -> { Orb::Models::InvoiceIssueSummaryResponse::AutoCollection }
      ...
      #
      #   @return [Array<Orb::Models::InvoiceIssueSummaryResponse::CreditNote>]
      required :credit_notes,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::InvoiceIssueSummaryResponse::CreditNote] }
      ...
      #
      #   @return [Array<Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction>]
      required :customer_balance_transactions,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction] }
      ...
      #
      #   @return [Symbol, Orb::Models::InvoiceIssueSummaryResponse::InvoiceSource]
      required :invoice_source, enum: -> { Orb::Models::InvoiceIssueSummaryResponse::InvoiceSource }
      ...
      #
      #   @return [Array<Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt>]
      required :payment_attempts,
               -> { Orb::Internal::Type::ArrayOf[Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt] }
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::InvoiceIssueSummaryResponse::Status]
      required :status, enum: -> { Orb::Models::InvoiceIssueSummaryResponse::Status }
      ...
      #   {Orb::Models::InvoiceIssueSummaryResponse} for more details.
      #
      ...
      #
      #   @param auto_collection [Orb::Models::InvoiceIssueSummaryResponse::AutoCollection]
      #
      #   @param billing_address [Orb::Models::Address, nil]
      #
      #   @param created_at [Time] The creation time of the resource in Orb.
      #
      #   @param credit_notes [Array<Orb::Models::InvoiceIssueSummaryResponse::CreditNote>] A list of credit notes associated with the invoice
      #
      #   @param currency [String] An ISO 4217 currency string or `credits`
      #
      #   @param customer [Orb::Models::CustomerMinified]
      #
      #   @param customer_balance_transactions [Array<Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction>]
      #
      ...
      #
      #   @param invoice_source [Symbol, Orb::Models::InvoiceIssueSummaryResponse::InvoiceSource]
      #
      ...
      #
      #   @param payment_attempts [Array<Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt>] A list of payment attempts associated with the invoice
      #
      ...
      #
      #   @param status [Symbol, Orb::Models::InvoiceIssueSummaryResponse::Status]
      #
      ...
      # @see Orb::Models::InvoiceIssueSummaryResponse#auto_collection
      class AutoCollection < Orb::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::InvoiceIssueSummaryResponse::AutoCollection} for more details.
        #
      ...
      class CreditNote < Orb::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::InvoiceIssueSummaryResponse::CreditNote} for more details.
        #
        #   @param id [String]
        #
      ...
      class CustomerBalanceTransaction < Orb::Internal::Type::BaseModel
        ...
        # @!attribute action
        #
        #   @return [Symbol, Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Action]
        required :action,
                 enum: -> { Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Action }
        ...
        # @!attribute type
        #
        #   @return [Symbol, Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Type]
        required :type, enum: -> { Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Type }

        # @!method initialize(id:, action:, amount:, created_at:, credit_note:, description:, ending_balance:, invoice:, starting_balance:, type:)
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction} for more
        #   details.
        #
        #   @param id [String] A unique id for this transaction.
        #
        #   @param action [Symbol, Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Action]
        #
        ...
        #
        #   @param type [Symbol, Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction::Type]

        # @see Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction#action
        module Action
        ...
        # @see Orb::Models::InvoiceIssueSummaryResponse::CustomerBalanceTransaction#type
        module Type
          extend Orb::Internal::Type::Enum
      ...
      # @see Orb::Models::InvoiceIssueSummaryResponse#invoice_source
      ...
      class PaymentAttempt < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt::PaymentProvider, nil]
        required :payment_provider,
                 enum: -> { Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt::PaymentProvider },
                 nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt} for more details.
        #
        ...
        #
        #   @param payment_provider [Symbol, Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt::PaymentProvider, nil] The payment provider that attempted to collect the payment.
        #
        ...
        # The payment provider that attempted to collect the payment.
        #
        # @see Orb::Models::InvoiceIssueSummaryResponse::PaymentAttempt#payment_provider
      ...
      # @see Orb::Models::InvoiceIssueSummaryResponse#status
      module Status
        extend Orb::Internal::Type::Enum
