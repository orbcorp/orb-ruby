...
module Orb
  module Models
    ...
    class LicenseCreateResponse < Orb::Internal::Type::BaseModel
      ...
      # @!attribute status
      #
      #   @return [Symbol, Orb::Models::LicenseCreateResponse::Status]
      required :status, enum: -> { Orb::Models::LicenseCreateResponse::Status }
      ...
      #   @param status [Symbol, Orb::Models::LicenseCreateResponse::Status]
      #   @param subscription_id [String]

      # @see Orb::Models::LicenseCreateResponse#status
      module Status
