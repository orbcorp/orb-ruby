...
module Orb
  module Models
    class SubscriptionPlanChangedWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::SubscriptionPlanChangedWebhookEvent::Properties]
      required :properties, -> { Orb::SubscriptionPlanChangedWebhookEvent::Properties }
      ...
      #
      #   @return [Symbol, Orb::Models::SubscriptionPlanChangedWebhookEvent::Type]
      required :type, enum: -> { Orb::SubscriptionPlanChangedWebhookEvent::Type }

      # @!method initialize(id:, created_at:, properties:, subscription:, type:)
      #   Some parameter documentations has been truncated, see
      #   {Orb::Models::SubscriptionPlanChangedWebhookEvent} for more details.
      #
      ...
      #
      #   @param properties [Orb::Models::SubscriptionPlanChangedWebhookEvent::Properties]
      #
      #   @param subscription [Orb::Models::Subscription] A [subscription](/core-concepts#subscription) represents the purchase of a plan
      #
      #   @param type [Symbol, Orb::Models::SubscriptionPlanChangedWebhookEvent::Type] The event this payload describes.

      # @see Orb::Models::SubscriptionPlanChangedWebhookEvent#properties
      class Properties < Orb::Internal::Type::BaseModel
        ...
        # @!method initialize(previous_plan_id:)
        #   @param previous_plan_id [String]
      end

      # The event this payload describes.
      #
      # @see Orb::Models::SubscriptionPlanChangedWebhookEvent#type
      module Type
