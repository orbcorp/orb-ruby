...
module Orb
  module Models
    class NewFloatingGroupedWithMeteredMinimumPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig]
      ...
      #
      #   @param grouped_with_metered_minimum_config [Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig] Configuration for grouped_with_metered_minimum pricing
      #
      #   @param item_id [String] The id of the item the price will be associated with.
      #
      #   @param model_type [Symbol, Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice::ModelType] The pricing model type
      #
      ...
      # @see Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice#grouped_with_metered_minimum_config
      class GroupedWithMeteredMinimumConfig < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::ScalingFactor>]
        required :scaling_factors,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewFloatingGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::ScalingFactor] }
        ...
        #   unmatched usage.
        #
        #   @return [Array<Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::UnitAmount>]
        required :unit_amounts,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewFloatingGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::UnitAmount] }

        # @!method initialize(grouping_key:, minimum_unit_amount:, pricing_key:, scaling_factors:, scaling_key:, unit_amounts:)
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig}
        #   for more details.
        #
        #   Configuration for grouped_with_metered_minimum pricing
        #
        ...
        #
        #   @param scaling_factors [Array<Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::ScalingFactor>] Scale the unit rates by the scaling factor.
        #
        #   @param scaling_key [String] Used to determine the unit rate scaling factor
        #
        #   @param unit_amounts [Array<Orb::Models::NewFloatingGroupedWithMeteredMinimumPrice::GroupedWithMeteredMinimumConfig::UnitAmount>] Apply per unit pricing to each pricing value. The minimum amount is applied any
