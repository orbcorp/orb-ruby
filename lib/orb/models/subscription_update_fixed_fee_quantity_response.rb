...
module Orb
  module Models
    ...
    #   adjustment_intervals: -> { Orb::ArrayOf[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval] === _1 },
    ...
    class SubscriptionUpdateFixedFeeQuantityResponse < Orb::BaseModel
      ...
      required :adjustment_intervals,
               -> {
                 Orb::ArrayOf[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval]
               }
      ...
      required :discount_intervals,
               -> {
                 Orb::ArrayOf[union: Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval]
               }
      ...
      required :fixed_fee_quantity_schedule,
               -> {
                 Orb::ArrayOf[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::FixedFeeQuantitySchedule]
               }
      ...
      required :maximum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::MaximumInterval] }
      ...
      required :minimum_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::MinimumInterval] }
      ...
      required :price_intervals,
               -> { Orb::ArrayOf[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PriceInterval] }
      ...
      class AdjustmentInterval < Orb::BaseModel
        ...
        required :adjustment,
                 union: -> {
                   Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment
                 }
        ...
        # ```ruby
        # case adjustment
        # in Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::AmountDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::PercentageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::UsageDiscountAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::MinimumAdjustment
        #   # ...
        # in Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::AdjustmentInterval::Adjustment::MaximumAdjustment
        #   # ...
        # end
        # ```
      ...
      # ```ruby
      # case discount_interval
      # in Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::AmountDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::PercentageDiscountInterval
      #   # ...
      # in Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::DiscountInterval::UsageDiscountInterval
      #   # ...
      # end
      # ```
      ...
      class PriceInterval < Orb::BaseModel
        ...
        required :fixed_fee_quantity_transitions,
                 -> {
                   Orb::ArrayOf[Orb::Models::SubscriptionUpdateFixedFeeQuantityResponse::PriceInterval::FixedFeeQuantityTransition]
                 },
                 nil?: true
