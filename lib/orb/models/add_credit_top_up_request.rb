...
module Orb
  module Models
    class AddCreditTopUpRequest < Orb::BaseModel
      ...
      #
      #   @return [Orb::Models::AddCreditTopUpRequest::InvoiceSettings]
      required :invoice_settings, -> { Orb::Models::AddCreditTopUpRequest::InvoiceSettings }
      ...
      #
      #   @return [Symbol, Orb::Models::AddCreditTopUpRequest::ExpiresAfterUnit, nil]
      optional :expires_after_unit,
               enum: -> { Orb::Models::AddCreditTopUpRequest::ExpiresAfterUnit },
               nil?: true

      # @!parse
      #   # @param amount [String]
      #   # @param currency [String]
      #   # @param invoice_settings [Orb::Models::AddCreditTopUpRequest::InvoiceSettings]
      #   # @param per_unit_cost_basis [String]
      #   # @param threshold [String]
      #   # @param active_from [Time, nil]
      #   # @param expires_after [Integer, nil]
      #   # @param expires_after_unit [Symbol, Orb::Models::AddCreditTopUpRequest::ExpiresAfterUnit, nil]
      #   #
      #   def initialize(
      #     amount:,
      #     currency:,
