...
module Orb
  module Models
    class InvoiceIssuedSummaryWebhookEvent < Orb::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice]
      required :invoice, -> { Orb::InvoiceIssuedSummaryWebhookEvent::Invoice }

      # @!attribute properties
      #
      #   @return [Orb::Models::InvoiceIssuedSummaryWebhookEvent::Properties]
      required :properties, -> { Orb::InvoiceIssuedSummaryWebhookEvent::Properties }

      # @!attribute type
      #   The event this payload describes.
      #
      #   @return [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Type]
      required :type, enum: -> { Orb::InvoiceIssuedSummaryWebhookEvent::Type }
      ...
      #
      #   @param invoice [Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice] #InvoiceApiResourceWithoutLineItems
      #
      #   @param properties [Orb::Models::InvoiceIssuedSummaryWebhookEvent::Properties]
      #
      #   @param type [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Type] The event this payload describes.

      # @see Orb::Models::InvoiceIssuedSummaryWebhookEvent#invoice
      class Invoice < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::AutoCollection]
        required :auto_collection, -> { Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::AutoCollection }
        ...
        #
        #   @return [Array<Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CreditNote>]
        required :credit_notes,
                 -> { Orb::Internal::Type::ArrayOf[Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CreditNote] }
        ...
        #
        #   @return [Array<Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction>]
        required :customer_balance_transactions,
                 -> { Orb::Internal::Type::ArrayOf[Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction] }
        ...
        #
        #   @return [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::InvoiceSource]
        required :invoice_source, enum: -> { Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::InvoiceSource }
        ...
        #
        #   @return [Array<Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt>]
        required :payment_attempts,
                 -> { Orb::Internal::Type::ArrayOf[Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt] }
        ...
        # @!attribute status
        #
        #   @return [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::Status]
        required :status, enum: -> { Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::Status }
        ...
        #
        #   @param auto_collection [Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::AutoCollection]
        #
        #   @param billing_address [Orb::Models::Address, nil]
        #
        #   @param created_at [Time] The creation time of the resource in Orb.
        #
        #   @param credit_notes [Array<Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CreditNote>] A list of credit notes associated with the invoice
        #
        #   @param currency [String] An ISO 4217 currency string or `credits`
        #
        #   @param customer [Orb::Models::CustomerMinified]
        #
        #   @param customer_balance_transactions [Array<Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction>]
        #
        ...
        #
        #   @param invoice_source [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::InvoiceSource]
        #
        ...
        #
        #   @param status [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::Status]
        #
        ...
        # @see Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice#auto_collection
        class AutoCollection < Orb::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::AutoCollection} for
          #   more details.
          #
        ...
        class CreditNote < Orb::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CreditNote} for more
          #   details.
          #
          #   @param id [String]
          #
        ...
        class CustomerBalanceTransaction < Orb::Internal::Type::BaseModel
          ...
          # @!attribute action
          #
          #   @return [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Action]
          required :action,
                   enum: -> { Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Action }
          ...
          # @!attribute type
          #
          #   @return [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Type]
          required :type,
                   enum: -> { Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Type }

          # @!method initialize(id:, action:, amount:, created_at:, credit_note:, description:, ending_balance:, invoice:, starting_balance:, type:)
          #   Some parameter documentations has been truncated, see
          #   {Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction}
          #   for more details.
          #
          #   @param id [String] A unique id for this transaction.
          #
          #   @param action [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Action]
          #
          ...
          #
          #   @param type [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction::Type]

          # @see Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction#action
          module Action
          ...
          # @see Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::CustomerBalanceTransaction#type
          module Type
            extend Orb::Internal::Type::Enum
        ...
        # @see Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice#invoice_source
        ...
        class PaymentAttempt < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt::PaymentProvider, nil]
          required :payment_provider,
                   enum: -> {
                     Orb::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt::PaymentProvider
                   },
                   nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt} for
          #   more details.
          #
          ...
          #
          #   @param payment_provider [Symbol, Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt::PaymentProvider, nil] The payment provider that attempted to collect the payment.
          #
          ...
          # The payment provider that attempted to collect the payment.
          #
          # @see Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice::PaymentAttempt#payment_provider
        ...
        # @see Orb::Models::InvoiceIssuedSummaryWebhookEvent::Invoice#status
        module Status
          extend Orb::Internal::Type::Enum
      ...
      # @see Orb::Models::InvoiceIssuedSummaryWebhookEvent#properties
      ...
      # The event this payload describes.
      #
      # @see Orb::Models::InvoiceIssuedSummaryWebhookEvent#type
      module Type
        extend Orb::Internal::Type::Enum

        INVOICE_ISSUED_SUMMARY = :"invoice.issued_summary"
