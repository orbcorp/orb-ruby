...
module Orb
  module Models
    ...
    class PriceEvaluateMultipleResponse < Orb::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Array<Orb::Models::PriceEvaluateMultipleResponse::Data>]
      required :data, -> { Orb::Internal::Type::ArrayOf[Orb::Models::PriceEvaluateMultipleResponse::Data] }

      # @!method initialize(data:)
      #   @param data [Array<Orb::Models::PriceEvaluateMultipleResponse::Data>]
