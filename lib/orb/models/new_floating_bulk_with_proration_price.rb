...
module Orb
  module Models
    class NewFloatingBulkWithProrationPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::NewFloatingBulkWithProrationPrice::Cadence]
      required :cadence, enum: -> { Orb::NewFloatingBulkWithProrationPrice::Cadence }
      ...
      #
      #   @return [Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered, nil]
      ...
      #
      #   @param conversion_rate_config [Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered, nil] The configuration for the rate of the price currency to the invoicing currency.
      #
      ...
      module ConversionRateConfig
        ...
        variant :unit, -> { Orb::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Unit }

        variant :tiered, -> { Orb::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered }
        ...
        class Unit < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Unit::UnitConfig]
          required :unit_config,
                   -> { Orb::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Unit::UnitConfig }

          # @!method initialize(unit_config:, conversion_rate_type: :unit)
          #   @param unit_config [Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Unit::UnitConfig]
          #   @param conversion_rate_type [Symbol, :unit]

          # @see Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Unit#unit_config
        ...
        class Tiered < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered::TieredConfig]
          required :tiered_config,
                   -> { Orb::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered::TieredConfig }

          # @!method initialize(tiered_config:, conversion_rate_type: :tiered)
          #   @param tiered_config [Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered::TieredConfig]
          #   @param conversion_rate_type [Symbol, :tiered]

          # @see Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered#tiered_config
          class TieredConfig < Orb::Internal::Type::BaseModel
            # @!attribute tiers
            #   Tiers for rating based on total usage quantities into the specified tier
            #
            #   @return [Array<Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>]
            required :tiers,
                     -> {
                       Orb::Internal::Type::ArrayOf[Orb::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered::TieredConfig::Tier]
                     }

            # @!method initialize(tiers:)
            #   @param tiers [Array<Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered::TieredConfig::Tier>] Tiers for rating based on total usage quantities into the specified tier
        ...
        #   @return [Array(Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Unit, Orb::Models::NewFloatingBulkWithProrationPrice::ConversionRateConfig::Tiered)]
      end
    end
  end
end
