  ...
  module Models
    module Customers
      class BalanceTransactionListResponse < Orb::BaseModel
        ...
        # @!attribute action
        #
        #   @return [Symbol, Orb::Models::Customers::BalanceTransactionListResponse::Action]
        required :action, enum: -> { Orb::Models::Customers::BalanceTransactionListResponse::Action }
        ...
        # @!attribute type
        #
        #   @return [Symbol, Orb::Models::Customers::BalanceTransactionListResponse::Type]
