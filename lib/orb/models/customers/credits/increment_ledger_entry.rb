    ...
    module Customers
      module Credits
        class IncrementLedgerEntry < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Orb::Models::Customers::Credits::IncrementLedgerEntry::EntryStatus]
          required :entry_status, enum: -> { Orb::Customers::Credits::IncrementLedgerEntry::EntryStatus }

          # @!attribute entry_type
          #
          #   @return [Symbol, Orb::Models::Customers::Credits::IncrementLedgerEntry::EntryType]
          required :entry_type, enum: -> { Orb::Customers::Credits::IncrementLedgerEntry::EntryType }
          ...
          # @!method initialize(id:, amount:, created_at:, credit_block:, currency:, customer:, description:, ending_balance:, entry_status:, entry_type:, ledger_sequence_number:, metadata:, starting_balance:, created_invoices: nil)
          #   Some parameter documentations has been truncated, see
          #   {Orb::Models::Customers::Credits::IncrementLedgerEntry} for more details.
          #
          #   @param id [String]
          #
          #   @param amount [Float]
          ...
          #
          #   @param entry_status [Symbol, Orb::Models::Customers::Credits::IncrementLedgerEntry::EntryStatus]
          #
          #   @param entry_type [Symbol, Orb::Models::Customers::Credits::IncrementLedgerEntry::EntryType]
          #
          ...
          # @see Orb::Models::Customers::Credits::IncrementLedgerEntry#entry_status
          module EntryStatus
          ...
          # @see Orb::Models::Customers::Credits::IncrementLedgerEntry#entry_type
          module EntryType
            extend Orb::Internal::Type::Enum
