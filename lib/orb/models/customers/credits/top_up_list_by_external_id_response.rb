    ...
    module Customers
      module Credits
        ...
        class TopUpListByExternalIDResponse < Orb::Internal::Type::BaseModel
          ...
          #   @param invoice_settings [Orb::Models::Customers::Credits::TopUpListByExternalIDResponse::InvoiceSettings]
          #   @param per_unit_cost_basis [String]
          #   @param threshold [String]
          #   @param expires_after [Integer, nil]
          #   @param expires_after_unit [Symbol, Orb::Models::Customers::Credits::TopUpListByExternalIDResponse::ExpiresAfterUnit, nil]
