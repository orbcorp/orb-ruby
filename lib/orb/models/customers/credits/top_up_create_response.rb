    ...
    module Customers
      module Credits
        ...
        class TopUpCreateResponse < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::Customers::Credits::TopUpCreateResponse::InvoiceSettings]
          ...
          #
          #   @return [Symbol, Orb::Models::Customers::Credits::TopUpCreateResponse::ExpiresAfterUnit, nil]
          optional :expires_after_unit,
                   enum: -> { Orb::Models::Customers::Credits::TopUpCreateResponse::ExpiresAfterUnit },
                   nil?: true
          ...
          #   @param invoice_settings [Orb::Models::Customers::Credits::TopUpCreateResponse::InvoiceSettings]
          #   @param per_unit_cost_basis [String]
          #   @param threshold [String]
          #   @param expires_after [Integer, nil]
          #   @param expires_after_unit [Symbol, Orb::Models::Customers::Credits::TopUpCreateResponse::ExpiresAfterUnit, nil]

          # @see Orb::Models::Customers::Credits::TopUpCreateResponse#invoice_settings
          ...
          # The unit of expires_after.
          #
          # @see Orb::Models::Customers::Credits::TopUpCreateResponse#expires_after_unit
