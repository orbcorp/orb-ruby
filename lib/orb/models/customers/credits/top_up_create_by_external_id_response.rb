    ...
    module Customers
      module Credits
        ...
        class TopUpCreateByExternalIDResponse < Orb::Internal::Type::BaseModel
          ...
          #
          #   @return [Orb::Models::Customers::Credits::TopUpCreateByExternalIDResponse::InvoiceSettings]
          ...
          #
          #   @return [Symbol, Orb::Models::Customers::Credits::TopUpCreateByExternalIDResponse::ExpiresAfterUnit, nil]
          optional :expires_after_unit,
                   enum: -> { Orb::Models::Customers::Credits::TopUpCreateByExternalIDResponse::ExpiresAfterUnit },
                   nil?: true
          ...
          #   @param invoice_settings [Orb::Models::Customers::Credits::TopUpCreateByExternalIDResponse::InvoiceSettings]
          #   @param per_unit_cost_basis [String]
          #   @param threshold [String]
          #   @param expires_after [Integer, nil]
          #   @param expires_after_unit [Symbol, Orb::Models::Customers::Credits::TopUpCreateByExternalIDResponse::ExpiresAfterUnit, nil]

          # @see Orb::Models::Customers::Credits::TopUpCreateByExternalIDResponse#invoice_settings
          ...
          # The unit of expires_after.
          #
          # @see Orb::Models::Customers::Credits::TopUpCreateByExternalIDResponse#expires_after_unit
