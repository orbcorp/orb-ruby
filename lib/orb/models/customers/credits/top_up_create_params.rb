    ...
    module Customers
      module Credits
        ...
        class TopUpCreateParams < Orb::Internal::Type::BaseModel
          ...
          # @!method initialize(customer_id:, amount:, currency:, invoice_settings:, per_unit_cost_basis:, threshold:, active_from: nil, expires_after: nil, expires_after_unit: nil, request_options: {})
