...
module Orb
  module Models
    module Customers
      ...
      # ```ruby
      # cost_list_response => {
      #   data: -> { Orb::ArrayOf[Orb::Models::Customers::CostListResponse::Data] === _1 }
      # }
      # ```
      class CostListResponse < Orb::BaseModel
        ...
        required :data, -> { Orb::ArrayOf[Orb::Models::Customers::CostListResponse::Data] }
        ...
        # ```ruby
        # data => {
        #   per_price_costs: -> { Orb::ArrayOf[Orb::Models::Customers::CostListResponse::Data::PerPriceCost] === _1 },
        #   subtotal: String,
        #   timeframe_end: Time,
        ...
        class Data < Orb::BaseModel
          ...
          required :per_price_costs,
                   -> { Orb::ArrayOf[Orb::Models::Customers::CostListResponse::Data::PerPriceCost] }
