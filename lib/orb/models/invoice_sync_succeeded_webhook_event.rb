...
module Orb
  module Models
    class InvoiceSyncSucceededWebhookEvent < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::InvoiceSyncSucceededWebhookEvent::Properties]
      required :properties, -> { Orb::InvoiceSyncSucceededWebhookEvent::Properties }

      # @!attribute type
      #   The event this payload describes.
      #
      #   @return [Symbol, Orb::Models::InvoiceSyncSucceededWebhookEvent::Type]
      required :type, enum: -> { Orb::InvoiceSyncSucceededWebhookEvent::Type }

      # @!method initialize(id:, created_at:, invoice:, properties:, type:)
      #   Some parameter documentations has been truncated, see
      #   {Orb::Models::InvoiceSyncSucceededWebhookEvent} for more details.
      #
      ...
      #
      #   @param properties [Orb::Models::InvoiceSyncSucceededWebhookEvent::Properties]
      #
      #   @param type [Symbol, Orb::Models::InvoiceSyncSucceededWebhookEvent::Type] The event this payload describes.

      # @see Orb::Models::InvoiceSyncSucceededWebhookEvent#properties
      ...
      # The event this payload describes.
      #
      # @see Orb::Models::InvoiceSyncSucceededWebhookEvent#type
      module Type
        extend Orb::Internal::Type::Enum

        INVOICE_SYNC_SUCCEEDED = :"invoice.sync_succeeded"
