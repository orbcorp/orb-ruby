...
module Orb
  module Models
    class NewFloatingMinimumCompositePrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Orb::Models::NewFloatingMinimumCompositePrice::Cadence]
      required :cadence, enum: -> { Orb::NewFloatingMinimumCompositePrice::Cadence }
      ...
      optional :conversion_rate_config,
               union: -> { Orb::NewFloatingMinimumCompositePrice::UnnamedTypeWithobjectParent16 },
               nil?: true
      ...
      # The cadence to bill for this price on.
      #
      # @see Orb::Models::NewFloatingMinimumCompositePrice#cadence
      module Cadence
