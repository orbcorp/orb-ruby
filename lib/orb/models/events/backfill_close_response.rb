  ...
  module Models
    module Events
      ...
      class BackfillCloseResponse < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::Events::BackfillCloseResponse::Status]
        required :status, enum: -> { Orb::Models::Events::BackfillCloseResponse::Status }
        ...
        #   {Orb::Models::Events::BackfillCloseResponse} for more details.
        #
        ...
        #
        #   @param status [Symbol, Orb::Models::Events::BackfillCloseResponse::Status] The status of the backfill.
        #
        ...
        # The status of the backfill.
        #
        # @see Orb::Models::Events::BackfillCloseResponse#status
        module Status
