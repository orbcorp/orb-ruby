  ...
  module Models
    module Events
      ...
      class BackfillListResponse < Orb::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::Events::BackfillListResponse::Status]
        required :status, enum: -> { Orb::Models::Events::BackfillListResponse::Status }
        ...
        #   {Orb::Models::Events::BackfillListResponse} for more details.
        #
        ...
        #
        #   @param status [Symbol, Orb::Models::Events::BackfillListResponse::Status] The status of the backfill.
        #
        ...
        # The status of the backfill.
        #
        # @see Orb::Models::Events::BackfillListResponse#status
        module Status
