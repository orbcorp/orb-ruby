  ...
  module Models
    module Events
      ...
      class BackfillCreateResponse < Orb::BaseModel
        ...
        #
        #   @return [Symbol, Orb::Models::Events::BackfillCreateResponse::Status]
        required :status, enum: -> { Orb::Models::Events::BackfillCreateResponse::Status }
