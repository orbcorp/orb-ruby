...
module Orb
  module Models
    class NewFloatingTieredWithMinimumPrice < Orb::Internal::Type::BaseModel
      ...
      #
      #   @return [Orb::Models::NewFloatingTieredWithMinimumPrice::TieredWithMinimumConfig]
      ...
      #
      #   @param model_type [Symbol, Orb::Models::NewFloatingTieredWithMinimumPrice::ModelType] The pricing model type
      #
      #   @param name [String] The name of the price.
      #
      #   @param tiered_with_minimum_config [Orb::Models::NewFloatingTieredWithMinimumPrice::TieredWithMinimumConfig] Configuration for tiered_with_minimum pricing
      #
      ...
      # @see Orb::Models::NewFloatingTieredWithMinimumPrice#tiered_with_minimum_config
      class TieredWithMinimumConfig < Orb::Internal::Type::BaseModel
        # @!attribute tiers
        #   Tiered pricing with a minimum amount dependent on the volume tier. Tiers are
        #   defined using exclusive lower bounds.
        #
        #   @return [Array<Orb::Models::NewFloatingTieredWithMinimumPrice::TieredWithMinimumConfig::Tier>]
        required :tiers,
                 -> { Orb::Internal::Type::ArrayOf[Orb::NewFloatingTieredWithMinimumPrice::TieredWithMinimumConfig::Tier] }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Orb::Models::NewFloatingTieredWithMinimumPrice::TieredWithMinimumConfig} for
        #   more details.
        #
        #   Configuration for tiered_with_minimum pricing
        #
        #   @param tiers [Array<Orb::Models::NewFloatingTieredWithMinimumPrice::TieredWithMinimumConfig::Tier>] Tiered pricing with a minimum amount dependent on the volume tier. Tiers are def
        #
