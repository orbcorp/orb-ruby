    ...
    class BaseModel
      ...
      class << self
        ...
        private def add_field(name_sym, required:, type_info:, spec:)
          type_fn, info =
            case type_info
            in Proc | Orb::Type::Converter | Class
              [Orb::Type::Converter.type_info({**spec, union: type_info}), spec]
            in Hash
              [Orb::Type::Converter.type_info(type_info), type_info]
            end
        ...
        def coerce(value, state:)
          ...
          fields.each do |name, field|
            ...
            unless val.key?(api_name)
              if required && mode != :dump && const == Orb::Util::OMIT
            ...
            converted =
              if item.nil? && (nilable || !required)
                ...
                coerced = Orb::Type::Converter.coerce(target, item, state: state)
                case target
                in Orb::Type::Converter | Symbol
                  coerced
                else
                  item
                end
          ...
          coerced.each do |key, val|
            ...
            in nil
              ...
              in :coerce
                ...
                target = type_fn.call
                acc.store(api_name, Orb::Type::Converter.dump(target, val))
              end
            end
          end
