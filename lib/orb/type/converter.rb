    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in true | false
            -> { Orb::BooleanModel }
          in Orb::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [Orb::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(Orb::Type::Converter) ? target.dump(value) : Orb::Unknown.dump(value)
        end
      end
    end
