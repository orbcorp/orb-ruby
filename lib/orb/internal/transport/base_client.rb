  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Orb::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Orb::Internal::Util.os,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Orb::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            # from undici
            if Orb::Internal::Util.uri_origin(url) != Orb::Internal::Util.uri_origin(location)
          ...
          def reap_connection!(status, stream:)
            ...
            in (..199) | (300..499)
              stream&.each { next }
            in Orb::Errors::APIConnectionError | (500..)
        ...
        def initialize(
          ...
          @requester = Orb::Internal::Transport::PooledNetRequester.new
          @headers = Orb::Internal::Util.normalized_headers(
        ...
        private def build_request(req, opts)
          ...
          path = Orb::Internal::Util.interpolate_path(uninterpolated_path)

          query = Orb::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
        ...
        #
        # @param options [Orb::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
