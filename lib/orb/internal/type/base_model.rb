          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            type_fn, info =
              ...
              in Proc | Orb::Internal::Type::Converter | Class
                [Orb::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
            ...
            define_method(name_sym) do
              target = type_fn.call
              value = @data.fetch(name_sym) { const == Orb::Internal::Util::OMIT ? nil : const }
        ...
        class << self
          ...
          def coerce(value, state:)
            ...
            fields.each do |name, field|
              ...
              unless val.key?(api_name)
                if required && mode != :dump && const == Orb::Internal::Util::OMIT
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = Orb::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in Orb::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value)
            ...
            known_fields.each_value do |field|
              ...
              next if mode == :coerce || acc.key?(api_name) || const == Orb::Internal::Util::OMIT
