  ...
  module Internal
    module Type
      ...
      class HashOf
        ...
        #
        # @return [Orb::Internal::Type::HashOf]
        def self.[](...) = new(...)
        ...
        def ==(other)
          ...
          other.is_a?(Orb::Internal::Type::HashOf) && other.nilable? == nilable? && other.item_type == item_type
            ...
            .to_h do |key, val|
              ...
              v =
                ...
                in [true, nil]
                  ...
                  Orb::Internal::Type::Converter.coerce(target, val, state: state)
                end
