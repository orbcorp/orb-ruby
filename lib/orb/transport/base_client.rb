...
module Orb
  module Transport
    ...
    class BaseClient
      ...
      # @api private
      # @return [Orb::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = Orb::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [Orb::Type::Converter, Class, nil] :model
      #
      ...
      private def build_request(req, opts)
        ...
        query = Orb::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
      ...
      def request(req)
        ...
        in { page: Class => page }
          ...
          Orb::Type::Converter.coerce(model, unwrapped)
        end
      end
