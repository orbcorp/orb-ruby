...
module Orb
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in Orb::Converter | Module | Symbol
          -> { spec }
        in true | false
          -> { Orb::BooleanModel }
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(Orb::Enum) && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    private def variant(key, spec = nil)
      variant_info =
        ...
        in Proc | Orb::Converter | Module | Hash
    ...
    private def resolve_variant(value)
      ...
      in [Symbol, Hash]
        ...
        resolved.nil? ? Orb::Unknown : resolved.call
      else
        nil
      end
    end
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(Orb::Union) && other.derefed_variants == derefed_variants
    end
    ...
    def coerce(value)
      ...
      known_variants.each do |_, variant_fn|
        ...
        case Orb::Converter.try_strict_coerce(variant, value)
        in [true, coerced, _]
          return coerced
        in [false, true, score]
  ...
  class ArrayOf
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case Orb::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class HashOf
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = Orb::Converter.coerce(type, val)
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case Orb::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
    ...
    class << self
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        ...
        define_method(name_sym) do
          ...
          Orb::Converter.coerce(field_type, value)
        rescue StandardError
          name = self.class.name.split("::").last
          raise Orb::ConversionError.new(
        ...
        values = coerced.filter_map do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              [api_name, Orb::Converter.dump(target, val)]
            end
          end
        end.to_h
      ...
      def try_strict_coerce(value)
        ...
        known_fields.each_value do |field|
          ...
          in [_, true]
            ...
            case Orb::Converter.try_strict_coerce(target, item)
            in [true, coerced, score]
              tally += score
    ...
    def initialize(data = {})
      ...
      in Hash => coerced
        @data = coerced.to_h do |key, value|
          ...
          stored =
            case [type, value]
            in [Module, Hash] if type <= Orb::BaseModel
              type.new(value)
