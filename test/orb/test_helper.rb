...
class Orb::Test::SingletonClient < Orb::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Orb::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Orb::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @orb = Orb::Test::SingletonClient.instance
  end
