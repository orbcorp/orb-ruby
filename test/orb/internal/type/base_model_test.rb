...
class Orb::Test::PrimitiveModelTest < Minitest::Test
  ...
  def test_coerce
    cases = {
      ...
      [Orb::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Orb::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
  ...
  def test_dump
    cases = {
      ...
      [Orb::Internal::Type::Boolean, true] => true,
      [Orb::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Orb::Internal::Type::Converter.dump(target, input, state: state)
