...
class Orb::Test::SorbetRuntimeSupportTest < Minitest::Test
  ...
  class M < Orb::Internal::Type::BaseModel
  ...
  def test_nil_aliases
    ...
    assert_raises(err) { Orb::Internal::Type::BaseModel::KnownField }
    assert_raises(err) { Orb::Internal::Util::ParsedUri }
    assert_raises(err) { Orb::Internal::Util::ServerSentEvent }
    assert_raises(err) { Orb::Internal::Transport::BaseClient::RequestComponents }
    assert_raises(err) { Orb::Internal::Transport::BaseClient::RequestInput }
    assert_raises(err) { Orb::Internal::Transport::PooledNetRequester::Request }
