  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        auto_collection: Orb::Internal::Type::BooleanModel,
        balance: String,
        billing_address: Orb::Models::Customer::BillingAddress | nil,
        created_at: Time,
        currency: String | nil,
        email: String,
        email_delivery: Orb::Internal::Type::BooleanModel,
        exempt_from_automated_tax: Orb::Internal::Type::BooleanModel | nil,
