...
class Orb::Test::Resources::BetaTest < Orb::Test::ResourceTest
  def test_create_plan_version_required_params
    response = @orb.beta.create_plan_version("plan_id", version: 0)
  ...
  def test_fetch_plan_version_required_params
    response = @orb.beta.fetch_plan_version("version", plan_id: "plan_id")
  ...
  def test_set_default_plan_version_required_params
    response = @orb.beta.set_default_plan_version("plan_id", version: 0)
