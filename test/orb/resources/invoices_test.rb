  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        billing_address: Orb::Invoice::BillingAddress | nil,
        created_at: Time,
        ...
        customer_tax_id: Orb::Invoice::CustomerTaxID | nil,
        ...
        shipping_address: Orb::Invoice::ShippingAddress | nil,
        status: Orb::Invoice::Status,
        subscription: Orb::Invoice::Subscription | nil,
        subtotal: String,
